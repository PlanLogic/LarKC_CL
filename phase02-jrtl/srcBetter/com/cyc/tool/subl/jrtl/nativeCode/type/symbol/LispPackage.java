...
public abstract class LispPackage extends AbstractLispObject {
	...
	public synchronized SubLSymbol addExternalSymbol(String symbolName) {
		SubLSymbol symbol = new SubLSymbolImpl(symbolName, this.toSubLPackage());
	...
	private synchronized SubLSymbol addSymbol(SubLString name, int hash) {
		SubLSymbolImpl symbol = new SubLSymbolImpl(name, (SubLPackage)this);
		symbol.hash = hash;
...

	{
		...
		symbol = new SubLSymbolImpl(s, this.toSubLPackage());
		((LispSymbolImpl)symbol).hash=hash;
