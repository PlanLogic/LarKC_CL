...
public class SubLSymbolImpl extends AbstractSubLSymbol implements SubLSymbol {
	...
	public String toString() {
		...
		try {
			//curPackage = SubLPackage.getCurrentPackage();
		} catch (Exception e) {
			//e.printStackTrace();
			//return this.getPackageNamePrecise() + ":" + this.getSymbolNamePrecise();
		}
		//if (thePackage == null) return "#:" + this.getSymbolNamePrecise();
		if (thePackage.toPackage().retrieveSymbol(this.getName()) == null)
			return this.getPackageNamePrecise() + "::" + this.getSymbolNamePrecise();
		return this.getPackageNamePrecise() +":"+ this.getSymbolNamePrecise().toString();	
	}
