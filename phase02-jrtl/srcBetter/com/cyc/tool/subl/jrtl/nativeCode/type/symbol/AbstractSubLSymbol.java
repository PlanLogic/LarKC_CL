...
public abstract class AbstractSubLSymbol extends LispSymbolImpl implements SubLSymbol {
	 ...
	 */
	AbstractSubLSymbol(SubLString symbolName, SubLPackage thePack) {
		super(symbolName, thePack);
		//this.thePackage = thePack;
		this.symbolName = symbolName;
		this.hashCode = (thePack == null ? 0 : thePack.hashCode()) ^ symbolName.hashCode();
		if (thePack != null && thePack == SubLPackage.KEYWORD_PACKAGE) {
			// get 
			// rid
			// of
			// this
			// test
			if (!this.isKeyword())
			Errors.error("Got invalid keyword: '" + thePack + ":" + symbolName + "'");
		}
	}
	...
	public SubLPackage getPackage() {
		return this.thePackage.toPackage();
	}
	...
	protected CharSequence getPackageName() {
		return this.thePackage == null ? "#" : this.thePackage.toPackage().getName();
	}
	...
	// @ToDo get rid of me --APB
	protected CharSequence getPackageNamePrecise() {
	...
	/** this version will not contain outer symbol quotes ("|") */
	// @ToDo get rid of me --APB
	protected SubLString getSymbolName() {
	...
	// @ToDo get rid of me --APB
	protected CharSequence getSymbolNamePrecise() {
