...
into BITS according the the BYTESPEC. */
  ...
  public static SubLSymbol $sym0$INTEGERP = makeSymbol("INTEGERP");
  public static SubLInteger $int1$4095 = makeInteger(4095);
  public static SubLString $str2$Invalid_Size = makeString("Invalid Size");
  public static SubLString $str3$Invalid_Position = makeString("Invalid Position");
  public static SubLInteger $int4$4096 = makeInteger(4096);
  public static SubLInteger $int5$8193 = makeInteger(8193);
  public static SubLInteger $int6$12291 = makeInteger(12291);
  public static SubLInteger $int7$_3 = makeInteger(-3);
  public static SubLInteger $int8$_12 = makeInteger(-12);
