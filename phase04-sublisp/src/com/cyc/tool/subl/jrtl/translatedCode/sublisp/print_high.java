...
public  class print_high extends SubLTranslatedFile {
  ...
  public static SubLObject declare_print_high_file() {
    declareFunction(myName, "read_print_eq", "READ-PRINT-EQ", 1, 0, false);
    declareFunction(myName, "print_error", "PRINT-ERROR", 2, 0, false);
    declareMacro(myName, "with_printer_state", "WITH-PRINTER-STATE");
    declareFunction(myName, "handle_circularity", "HANDLE-CIRCULARITY", 2, 0, false);
    declareFunction(myName, "circular_reference_p", "CIRCULAR-REFERENCE-P", 2, 0, false);
    declareFunction(myName, "print_object", "PRINT-OBJECT", 2, 0, false);
    declareFunction(myName, "print_object_wrapper", "PRINT-OBJECT-WRAPPER", 2, 0, false);
    declareFunction(myName, "really_write", "REALLY-WRITE", 2, 0, false);
    declareFunction(myName, "prin1", "PRIN1", 1, 1, false);
    declareFunction(myName, "print", "PRINT", 1, 1, false);
    declareFunction(myName, "princ", "PRINC", 1, 1, false);
    declareFunction(myName, "really_write_to_string", "REALLY-WRITE-TO-STRING", 2, 0, false);
    declareFunction(myName, "prin1_to_string", "PRIN1-TO-STRING", 1, 0, false);
    declareFunction(myName, "princ_to_string", "PRINC-TO-STRING", 1, 0, false);
    declareFunction(myName, "print_not_readable", "PRINT-NOT-READABLE", 2, 0, false);
    return NIL;
  }
  ...
  public static SubLSymbol $kw0$UPCASE = makeKeyword("UPCASE");
  public static SubLInteger $int1$64 = makeInteger(64);
  public static SubLString $str2$__Error_printing__S_ = makeString("#<Error printing ~S>");
  public static SubLList $list3 = list(list(makeSymbol("STREAM-VAR"), makeSymbol("&KEY"), makeSymbol("NEWP")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list4 = list(makeKeyword("NEWP"));
  public static SubLSymbol $kw5$ALLOW_OTHER_KEYS = makeKeyword("ALLOW-OTHER-KEYS");
  public static SubLSymbol $kw6$NEWP = makeKeyword("NEWP");
  public static SubLString $str7$TEMP_STREAM = makeString("TEMP-STREAM");
  public static SubLString $str8$SAVED_STREAM = makeString("SAVED-STREAM");
  public static SubLString $str9$TABLE = makeString("TABLE");
  public static SubLString $str10$INFO = makeString("INFO");
  public static SubLSymbol $sym11$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym12$CSETF = makeSymbol("CSETF");
  public static SubLSymbol $sym13$OUTPUT_STREAM_DESIGNATOR_STREAM = makeSymbol("OUTPUT-STREAM-DESIGNATOR-STREAM");
  public static SubLSymbol $sym14$PIF = makeSymbol("PIF");
  public static SubLSymbol $sym15$_PRINT_CIRCLE_ = makeSymbol("*PRINT-CIRCLE*");
  public static SubLSymbol $sym16$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym17$CDR = makeSymbol("CDR");
  public static SubLSymbol $sym18$ASSOC = makeSymbol("ASSOC");
  public static SubLList $list19 = list(makeSymbol("*PRINT-CIRCULARITIES*"));
  public static SubLSymbol $sym20$CAND = makeSymbol("CAND");
  public static SubLSymbol $sym21$CNOT = makeSymbol("CNOT");
  public static SubLList $list22 = list(list(makeSymbol("MAKE-HASH-TABLE"), makeSymbol("*PRINT-CIRCLE-TABLE-SIZE*"), list(makeSymbol("FUNCTION"), EQ)));
  public static SubLList $list23 = list(list(makeSymbol("MAKE-BROADCAST-STREAM"), NIL));
  public static SubLSymbol $sym24$_PRINT_CIRCULARITIES_ = makeSymbol("*PRINT-CIRCULARITIES*");
  public static SubLSymbol $sym25$CONS = makeSymbol("CONS");
  public static SubLSymbol $sym26$LIST = makeSymbol("LIST");
  public static SubLSymbol $sym27$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static SubLSymbol $sym28$LIST_ = makeSymbol("LIST*");
  public static SubLList $list29 = list(ZERO_INTEGER);
  public static SubLList $list30 = cons(makeSymbol("TABLE"), makeSymbol("COUNTER"));
  public static SubLSymbol $sym31$REFERENCED = makeSymbol("REFERENCED");
  public static SubLString $str32$__D_ = makeString("#~D=");
  public static SubLString $str33$__D__ = makeString("#~D# ");
  public static SubLSymbol $sym34$DETECTED = makeSymbol("DETECTED");
  public static SubLInteger $int35$256 = makeInteger(256);
  public static SubLString $str36$__ = makeString("#<");
  public static SubLSymbol $kw37$STREAM = makeKeyword("STREAM");
  public static SubLSymbol $kw38$BASE = makeKeyword("BASE");
  public static SubLList $list39 = list(new SubLObject[] {makeSymbol("&KEY"), list(makeSymbol("STREAM"), makeSymbol("*STANDARD-OUTPUT*")), list(list(makeKeyword("ARRAY"), makeSymbol("*PRINT-ARRAY*")), makeSymbol("*PRINT-ARRAY*")), list(list(makeKeyword("BASE"), makeSymbol("*PRINT-BASE*")), makeSymbol("*PRINT-BASE*")), list(list(makeKeyword("CASE"), makeSymbol("*PRINT-CASE*")), makeSymbol("*PRINT-CASE*")), list(list(makeKeyword("CIRCLE"), makeSymbol("*PRINT-CIRCLE*")), makeSymbol("*PRINT-CIRCLE*")), list(list(makeKeyword("ESCAPE"), makeSymbol("*PRINT-ESCAPE*")), makeSymbol("*PRINT-ESCAPE*")), list(list(makeKeyword("GENSYM"), makeSymbol("*PRINT-GENSYM*")), makeSymbol("*PRINT-GENSYM*")), list(list(makeKeyword("LENGTH"), makeSymbol("*PRINT-LENGTH*")), makeSymbol("*PRINT-LENGTH*")), list(list(makeKeyword("LEVEL"), makeSymbol("*PRINT-LEVEL*")), makeSymbol("*PRINT-LEVEL*")), list(list(makeKeyword("LINES"), makeSymbol("*PRINT-LINES*")), makeSymbol("*PRINT-LINES*")), list(list(makeKeyword("MISER-WIDTH"), makeSymbol("*PRINT-MISER-WIDTH*")), makeSymbol("*PRINT-MISER-WIDTH*")), list(list(makeKeyword("PPRINT-DISPATCH"), makeSymbol("*PRINT-PPRINT-DISPATCH*")), makeSymbol("*PRINT-PPRINT-DISPATCH*")), list(list(makeKeyword("PRETTY"), makeSymbol("*PRINT-PRETTY*")), makeSymbol("*PRINT-PRETTY*")), list(list(makeKeyword("RADIX"), makeSymbol("*PRINT-RADIX*")), makeSymbol("*PRINT-RADIX*")), list(list(makeKeyword("READABLY"), makeSymbol("*PRINT-READABLY*")), makeSymbol("*PRINT-READABLY*")), list(list(makeKeyword("RIGHT-MARGIN"), makeSymbol("*PRINT-RIGHT-MARGIN*")), makeSymbol("*PRINT-RIGHT-MARGIN*"))});
  public static SubLList $list40 = list(new SubLObject[] {makeKeyword("STREAM"), makeKeyword("ARRAY"), makeKeyword("BASE"), makeKeyword("CASE"), makeKeyword("CIRCLE"), makeKeyword("ESCAPE"), makeKeyword("GENSYM"), makeKeyword("LENGTH"), makeKeyword("LEVEL"), makeKeyword("LINES"), makeKeyword("MISER-WIDTH"), makeKeyword("PPRINT-DISPATCH"), makeKeyword("PRETTY"), makeKeyword("RADIX"), makeKeyword("READABLY"), makeKeyword("RIGHT-MARGIN")});
  public static SubLSymbol $kw41$ARRAY = makeKeyword("ARRAY");
  public static SubLSymbol $kw42$CASE = makeKeyword("CASE");
  public static SubLSymbol $kw43$CIRCLE = makeKeyword("CIRCLE");
  public static SubLSymbol $kw44$ESCAPE = makeKeyword("ESCAPE");
  public static SubLSymbol $kw45$GENSYM = makeKeyword("GENSYM");
  public static SubLSymbol $kw46$LENGTH = makeKeyword("LENGTH");
  public static SubLSymbol $kw47$LEVEL = makeKeyword("LEVEL");
  public static SubLSymbol $kw48$LINES = makeKeyword("LINES");
  public static SubLSymbol $kw49$MISER_WIDTH = makeKeyword("MISER-WIDTH");
  public static SubLSymbol $kw50$PPRINT_DISPATCH = makeKeyword("PPRINT-DISPATCH");
  public static SubLSymbol $kw51$PRETTY = makeKeyword("PRETTY");
  public static SubLSymbol $kw52$RADIX = makeKeyword("RADIX");
  public static SubLSymbol $kw53$READABLY = makeKeyword("READABLY");
  public static SubLSymbol $kw54$RIGHT_MARGIN = makeKeyword("RIGHT-MARGIN");
  public static SubLString $str55$_S_cannot_be_printed_readably_ = makeString("~S cannot be printed readably.");
