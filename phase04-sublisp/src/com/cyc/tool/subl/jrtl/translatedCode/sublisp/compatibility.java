...
public  class compatibility extends SubLTranslatedFile {
  ...
  public static SubLSymbol $kw0$INPUT = makeKeyword("INPUT");
  public static SubLSymbol $kw1$DIRECTION = makeKeyword("DIRECTION");
  public static SubLSymbol $kw2$IF_DOES_NOT_EXIST = makeKeyword("IF-DOES-NOT-EXIST");
  public static SubLSymbol $kw3$ELEMENT_TYPE = makeKeyword("ELEMENT-TYPE");
  public static SubLSymbol $kw4$TEXT = makeKeyword("TEXT");
  public static SubLSymbol $kw5$OUTPUT = makeKeyword("OUTPUT");
  public static SubLSymbol $kw6$IF_EXISTS = makeKeyword("IF-EXISTS");
  public static SubLSymbol $kw7$NEW_VERSION = makeKeyword("NEW-VERSION");
  public static SubLSymbol $kw8$CREATE = makeKeyword("CREATE");
  public static SubLSymbol $kw9$APPEND = makeKeyword("APPEND");
  public static SubLString $str10$_S_called_with_invalid_direction_ = makeString("~S called with invalid direction argument of ~S.");
  public static SubLSymbol $sym11$OPEN_TEXT = makeSymbol("OPEN-TEXT");
  public static SubLSymbol $kw12$BINARY = makeKeyword("BINARY");
  public static SubLSymbol $kw13$IO = makeKeyword("IO");
  public static SubLString $str14$_S_called_with_invalid_direction_ = makeString("~S called with invalid direction argument of ~A");
  public static SubLSymbol $sym15$OPEN_BINARY = makeSymbol("OPEN-BINARY");
  public static SubLList $list16 = list(list(makeSymbol("STREAM"), makeSymbol("FILENAME"), makeSymbol("DIRECTION"), makeSymbol("ACCESS"), makeSymbol("TYPE")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str17$STREAM = makeString("STREAM");
  public static SubLString $str18$_S_invoked_with_invalid_file_type = makeString("~S invoked with invalid file type ~S specified.");
  public static SubLSymbol $sym19$WITH_STREAMED_FILE_INTERNAL = makeSymbol("WITH-STREAMED-FILE-INTERNAL");
  public static SubLSymbol $sym20$CSETQ = makeSymbol("CSETQ");
  public static SubLSymbol $kw21$PRIVATE = makeKeyword("PRIVATE");
  public static SubLSymbol $sym22$ENSURE_PRIVATE_STREAM = makeSymbol("ENSURE-PRIVATE-STREAM");
  public static SubLSymbol $kw23$PUBLIC = makeKeyword("PUBLIC");
  public static SubLString $str24$_S_invoked_with_invalid_access_se = makeString("~S invoked with invalid access setting ~S.");
  public static SubLSymbol $sym25$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym26$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static SubLSymbol $sym27$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym28$PUNLESS = makeSymbol("PUNLESS");
  public static SubLSymbol $sym29$STREAMP = makeSymbol("STREAMP");
  public static SubLSymbol $sym30$ERROR = makeSymbol("ERROR");
  public static SubLString $str31$Unable_to_open__S = makeString("Unable to open ~S");
  public static SubLSymbol $sym32$PWHEN = makeSymbol("PWHEN");
  public static SubLSymbol $sym33$CLOSE = makeSymbol("CLOSE");
  public static SubLList $list34 = list(list(makeSymbol("STREAM"), makeSymbol("FILENAME"), makeSymbol("DIRECTION")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list35 = list(makeKeyword("PUBLIC"), makeKeyword("TEXT"));
  public static SubLList $list36 = list(makeKeyword("PRIVATE"), makeKeyword("TEXT"));
  public static SubLList $list37 = list(makeKeyword("PUBLIC"), makeKeyword("BINARY"));
  public static SubLList $list38 = list(makeKeyword("PRIVATE"), makeKeyword("BINARY"));
  public static SubLString $str39$__ = makeString("#<");
  public static SubLSymbol $kw40$STREAM = makeKeyword("STREAM");
  public static SubLSymbol $kw41$BASE = makeKeyword("BASE");
