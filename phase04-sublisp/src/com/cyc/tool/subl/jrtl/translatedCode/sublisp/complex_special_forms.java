...
structure as in the DEFPOLYMORPHIC call. */
 ...
 (5) Reading of structures is not supported by the reader. */
  ...
  public static SubLList $list0 = list(makeSymbol("NAME"), makeSymbol("LAMBDA-LIST"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str1$METHOD_FUNCTION = makeString("METHOD-FUNCTION");
  public static SubLSymbol $sym2$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym3$DEFLEXICAL = makeSymbol("DEFLEXICAL");
  public static SubLList $list4 = list(list(makeSymbol("MAKE-VECTOR"), makeInteger(256), NIL));
  public static SubLSymbol $sym5$DEFINE = makeSymbol("DEFINE");
  public static SubLSymbol $sym6$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym7$_METHOD = makeSymbol("_METHOD");
  public static SubLSymbol $sym8$PWHEN = makeSymbol("PWHEN");
  public static SubLSymbol $sym9$RET = makeSymbol("RET");
  public static SubLSymbol $sym10$FUNCALL = makeSymbol("FUNCALL");
  public static SubLSymbol $sym11$DECLAIM = makeSymbol("DECLAIM");
  public static SubLSymbol $sym12$OPTIMIZE_FUNCALL = makeSymbol("OPTIMIZE-FUNCALL");
  public static SubLList $list13 = list(list(makeString("INTEGER"), list(makeSymbol("FIXNUM"), makeSymbol("BIGNUM"))), list(makeString("NUMBER"), list(makeSymbol("FIXNUM"), makeSymbol("BIGNUM"), makeSymbol("FLOAT"))), list(makeString("SEQUENCE"), list(makeSymbol("CONS"), makeSymbol("VECTOR"), makeSymbol("STRING"))));
  public static SubLSymbol $sym14$_REGISTER_METHOD = makeSymbol("_REGISTER-METHOD");
  public static SubLSymbol $sym15$FUNCTION = makeSymbol("FUNCTION");
  public static SubLSymbol $sym16$STRING_ = makeSymbol("STRING=");
  public static SubLString $str17$_ = makeString("*");
  public static SubLString $str18$_METHOD_TABLE_ = makeString("-METHOD-TABLE*");
  public static SubLString $str19$_ = makeString("-");
  public static SubLString $str20$_METHOD = makeString("-METHOD");
  public static SubLString $str21$_DTP_ = makeString("*DTP-");
  public static SubLSymbol $sym22$_OPTIONAL = makeSymbol("&OPTIONAL");
  public static SubLSymbol $sym23$_REST = makeSymbol("&REST");
  public static SubLList $list24 = list(list(makeSymbol("NAME"), makeSymbol("&REST"), makeSymbol("OPTIONS")), makeSymbol("&BODY"), makeSymbol("SLOTS"));
  public static SubLSymbol $sym25$SYMBOLP = makeSymbol("SYMBOLP");
  public static SubLSymbol $kw26$CONC_NAME = makeKeyword("CONC-NAME");
  public static SubLSymbol $kw27$PRINT_FUNCTION = makeKeyword("PRINT-FUNCTION");
  public static SubLSymbol $kw28$C_STRUCTURE_TAG = makeKeyword("C-STRUCTURE-TAG");
  public static SubLSymbol $kw29$GENERATE_VISIT_FUNCTION_ = makeKeyword("GENERATE-VISIT-FUNCTION?");
  public static SubLSymbol $kw30$NAME = makeKeyword("NAME");
  public static SubLSymbol $kw31$HOST_FN_NAME = makeKeyword("HOST-FN-NAME");
  public static SubLSymbol $kw32$PREDICATE = makeKeyword("PREDICATE");
  public static SubLSymbol $kw33$CONSTRUCTOR = makeKeyword("CONSTRUCTOR");
  public static SubLSymbol $kw34$TYPE_VAR = makeKeyword("TYPE-VAR");
  public static SubLSymbol $kw35$SLOTS = makeKeyword("SLOTS");
  public static SubLSymbol $kw36$SLOT_KEYWORDS = makeKeyword("SLOT-KEYWORDS");
  public static SubLSymbol $kw37$GETTERS = makeKeyword("GETTERS");
  public static SubLSymbol $kw38$SETTERS = makeKeyword("SETTERS");
  public static SubLString $str39$_P = makeString("-P");
  public static SubLString $str40$MAKE_ = makeString("MAKE-");
  public static SubLString $str41$VISIT_DEFSTRUCT_ = makeString("VISIT-DEFSTRUCT-");
  public static SubLString $str42$_CSETF_ = makeString("_CSETF-");
  public static SubLString $str43$CYC = makeString("CYC");
  public static SubLString $str44$SUBLISP = makeString("SUBLISP");
  public static SubLString $str45$_1 = makeString("-1");
  public static SubLList $list46 = list(new SubLObject[] {makeSymbol("&KEY"), makeSymbol("NAME"), makeSymbol("CONC-NAME"), makeSymbol("PRINT-FUNCTION"), makeSymbol("C-STRUCTURE-TAG"), makeSymbol("GENERATE-VISIT-FUNCTION?"), makeSymbol("PREDICATE"), makeSymbol("CONSTRUCTOR"), makeSymbol("HOST-FN-NAME"), makeSymbol("TYPE-VAR"), makeSymbol("SLOTS"), makeSymbol("SLOT-KEYWORDS"), makeSymbol("GETTERS"), makeSymbol("SETTERS")});
  public static SubLList $list47 = list(new SubLObject[] {makeKeyword("NAME"), makeKeyword("CONC-NAME"), makeKeyword("PRINT-FUNCTION"), makeKeyword("C-STRUCTURE-TAG"), makeKeyword("GENERATE-VISIT-FUNCTION?"), makeKeyword("PREDICATE"), makeKeyword("CONSTRUCTOR"), makeKeyword("HOST-FN-NAME"), makeKeyword("TYPE-VAR"), makeKeyword("SLOTS"), makeKeyword("SLOT-KEYWORDS"), makeKeyword("GETTERS"), makeKeyword("SETTERS")});
  public static SubLSymbol $kw48$ALLOW_OTHER_KEYS = makeKeyword("ALLOW-OTHER-KEYS");
  public static SubLSymbol $kw49$SL2JAVA = makeKeyword("SL2JAVA");
  public static SubLSymbol $sym50$QUOTE = makeSymbol("QUOTE");
  public static SubLList $list51 = list(makeSymbol("PROGN"));
  public static SubLList $list52 = list(makeSymbol("OBJECT"), makeSymbol("C-STRUCTURE-TAG"), makeSymbol("TYPE-VAR"), makeSymbol("TYPE"));
  public static SubLSymbol $sym53$_STRUCTURE_TYPE = makeSymbol("_STRUCTURE-TYPE");
  public static SubLSymbol $sym54$CAND = makeSymbol("CAND");
  public static SubLSymbol $sym55$_STRUCTURES_BAG_P = makeSymbol("_STRUCTURES-BAG-P");
  public static SubLSymbol $sym56$_STRUCTURE_SLOT = makeSymbol("_STRUCTURE-SLOT");
  public static SubLList $list57 = list(ONE_INTEGER);
  public static SubLList $list58 = list(makeSymbol("OBJECT"), makeSymbol("INDEX"), makeSymbol("TYPE"), makeSymbol("SLOT"));
  public static SubLList $list59 = list(makeSymbol("OBJECT"), makeSymbol("INDEX"), makeSymbol("VALUE"), makeSymbol("TYPE"), makeSymbol("SLOT"));
  public static SubLSymbol $sym60$_SET_STRUCTURE_SLOT = makeSymbol("_SET-STRUCTURE-SLOT");
  public static SubLList $list61 = list(makeSymbol("C-STRUCTURE-TAG"), makeSymbol("SIZE"), makeSymbol("TYPE-VAR"), makeSymbol("TYPE"));
  public static SubLSymbol $sym62$_CLEAR_STRUCTURE = makeSymbol("_CLEAR-STRUCTURE");
  public static SubLSymbol $sym63$_NEW_STRUCTURE = makeSymbol("_NEW-STRUCTURE");
  public static SubLSymbol $sym64$_CLEAR_SUB_STRUCTURE = makeSymbol("_CLEAR-SUB-STRUCTURE");
  public static SubLSymbol $sym65$_DTP_STRUCTURES_BAG_ = makeSymbol("*DTP-STRUCTURES-BAG*");
  public static SubLSymbol $sym66$DEFCONSTANT = makeSymbol("DEFCONSTANT");
  public static SubLString $str67$_PRINT_FUNCTION_TRAMPOLINE = makeString("-PRINT-FUNCTION-TRAMPOLINE");
  public static SubLSymbol $sym68$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol("DEFAULT-STRUCT-PRINT-FUNCTION");
  public static SubLSymbol $sym69$FACCESS = makeSymbol("FACCESS");
  public static SubLSymbol $sym70$PRIVATE = makeSymbol("PRIVATE");
  public static SubLList $list71 = list(makeSymbol("OBJECT"), makeSymbol("STREAM"));
  public static SubLList $list72 = list(makeSymbol("OBJECT"), makeSymbol("STREAM"), ZERO_INTEGER);
  public static SubLSymbol $sym73$_PRINT_OBJECT_METHOD_TABLE_ = makeSymbol("*PRINT-OBJECT-METHOD-TABLE*");
  public static SubLSymbol $sym74$_REGISTER_DEFSTRUCT = makeSymbol("_REGISTER-DEFSTRUCT");
  public static SubLSymbol $sym75$_DEFSTRUCT_OBJECT_P = makeSymbol("_DEFSTRUCT-OBJECT-P");
  public static SubLSymbol $sym76$OBJECT = makeSymbol("OBJECT");
  public static SubLSymbol $sym77$CHECK_TYPE = makeSymbol("CHECK-TYPE");
  public static SubLSymbol $sym78$_DEFSTRUCT_GET_SLOT = makeSymbol("_DEFSTRUCT-GET-SLOT");
  public static SubLSymbol $sym79$_DEFSTRUCT_SET_SLOT = makeSymbol("_DEFSTRUCT-SET-SLOT");
  public static SubLList $list80 = list(makeSymbol("OBJECT"), makeSymbol("VALUE"));
  public static SubLSymbol $sym81$_DEF_CSETF = makeSymbol("_DEF-CSETF");
  public static SubLSymbol $sym82$NEW = makeSymbol("NEW");
  public static SubLSymbol $sym83$_DEFSTRUCT_CONSTRUCT = makeSymbol("_DEFSTRUCT-CONSTRUCT");
  public static SubLList $list84 = list(makeSymbol("&OPTIONAL"), makeSymbol("ARGLIST"));
  public static SubLString $str85$CURRENT_VALUE = makeString("CURRENT-VALUE");
  public static SubLString $str86$CURRENT_ARG = makeString("CURRENT-ARG");
  public static SubLString $str87$NEXT = makeString("NEXT");
  public static SubLSymbol $sym88$OTHERWISE = makeSymbol("OTHERWISE");
  public static SubLSymbol $sym89$ERROR = makeSymbol("ERROR");
  public static SubLString $str90$Invalid_slot__S_for_construction_ = makeString("Invalid slot ~S for construction function");
  public static SubLSymbol $sym91$CDO = makeSymbol("CDO");
  public static SubLSymbol $sym92$CDDR = makeSymbol("CDDR");
  public static SubLSymbol $sym93$NULL = makeSymbol("NULL");
  public static SubLSymbol $sym94$CAR = makeSymbol("CAR");
  public static SubLSymbol $sym95$CADR = makeSymbol("CADR");
  public static SubLSymbol $sym96$PCASE = makeSymbol("PCASE");
  public static SubLSymbol $kw97$BEGIN = makeKeyword("BEGIN");
  public static SubLSymbol $kw98$SLOT = makeKeyword("SLOT");
  public static SubLSymbol $kw99$END = makeKeyword("END");
  public static SubLSymbol $sym100$DEFINE_METHOD = makeSymbol("DEFINE-METHOD");
  public static SubLSymbol $sym101$VISIT_DEFSTRUCT_OBJECT = makeSymbol("VISIT-DEFSTRUCT-OBJECT");
  public static SubLSymbol $sym102$OBJ = makeSymbol("OBJ");
  public static SubLList $list103 = list(makeSymbol("VISITOR-FN"));
  public static SubLList $list104 = list(makeSymbol("OBJ"), makeSymbol("VISITOR-FN"));
  public static SubLList $list105 = list(makeSymbol("PLACE"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list106 = list(list(makeSymbol("*CALL-PROFILING-TABLE*"), list(makeSymbol("INITIALIZE-CALL-PROFILING-TABLE"))), list(makeSymbol("*CALL-PROFILING-ENABLED?*"), T));
  public static SubLSymbol $sym107$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static SubLSymbol $sym108$CSETF = makeSymbol("CSETF");
  public static SubLList $list109 = list(list(makeSymbol("FINALIZE-CALL-PROFILING-TABLE"), makeSymbol("*CALL-PROFILING-TABLE*")));
  public static SubLInteger $int110$1000 = makeInteger(1000);
  public static SubLSymbol $sym111$_ = makeSymbol(">");
  public static SubLSymbol $sym112$CDR = makeSymbol("CDR");
