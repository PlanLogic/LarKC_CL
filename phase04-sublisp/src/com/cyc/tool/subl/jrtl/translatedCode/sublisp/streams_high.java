...
public  class streams_high extends SubLTrampolineFile {
  ...
  public static SubLObject read_byte(SubLObject stream, 
  ...
  public static SubLObject read_char(SubLObject stream, SubLObject eof_error_p, 
  ...
  public static SubLObject read_byte_sequence_into_string(SubLObject string, 
  ...
  public static SubLObject read_byte_sequence_to_positive_integer(SubLObject byteCount, 
      SubLObject stream, SubLObject eof_error_p, SubLObject eof_value) { 
    if (stream == UNPROVIDED) { stream = StreamsLow.$standard_input$.getDynamicValue(); }
  ...
  public static SubLObject read_char_no_hang(SubLObject stream, 
  ...
  public static SubLObject read_line(SubLObject stream, SubLObject eof_error_p, 
      SubLObject eof_value, SubLObject recursive_p) {
  ...
  private static SubLObject peekChar(SubLInputTextStream stream, 
      SubLObject eof_error_p, SubLObject eof_value) {
  ...
  private static SubLObject peekCharSkippingWS(SubLInputTextStream stream, 
      SubLObject eof_error_p, SubLObject eof_value) {
    int theChar;
    do {
  ...
  private static SubLObject peekCharSkippingChar(int charToSkip, SubLInputTextStream stream, 
      SubLObject eof_error_p, SubLObject eof_value) {
    int theChar;
    do {
      theChar = stream.readChar();
  ...
  public static SubLObject peek_char(SubLObject peek_type, SubLObject stream, 
  ...
  /*
   public static SubLObject output_stream_designator_stream(SubLObject object) {
  ...
  public static SubLObject input_stream_designator_stream(SubLObject object) {
    if (SubLNil.toBool(Equality.eq(object, T))) {
      return StreamsLow.$terminal_io$.getValue();
    } else if (SubLNil.toBool(Equality.eq(object, NIL))) {
  ...
  public static SubLObject make_descriptor_stream(SubLObject descriptor, SubLObject direction, SubLObject element_type) {
    if ((!(SubLNil.toBool(Errors.$ignore_mustsP$.getValue())))) {
  ...
  public static SubLObject make_private_descriptor_stream(SubLObject descriptor, SubLObject direction, SubLObject element_type) {
    {
      SubLObject stream = NIL;
      try {
          Dynamic.bind(stream_macros.$stream_requires_locking$, NIL);
  ...
  public static SubLObject make_two_way_stream(SubLObject input_stream, SubLObject output_stream) {
  ...
  public static SubLObject make_private_two_way_stream(SubLObject input_stream, SubLObject output_stream) {
    {
      SubLObject stream = NIL;
      try {
          Dynamic.bind(stream_macros.$stream_requires_locking$, NIL);
  ...
  public static SubLObject make_echo_stream(SubLObject input_stream, SubLObject output_stream) {
    input_stream.checkType(((SubLSymbol) $constants[90])); // INPUT-STREAM-P
    output_stream.checkType(((SubLSymbol) $constants[89])); // OUTPUT-STREAM-P
    {
      SubLObject stream = make_stream(UNPROVIDED);
  ...
  public static SubLObject make_private_echo_stream(SubLObject input_stream, SubLObject output_stream) {
    {
      SubLObject stream = NIL;
      try {
          Dynamic.bind(stream_macros.$stream_requires_locking$, NIL);
  ...
  public static SubLObject make_private_concatenated_stream(SubLObject streams) {
    {
      SubLObject stream = NIL;
      try {
          Dynamic.bind(stream_macros.$stream_requires_locking$, NIL);
  ...
  public static SubLObject stream_read_sequence(SubLObject stream, SubLObject sequence, SubLObject start, SubLObject end) {
  ...
  public static SubLObject stream_write_sequence(SubLObject stream, SubLObject sequence, SubLObject start, SubLObject end) {
  ...
  public static SubLObject stream_file_string_length(SubLObject stream, SubLObject object) {
