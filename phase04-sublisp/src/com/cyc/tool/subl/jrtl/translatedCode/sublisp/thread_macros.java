...
public  class thread_macros extends SubLTranslatedFile {
  ...
  public static SubLList $list0 = list(list(makeSymbol("LOCK"), makeSymbol("&KEY"), list(makeSymbol("WHOSTATE"), makeString("Seize lock"))), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list1 = list(makeKeyword("WHOSTATE"));
  public static SubLSymbol $kw2$ALLOW_OTHER_KEYS = makeKeyword("ALLOW-OTHER-KEYS");
  public static SubLSymbol $kw3$WHOSTATE = makeKeyword("WHOSTATE");
  public static SubLString $str4$Seize_lock = makeString("Seize lock");
  public static SubLString $str5$LOCK = makeString("LOCK");
  public static SubLString $str6$RELEASE = makeString("RELEASE");
  public static SubLSymbol $sym7$CLET = makeSymbol("CLET");
  public static SubLList $list8 = list(NIL);
  public static SubLSymbol $sym9$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static SubLSymbol $sym10$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym11$CSETQ = makeSymbol("CSETQ");
  public static SubLSymbol $sym12$SEIZE_LOCK = makeSymbol("SEIZE-LOCK");
  public static SubLSymbol $sym13$PWHEN = makeSymbol("PWHEN");
  public static SubLSymbol $sym14$RELEASE_LOCK = makeSymbol("RELEASE-LOCK");
