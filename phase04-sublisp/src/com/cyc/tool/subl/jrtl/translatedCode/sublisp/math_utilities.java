...
public  class math_utilities extends SubLTranslatedFile {
  ...
  public static SubLInteger $int0$53 = makeInteger(53);
  public static SubLInteger $int1$64 = makeInteger(64);
  public static SubLInteger $int2$18446744073709551616 = makeInteger("18446744073709551616");
  public static SubLInteger $int3$9223372036854775808 = makeInteger("9223372036854775808");
  public static SubLInteger $int4$2048 = makeInteger(2048);
  public static SubLInteger $int5$1024 = makeInteger(1024);
  public static SubLInteger $int6$9007199254740992 = makeInteger("9007199254740992");
  public static SubLInteger $int7$4503599627370496 = makeInteger("4503599627370496");
  public static SubLInteger $int8$23 = makeInteger(23);
  public static SubLInteger $int9$17976931348623157 = makeInteger("17976931348623157");
  public static SubLInteger $int10$292 = makeInteger(292);
  public static SubLInteger $int11$30 = makeInteger(30);
  public static SubLInteger $int12$_300 = makeInteger(-300);
  public static SubLSymbol $sym13$__ = makeSymbol("<=");
  public static SubLSymbol $sym14$_ = makeSymbol("<");
  public static SubLSymbol $sym15$__ = makeSymbol(">=");
  public static SubLSymbol $sym16$_ = makeSymbol(">");
