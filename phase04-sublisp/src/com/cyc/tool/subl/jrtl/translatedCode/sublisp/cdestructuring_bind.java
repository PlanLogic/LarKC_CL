...
public  class cdestructuring_bind extends SubLTranslatedFile {
  ...
  public static SubLList $list0 = list(makeSymbol("PATTERN"), makeSymbol("DATUM"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str1$DATUM = makeString("DATUM");
  public static SubLSymbol $sym2$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym3$PUNLESS = makeSymbol("PUNLESS");
  public static SubLSymbol $sym4$NULL = makeSymbol("NULL");
  public static SubLSymbol $sym5$CDESTRUCTURING_BIND_ERROR = makeSymbol("CDESTRUCTURING-BIND-ERROR");
  public static SubLList $list6 = list(NIL);
  public static SubLString $str7$CURRENT = makeString("CURRENT");
  public static SubLSymbol $sym8$QUOTE = makeSymbol("QUOTE");
  public static SubLString $str9$The_value__S_failed_to_match_the_ = makeString("The value ~S failed to match the ~S pattern ~S.");
  public static SubLSymbol $sym10$CDESTRUCTURING_BIND = makeSymbol("CDESTRUCTURING-BIND");
  public static SubLList $list11 = list(makeSymbol("FORM"));
  public static SubLList $list12 = list(list(makeSymbol("ERROR"), makeString("Malformed pattern ~S."), makeSymbol("PATTERN")));
  public static SubLString $str13$Malformed_pattern__S_ = makeString("Malformed pattern ~S.");
  public static SubLSymbol $sym14$_WHOLE = makeSymbol("&WHOLE");
  public static SubLList $list15 = list(makeSymbol("&OPTIONAL"), makeSymbol("&REST"), makeSymbol("&BODY"), makeSymbol("&KEY"), makeSymbol("&AUX"));
  public static SubLSymbol $sym16$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym17$DESTRUCTURING_BIND_MUST_CONSP = makeSymbol("DESTRUCTURING-BIND-MUST-CONSP");
  public static SubLSymbol $sym18$CSETQ = makeSymbol("CSETQ");
  public static SubLSymbol $sym19$FIRST = makeSymbol("FIRST");
  public static SubLSymbol $sym20$CPOP = makeSymbol("CPOP");
  public static SubLString $str21$TEMP = makeString("TEMP");
  public static SubLSymbol $sym22$REST = makeSymbol("REST");
  public static SubLSymbol $sym23$_OPTIONAL = makeSymbol("&OPTIONAL");
  public static SubLSymbol $sym24$PCOND = makeSymbol("PCOND");
  public static SubLList $list25 = list(makeSymbol("&REST"), makeSymbol("&BODY"), makeSymbol("&KEY"), makeSymbol("&AUX"));
  public static SubLSymbol $sym26$FIF = makeSymbol("FIF");
  public static SubLSymbol $sym27$CONSP = makeSymbol("CONSP");
  public static SubLSymbol $sym28$DESTRUCTURING_BIND_MUST_LISTP = makeSymbol("DESTRUCTURING-BIND-MUST-LISTP");
  public static SubLList $list29 = list(makeSymbol("&REST"), makeSymbol("&BODY"));
  public static SubLSymbol $sym30$_KEY = makeSymbol("&KEY");
  public static SubLSymbol $sym31$_ALLOW_OTHER_KEYS = makeSymbol("&ALLOW-OTHER-KEYS");
  public static SubLSymbol $sym32$_AUX = makeSymbol("&AUX");
  public static SubLString $str33$ALLOW_OTHER_KEYS_P = makeString("ALLOW-OTHER-KEYS-P");
  public static SubLString $str34$REST = makeString("REST");
  public static SubLString $str35$BAD = makeString("BAD");
  public static SubLSymbol $sym36$CDO = makeSymbol("CDO");
  public static SubLSymbol $sym37$MEMBER = makeSymbol("MEMBER");
  public static SubLList $list38 = list(T);
  public static SubLSymbol $sym39$PWHEN = makeSymbol("PWHEN");
  public static SubLList $list40 = list(makeKeyword("ALLOW-OTHER-KEYS"));
  public static SubLSymbol $sym41$CAND = makeSymbol("CAND");
  public static SubLSymbol $sym42$CNOT = makeSymbol("CNOT");
  public static SubLList $list43 = list(makeSymbol("&AUX"));
  public static SubLString $str44$_TAIL = makeString("-TAIL");
  public static SubLSymbol $sym45$PROPERTY_LIST_MEMBER = makeSymbol("PROPERTY-LIST-MEMBER");
  public static SubLSymbol $sym46$CADR = makeSymbol("CADR");
  public static SubLList $list47 = list(T, NIL);
