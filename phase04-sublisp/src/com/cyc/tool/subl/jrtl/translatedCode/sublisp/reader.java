...
start reading from again or :ERROR if there was some kind of reader error. */
  ...
  public static SubLSymbol $sym0$CDO = makeSymbol("CDO");
  public static SubLList $list1 = list(NIL);
  public static SubLSymbol $sym2$DOUBLE_FLOAT = makeSymbol("DOUBLE-FLOAT");
  public static SubLList $list3 = list(makeKeyword("SL2JAVA"));
  public static SubLInteger $int4$32 = makeInteger(32);
  public static SubLInteger $int5$128 = makeInteger(128);
  public static SubLSymbol $sym6$READTABLE = makeSymbol("READTABLE");
  public static SubLSymbol $sym7$READTABLE_P = makeSymbol("READTABLE-P");
  public static SubLList $list8 = list(makeSymbol("CASE"), makeSymbol("CHARACTER-SYNTAX"), makeSymbol("SINGLE-BYTE-CHAR-SYNTAX"), makeSymbol("MACRO-FUNCTIONS"), makeSymbol("SINGLE-BYTE-MACRO-FUNCTIONS"), makeSymbol("CONSTITUENT-TRAITS"), makeSymbol("SINGLE-BYTE-CONSTIT-TRAITS"), makeSymbol("DISPATCH-TABLES"));
  public static SubLList $list9 = list(makeKeyword("CASE"), makeKeyword("CHARACTER-SYNTAX"), makeKeyword("SINGLE-BYTE-CHAR-SYNTAX"), makeKeyword("MACRO-FUNCTIONS"), makeKeyword("SINGLE-BYTE-MACRO-FUNCTIONS"), makeKeyword("CONSTITUENT-TRAITS"), makeKeyword("SINGLE-BYTE-CONSTIT-TRAITS"), makeKeyword("DISPATCH-TABLES"));
  public static SubLList $list10 = list(makeSymbol("READTABLE-CASE"), makeSymbol("READTABLE-CHARACTER-SYNTAX"), makeSymbol("READTABLE-SINGLE-BYTE-CHAR-SYNTAX"), makeSymbol("READTABLE-MACRO-FUNCTIONS"), makeSymbol("READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS"), makeSymbol("READTABLE-CONSTITUENT-TRAITS"), makeSymbol("READTABLE-SINGLE-BYTE-CONSTIT-TRAITS"), makeSymbol("READTABLE-DISPATCH-TABLES"));
  public static SubLList $list11 = list(makeSymbol("_CSETF-READTABLE-CASE"), makeSymbol("_CSETF-READTABLE-CHARACTER-SYNTAX"), makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-CHAR-SYNTAX"), makeSymbol("_CSETF-READTABLE-MACRO-FUNCTIONS"), makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS"), makeSymbol("_CSETF-READTABLE-CONSTITUENT-TRAITS"), makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-CONSTIT-TRAITS"), makeSymbol("_CSETF-READTABLE-DISPATCH-TABLES"));
  public static SubLSymbol $sym12$DEFAULT_STRUCT_PRINT_FUNCTION = makeSymbol("DEFAULT-STRUCT-PRINT-FUNCTION");
  public static SubLSymbol $sym13$READTABLE_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("READTABLE-PRINT-FUNCTION-TRAMPOLINE");
  public static SubLSymbol $sym14$READTABLE_CASE = makeSymbol("READTABLE-CASE");
  public static SubLSymbol $sym15$_CSETF_READTABLE_CASE = makeSymbol("_CSETF-READTABLE-CASE");
  public static SubLSymbol $sym16$READTABLE_CHARACTER_SYNTAX = makeSymbol("READTABLE-CHARACTER-SYNTAX");
  public static SubLSymbol $sym17$_CSETF_READTABLE_CHARACTER_SYNTAX = makeSymbol("_CSETF-READTABLE-CHARACTER-SYNTAX");
  public static SubLSymbol $sym18$READTABLE_SINGLE_BYTE_CHAR_SYNTAX = makeSymbol("READTABLE-SINGLE-BYTE-CHAR-SYNTAX");
  public static SubLSymbol $sym19$_CSETF_READTABLE_SINGLE_BYTE_CHAR_SYNTAX = makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-CHAR-SYNTAX");
  public static SubLSymbol $sym20$READTABLE_MACRO_FUNCTIONS = makeSymbol("READTABLE-MACRO-FUNCTIONS");
  public static SubLSymbol $sym21$_CSETF_READTABLE_MACRO_FUNCTIONS = makeSymbol("_CSETF-READTABLE-MACRO-FUNCTIONS");
  public static SubLSymbol $sym22$READTABLE_SINGLE_BYTE_MACRO_FUNCTIONS = makeSymbol("READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS");
  public static SubLSymbol $sym23$_CSETF_READTABLE_SINGLE_BYTE_MACRO_FUNCTIONS = makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-MACRO-FUNCTIONS");
  public static SubLSymbol $sym24$READTABLE_CONSTITUENT_TRAITS = makeSymbol("READTABLE-CONSTITUENT-TRAITS");
  public static SubLSymbol $sym25$_CSETF_READTABLE_CONSTITUENT_TRAITS = makeSymbol("_CSETF-READTABLE-CONSTITUENT-TRAITS");
  public static SubLSymbol $sym26$READTABLE_SINGLE_BYTE_CONSTIT_TRAITS = makeSymbol("READTABLE-SINGLE-BYTE-CONSTIT-TRAITS");
  public static SubLSymbol $sym27$_CSETF_READTABLE_SINGLE_BYTE_CONSTIT_TRAITS = makeSymbol("_CSETF-READTABLE-SINGLE-BYTE-CONSTIT-TRAITS");
  public static SubLSymbol $sym28$READTABLE_DISPATCH_TABLES = makeSymbol("READTABLE-DISPATCH-TABLES");
  public static SubLSymbol $sym29$_CSETF_READTABLE_DISPATCH_TABLES = makeSymbol("_CSETF-READTABLE-DISPATCH-TABLES");
  public static SubLSymbol $kw30$CASE = makeKeyword("CASE");
  public static SubLSymbol $kw31$CHARACTER_SYNTAX = makeKeyword("CHARACTER-SYNTAX");
  public static SubLSymbol $kw32$SINGLE_BYTE_CHAR_SYNTAX = makeKeyword("SINGLE-BYTE-CHAR-SYNTAX");
  public static SubLSymbol $kw33$MACRO_FUNCTIONS = makeKeyword("MACRO-FUNCTIONS");
  public static SubLSymbol $kw34$SINGLE_BYTE_MACRO_FUNCTIONS = makeKeyword("SINGLE-BYTE-MACRO-FUNCTIONS");
  public static SubLSymbol $kw35$CONSTITUENT_TRAITS = makeKeyword("CONSTITUENT-TRAITS");
  public static SubLSymbol $kw36$SINGLE_BYTE_CONSTIT_TRAITS = makeKeyword("SINGLE-BYTE-CONSTIT-TRAITS");
  public static SubLSymbol $kw37$DISPATCH_TABLES = makeKeyword("DISPATCH-TABLES");
  public static SubLString $str38$Invalid_slot__S_for_construction_ = makeString("Invalid slot ~S for construction function");
  public static SubLInteger $int39$64 = makeInteger(64);
  public static SubLInteger $int40$256 = makeInteger(256);
  public static SubLInteger $int41$512 = makeInteger(512);
  public static SubLSymbol $kw42$UPCASE = makeKeyword("UPCASE");
  public static SubLSymbol $kw43$CONSTITUENT = makeKeyword("CONSTITUENT");
  public static SubLSymbol $sym44$CONSTITUENT_RMF = makeSymbol("CONSTITUENT-RMF");
  public static SubLList $list45 = list(makeSymbol("CH"), makeSymbol("&OPTIONAL"), list(makeSymbol("READTABLE"), list(makeSymbol("QUOTE"), makeSymbol("*READTABLE*"))));
  public static SubLSymbol $sym46$_READTABLE_ = makeSymbol("*READTABLE*");
  public static SubLSymbol $sym47$FIF = makeSymbol("FIF");
  public static SubLSymbol $sym48$SINGLE_BYTE_P = makeSymbol("SINGLE-BYTE-P");
  public static SubLSymbol $sym49$AREF = makeSymbol("AREF");
  public static SubLSymbol $sym50$CHAR_CODE = makeSymbol("CHAR-CODE");
  public static SubLSymbol $sym51$GETHASH = makeSymbol("GETHASH");
  public static SubLList $list52 = list(makeKeyword("CONSTITUENT"));
  public static SubLSymbol $kw53$INVALID = makeKeyword("INVALID");
  public static SubLSymbol $kw54$TERMINATING_MACRO = makeKeyword("TERMINATING-MACRO");
  public static SubLSymbol $kw55$NON_TERMINATING_MACRO = makeKeyword("NON-TERMINATING-MACRO");
  public static SubLSymbol $kw56$MULTIPLE_ESCAPE = makeKeyword("MULTIPLE-ESCAPE");
  public static SubLSymbol $kw57$SINGLE_ESCAPE = makeKeyword("SINGLE-ESCAPE");
  public static SubLSymbol $kw58$WHITESPACE = makeKeyword("WHITESPACE");
  public static SubLList $list59 = list(makeSymbol("CH"), makeSymbol("TRAIT"), makeSymbol("&OPTIONAL"), list(makeSymbol("READTABLE"), list(makeSymbol("QUOTE"), makeSymbol("*READTABLE*"))));
  public static SubLSymbol $sym60$PLUSP = makeSymbol("PLUSP");
  public static SubLSymbol $sym61$LOGAND = makeSymbol("LOGAND");
  public static SubLSymbol $sym62$CHARACTER_TRAITS = makeSymbol("CHARACTER-TRAITS");
  public static SubLList $list63 = cons(makeSymbol("CH"), makeSymbol("TABLE"));
  public static SubLSymbol $sym64$CAR = makeSymbol("CAR");
  public static SubLSymbol $sym65$DISPATCHING_RMF = makeSymbol("DISPATCHING-RMF");
  public static SubLString $str66$Attempt_to_make_decimal_digit__A_ = makeString("Attempt to make decimal digit ~A be a dispatching macro character.");
  public static SubLString $str67$_A_is_not_a_dispatching_macro_cha = makeString("~A is not a dispatching macro character in ~S.");
  public static SubLSymbol $sym68$WHITESPACE_RMF = makeSymbol("WHITESPACE-RMF");
  public static SubLSymbol $sym69$SINGLE_ESCAPE_RMF = makeSymbol("SINGLE-ESCAPE-RMF");
  public static SubLSymbol $sym70$MULTIPLE_ESCAPE_RMF = makeSymbol("MULTIPLE-ESCAPE-RMF");
  public static SubLSymbol $sym71$LEFT_PAREN_RMF = makeSymbol("LEFT-PAREN-RMF");
  public static SubLSymbol $sym72$RIGHT_PAREN_RMF = makeSymbol("RIGHT-PAREN-RMF");
  public static SubLSymbol $sym73$SINGLE_QUOTE_RMF = makeSymbol("SINGLE-QUOTE-RMF");
  public static SubLSymbol $sym74$SEMICOLON_RMF = makeSymbol("SEMICOLON-RMF");
  public static SubLSymbol $sym75$DOUBLE_QUOTE_RMF = makeSymbol("DOUBLE-QUOTE-RMF");
  public static SubLSymbol $sym76$BACKQUOTE_RMF = makeSymbol("BACKQUOTE-RMF");
  public static SubLSymbol $sym77$COMMA_RMF = makeSymbol("COMMA-RMF");
  public static SubLSymbol $sym78$SHARPSIGN_BACKSLASH_RMF = makeSymbol("SHARPSIGN-BACKSLASH-RMF");
  public static SubLSymbol $sym79$SHARPSIGN_SINGLE_QUOTE_RMF = makeSymbol("SHARPSIGN-SINGLE-QUOTE-RMF");
  public static SubLSymbol $sym80$SHARPSIGN_LEFT_PAREN_RMF = makeSymbol("SHARPSIGN-LEFT-PAREN-RMF");
  public static SubLSymbol $sym81$SHARPSIGN_ASTERISK_RMF = makeSymbol("SHARPSIGN-ASTERISK-RMF");
  public static SubLSymbol $sym82$SHARPSIGN_COLON_RMF = makeSymbol("SHARPSIGN-COLON-RMF");
  public static SubLSymbol $sym83$SHARPSIGN_DOT_RMF = makeSymbol("SHARPSIGN-DOT-RMF");
  public static SubLSymbol $sym84$SHARPSIGN_B_RMF = makeSymbol("SHARPSIGN-B-RMF");
  public static SubLSymbol $sym85$SHARPSIGN_O_RMF = makeSymbol("SHARPSIGN-O-RMF");
  public static SubLSymbol $sym86$SHARPSIGN_X_RMF = makeSymbol("SHARPSIGN-X-RMF");
  public static SubLSymbol $sym87$SHARPSIGN_R_RMF = makeSymbol("SHARPSIGN-R-RMF");
  public static SubLSymbol $sym88$SHARPSIGN_C_RMF = makeSymbol("SHARPSIGN-C-RMF");
  public static SubLSymbol $sym89$SHARPSIGN_A_RMF = makeSymbol("SHARPSIGN-A-RMF");
  public static SubLSymbol $sym90$SHARPSIGN_S_RMF = makeSymbol("SHARPSIGN-S-RMF");
  public static SubLSymbol $sym91$SHARPSIGN_P_RMF = makeSymbol("SHARPSIGN-P-RMF");
  public static SubLSymbol $sym92$SHARPSIGN_CAPITAL_G_RMF = makeSymbol("SHARPSIGN-CAPITAL-G-RMF");
  public static SubLSymbol $sym93$SHARPSIGN_EQUALS_RMF = makeSymbol("SHARPSIGN-EQUALS-RMF");
  public static SubLSymbol $sym94$SHARPSIGN_SHARPSIGN_RMF = makeSymbol("SHARPSIGN-SHARPSIGN-RMF");
  public static SubLSymbol $sym95$SHARPSIGN_PLUS_RMF = makeSymbol("SHARPSIGN-PLUS-RMF");
  public static SubLSymbol $sym96$SHARPSIGN_MINUS_RMF = makeSymbol("SHARPSIGN-MINUS-RMF");
  public static SubLSymbol $sym97$SHARPSIGN_VERTICAL_BAR_RMF = makeSymbol("SHARPSIGN-VERTICAL-BAR-RMF");
  public static SubLList $list98 = list(Characters.CHAR_backspace, Characters.CHAR_tab, Characters.CHAR_newline, Characters.CHAR_newline, Characters.CHAR_page, Characters.CHAR_return, Characters.CHAR_space, Characters.CHAR_rubout);
  public static SubLList $list99 = list(new SubLObject[] {Characters.CHAR_0, Characters.CHAR_1, Characters.CHAR_2, Characters.CHAR_3, Characters.CHAR_4, Characters.CHAR_5, Characters.CHAR_6, Characters.CHAR_7, Characters.CHAR_8, Characters.CHAR_9, Characters.CHAR_a, Characters.CHAR_b, Characters.CHAR_c, Characters.CHAR_d, Characters.CHAR_e, Characters.CHAR_f, Characters.CHAR_g, Characters.CHAR_h, Characters.CHAR_i, Characters.CHAR_j, Characters.CHAR_k, Characters.CHAR_l, Characters.CHAR_m, Characters.CHAR_n, Characters.CHAR_o, Characters.CHAR_p, Characters.CHAR_q, Characters.CHAR_r, Characters.CHAR_s, Characters.CHAR_t, Characters.CHAR_u, Characters.CHAR_v, Characters.CHAR_w, Characters.CHAR_x, Characters.CHAR_y, Characters.CHAR_z, Characters.CHAR_A, Characters.CHAR_B, Characters.CHAR_C, Characters.CHAR_D, Characters.CHAR_E, Characters.CHAR_F, Characters.CHAR_G, Characters.CHAR_H, Characters.CHAR_I, Characters.CHAR_J, Characters.CHAR_K, Characters.CHAR_L, Characters.CHAR_M, Characters.CHAR_N, Characters.CHAR_O, Characters.CHAR_P, Characters.CHAR_Q, Characters.CHAR_R, Characters.CHAR_S, Characters.CHAR_T, Characters.CHAR_U, Characters.CHAR_V, Characters.CHAR_W, Characters.CHAR_X, Characters.CHAR_Y, Characters.CHAR_Z});
  public static SubLSymbol $sym100$READER_ERROR = makeSymbol("READER-ERROR");
  public static SubLSymbol $sym101$ERROR = makeSymbol("ERROR");
  public static SubLSymbol $sym102$END_OF_FILE = makeSymbol("END-OF-FILE");
  public static SubLString $str103$End_of_file_on_stream__S_ = makeString("End of file on stream ~S.");
  public static SubLString $str104$_S_is_invalid_token_syntax_ = makeString("~S is invalid token syntax.");
  public static SubLString $str105$The__A_reader_macro_is_not_implem = makeString("The ~A reader macro is not implemented.");
  public static SubLString $str106$The__A_reader_macro_does_not_take = makeString("The ~A reader macro does not take an argument.");
  public static SubLString $str107$Illegal_argument__D_for_the__A_re = makeString("Illegal argument ~D for the ~A reader macro.");
  public static SubLSymbol $sym108$CLET = makeSymbol("CLET");
  public static SubLList $list109 = list(list(makeSymbol("*READ-BASE*"), TEN_INTEGER), list(makeSymbol("*READ-DEFAULT-FLOAT-FORMAT*"), list(makeSymbol("QUOTE"), makeSymbol("SINGLE-FLOAT"))), list(makeSymbol("*READ-EVAL*"), T), list(makeSymbol("*READ-SUPPRESS*"), NIL), list(makeSymbol("*READTABLE*"), makeSymbol("*STANDARD-READTABLE*")));
  public static SubLSymbol $sym110$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $kw111$EOF = makeKeyword("EOF");
  public static SubLSymbol $kw112$ERROR = makeKeyword("ERROR");
  public static SubLSymbol $sym113$READ_TOKEN = makeSymbol("READ-TOKEN");
  public static SubLSymbol $sym114$READ_TOKEN_P = makeSymbol("READ-TOKEN-P");
  public static SubLList $list115 = list(makeSymbol("POINTER"), makeSymbol("BUFFER"), makeSymbol("ESCAPES"));
  public static SubLList $list116 = list(makeKeyword("POINTER"), makeKeyword("BUFFER"), makeKeyword("ESCAPES"));
  public static SubLList $list117 = list(makeSymbol("READ-TOKEN-POINTER"), makeSymbol("READ-TOKEN-BUFFER"), makeSymbol("READ-TOKEN-ESCAPES"));
  public static SubLList $list118 = list(makeSymbol("_CSETF-READ-TOKEN-POINTER"), makeSymbol("_CSETF-READ-TOKEN-BUFFER"), makeSymbol("_CSETF-READ-TOKEN-ESCAPES"));
  public static SubLSymbol $sym119$READ_TOKEN_PRINT_FUNCTION_TRAMPOLINE = makeSymbol("READ-TOKEN-PRINT-FUNCTION-TRAMPOLINE");
  public static SubLSymbol $sym120$READ_TOKEN_POINTER = makeSymbol("READ-TOKEN-POINTER");
  public static SubLSymbol $sym121$_CSETF_READ_TOKEN_POINTER = makeSymbol("_CSETF-READ-TOKEN-POINTER");
  public static SubLSymbol $sym122$READ_TOKEN_BUFFER = makeSymbol("READ-TOKEN-BUFFER");
  public static SubLSymbol $sym123$_CSETF_READ_TOKEN_BUFFER = makeSymbol("_CSETF-READ-TOKEN-BUFFER");
  public static SubLSymbol $sym124$READ_TOKEN_ESCAPES = makeSymbol("READ-TOKEN-ESCAPES");
  public static SubLSymbol $sym125$_CSETF_READ_TOKEN_ESCAPES = makeSymbol("_CSETF-READ-TOKEN-ESCAPES");
  public static SubLSymbol $kw126$POINTER = makeKeyword("POINTER");
  public static SubLSymbol $kw127$BUFFER = makeKeyword("BUFFER");
  public static SubLSymbol $kw128$ESCAPES = makeKeyword("ESCAPES");
  public static SubLList $list129 = list(makeSymbol("TOKEN"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list130 = list(list(makeSymbol("MAKE-READ-TOKEN")));
  public static SubLList $list131 = list(makeSymbol("CSETF"), list(makeSymbol("READ-TOKEN-POINTER"), makeSymbol("TOKEN")), ZERO_INTEGER);
  public static SubLList $list132 = list(makeSymbol("CSETF"), list(makeSymbol("READ-TOKEN-BUFFER"), makeSymbol("TOKEN")), list(makeSymbol("MAKE-STRING"), makeSymbol("*INITIAL-TOKEN-SIZE*")));
  public static SubLList $list133 = list(makeSymbol("CSETF"), list(makeSymbol("READ-TOKEN-ESCAPES"), makeSymbol("TOKEN")), list(makeSymbol("QUOTE"), NIL));
  public static SubLString $str134$_A_is_an_invalid_character_ = makeString("~A is an invalid character.");
  public static SubLString $str135$Fell_through_character_syntax_on_ = makeString("Fell through character syntax on ~A.");
  public static SubLSymbol $kw136$DOWNCASE = makeKeyword("DOWNCASE");
  public static SubLString $str137$_S_is_not_a_known_package_ = makeString("~S is not a known package.");
  public static SubLSymbol $kw138$PRESERVE = makeKeyword("PRESERVE");
  public static SubLSymbol $kw139$INVERT = makeKeyword("INVERT");
  public static SubLSymbol $sym140$CONSING_DOT = makeUninternedSymbol("CONSING-DOT");
  public static SubLString $str141$KEYWORD = makeString("KEYWORD");
  public static SubLSymbol $kw142$EXTERNAL = makeKeyword("EXTERNAL");
  public static SubLString $str143$_S_is_not_external_in__S_ = makeString("~S is not external in ~S.");
  public static SubLFloat $float144$0_0 = makeDouble(0.0);
  public static SubLSymbol $kw145$INITIAL = makeKeyword("INITIAL");
  public static SubLSymbol $kw146$DOT1 = makeKeyword("DOT1");
  public static SubLSymbol $kw147$SIGN = makeKeyword("SIGN");
  public static SubLSymbol $kw148$DECIMALS = makeKeyword("DECIMALS");
  public static SubLSymbol $kw149$DIGITS = makeKeyword("DIGITS");
  public static SubLSymbol $kw150$EXPONENT = makeKeyword("EXPONENT");
  public static SubLSymbol $kw151$DOT2 = makeKeyword("DOT2");
  public static SubLSymbol $kw152$SLASH = makeKeyword("SLASH");
  public static SubLSymbol $kw153$DENOMINATOR = makeKeyword("DENOMINATOR");
  public static SubLSymbol $kw154$FRACTION = makeKeyword("FRACTION");
  public static SubLSymbol $kw155$DECIMALS2 = makeKeyword("DECIMALS2");
  public static SubLSymbol $kw156$EXPONENT_SIGN = makeKeyword("EXPONENT-SIGN");
  public static SubLSymbol $kw157$EXPONENT_VALUE = makeKeyword("EXPONENT-VALUE");
  public static SubLString $str158$Can_t_happen_ = makeString("Can't happen.");
  public static SubLSymbol $kw159$DIGIT = makeKeyword("DIGIT");
  public static SubLString $str160$_S_does_not_contain_an_integer_ = makeString("~S does not contain an integer.");
  public static SubLSymbol $kw161$TRAILING_WHITESPACE = makeKeyword("TRAILING-WHITESPACE");
  public static SubLString $str162$The__S_reader_macro_does_not_take = makeString("The ~S reader macro does not take an argument.");
  public static SubLString $str163$The__S_reader_macro_expected_a_st = makeString("The ~S reader macro expected a string.");
  public static SubLString $str164$The__S_reader_macro_could_not_int = makeString("The ~S reader macro could not interpret ~S as a GUID string.");
  public static SubLSymbol $sym165$RIGHT_PAREN = makeUninternedSymbol("RIGHT-PAREN");
  public static SubLString $str166$Nothing_before_consing_dot_ = makeString("Nothing before consing dot.");
  public static SubLSymbol $kw167$LIST = makeKeyword("LIST");
  public static SubLSymbol $kw168$CONSING_DOT = makeKeyword("CONSING-DOT");
  public static SubLString $str169$Nothing_after_consing_dot_ = makeString("Nothing after consing dot.");
  public static SubLString $str170$Too_many_consing_dots_ = makeString("Too many consing dots.");
  public static SubLSymbol $kw171$AFTER_CONSING_DOT = makeKeyword("AFTER-CONSING-DOT");
  public static SubLString $str172$Too_many_objects_after_consing_do = makeString("Too many objects after consing dot.");
  public static SubLString $str173$Ignoring_unmatched_close_parenthe = makeString("Ignoring unmatched close parenthesis.");
  public static SubLString $str174$Unmatched__A_ = makeString("Unmatched ~A.");
  public static SubLSymbol $sym175$QUOTE = makeSymbol("QUOTE");
  public static SubLSymbol $kw176$NORMAL = makeKeyword("NORMAL");
  public static SubLSymbol $kw177$ESCAPE = makeKeyword("ESCAPE");
  public static SubLSymbol $sym178$LIST = makeSymbol("LIST");
  public static SubLSymbol $sym179$LIST_ = makeSymbol("LIST*");
  public static SubLSymbol $sym180$APPEND = makeSymbol("APPEND");
  public static SubLSymbol $sym181$NCONC = makeSymbol("NCONC");
  public static SubLSymbol $sym182$VECTOR = makeSymbol("VECTOR");
  public static SubLSymbol $sym183$BQ_VECTOR = makeSymbol("BQ-VECTOR");
  public static SubLSymbol $sym184$BQ_APPEND = makeSymbol("BQ-APPEND");
  public static SubLString $str185$_ = makeString(",");
  public static SubLString $str186$_ = makeString("@");
  public static SubLString $str187$_ = makeString(".");
  public static SubLString $str188$BQ_VECTOR = makeString("BQ-VECTOR");
  public static SubLString $str189$_A_after_dot_in__S_ = makeString("~A after dot in ~S.");
  public static SubLList $list190 = list(makeSymbol("QUOTE"), T, NIL);
  public static SubLList $list191 = list(makeSymbol("APPEND"), makeSymbol("LIST"), makeSymbol("LIST*"), makeSymbol("NCONC"));
  public static SubLSymbol $sym192$CONS = makeSymbol("CONS");
  public static SubLSymbol $sym193$BQ_LIST_ = makeSymbol("BQ-LIST*");
  public static SubLSymbol $sym194$BQ_CONS = makeSymbol("BQ-CONS");
  public static SubLList $list195 = list(cons(makeSymbol("CONS"), makeSymbol("BQ-CONS")), cons(makeSymbol("LIST"), makeSymbol("BQ-LIST")), cons(makeSymbol("APPEND"), makeSymbol("BQ-APPEND")), cons(makeSymbol("NCONC"), makeSymbol("BQ-NCONC")));
  public static SubLString $str196$_A_read_after_backquote_in__S_ = makeString("~A read after backquote in ~S.");
  public static SubLString $str197$_S_read_outside_a_backquote_ = makeString("~S read outside a backquote.");
  public static SubLString $str198$Undefined_reader_macro__A_A_ = makeString("Undefined reader macro ~A~A.");
  public static SubLString $str199$_S_is_not_the_name_of_a_character = makeString("~S is not the name of a character.");
  public static SubLSymbol $sym200$FUNCTION = makeSymbol("FUNCTION");
  public static SubLString $str201$Attempt_the_use_the__A_reader_mac = makeString("Attempt the use the ~A reader macro when ~S is ~S.");
  public static SubLSymbol $sym202$_READ_EVAL_ = makeSymbol("*READ-EVAL*");
  public static SubLInteger $int203$36 = makeInteger(36);
  public static SubLString $str204$The_form_after__A_reader_macro_wa = makeString("The form after ~A reader macro was not a list.");
  public static SubLString $str205$Label__S_appears_more_than_once_ = makeString("Label ~S appears more than once.");
  public static SubLString $str206$Label__S_has_not_been_seen_ = makeString("Label ~S has not been seen.");
  public static SubLSymbol $kw207$NOT = makeKeyword("NOT");
  public static SubLString $str208$Bogus_feature_expression__S_ = makeString("Bogus feature expression ~S.");
  public static SubLSymbol $kw209$AND = makeKeyword("AND");
  public static SubLSymbol $kw210$OR = makeKeyword("OR");
  public static SubLString $str211$Unknown_feature_operator__S_ = makeString("Unknown feature operator ~S.");
  public static SubLSymbol $kw212$HASH = makeKeyword("HASH");
  public static SubLSymbol $kw213$VERTICAL_BAR = makeKeyword("VERTICAL-BAR");
