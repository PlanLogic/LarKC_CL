...
public  class stream_macros extends SubLTranslatedFile {
  ...
  public static SubLObject declare_stream_macros_file() {
    declareMacro(myName, "ensure_private_stream", "ENSURE-PRIVATE-STREAM");
    declareFunction(myName, "ensure_private_stream_internal", "ENSURE-PRIVATE-STREAM-INTERNAL", 1, 0, false);
    declareMacro(myName, "cwith_output_to_string", "CWITH-OUTPUT-TO-STRING");
    declareMacro(myName, "with_input_from_string", "WITH-INPUT-FROM-STRING");
    declareFunction(myName, "with_input_from_string_internal", "WITH-INPUT-FROM-STRING-INTERNAL", 6, 0, false);
    declareMacro(myName, "with_open_stream", "WITH-OPEN-STREAM");
    declareMacro(myName, "with_open_file", "WITH-OPEN-FILE");
    declareMacro(myName, "with_bounding_index_designators", "WITH-BOUNDING-INDEX-DESIGNATORS");
    declareMacro(myName, "with_stream_lock", "WITH-STREAM-LOCK");
    declareMacro(myName, "synonym_stream_p", "SYNONYM-STREAM-P");
    return NIL;
  }
  ...
  public static SubLSymbol $sym0$CLET = makeSymbol("CLET");
  public static SubLList $list1 = list(list(makeSymbol("*STREAM-REQUIRES-LOCKING*"), NIL));
  public static SubLList $list2 = list(list(makeSymbol("STREAM-VAR"), makeSymbol("RESULT-VAR")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLSymbol $sym3$CUNWIND_PROTECT = makeSymbol("CUNWIND-PROTECT");
  public static SubLSymbol $sym4$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym5$CSETQ = makeSymbol("CSETQ");
  public static SubLList $list6 = list(list(makeSymbol("MAKE-PRIVATE-STRING-OUTPUT-STREAM")));
  public static SubLSymbol $sym7$CSETF = makeSymbol("CSETF");
  public static SubLSymbol $sym8$GET_OUTPUT_STREAM_STRING = makeSymbol("GET-OUTPUT-STREAM-STRING");
  public static SubLSymbol $sym9$CLOSE = makeSymbol("CLOSE");
  public static SubLList $list10 = list(list(makeSymbol("VAR"), makeSymbol("STRING"), makeSymbol("&KEY"), makeSymbol("INDEX"), list(makeSymbol("START"), ZERO_INTEGER), makeSymbol("END")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLList $list11 = list(makeKeyword("INDEX"), makeKeyword("START"), makeKeyword("END"));
  public static SubLSymbol $kw12$ALLOW_OTHER_KEYS = makeKeyword("ALLOW-OTHER-KEYS");
  public static SubLSymbol $kw13$INDEX = makeKeyword("INDEX");
  public static SubLSymbol $kw14$START = makeKeyword("START");
  public static SubLSymbol $kw15$END = makeKeyword("END");
  public static SubLSymbol $sym16$MAKE_PRIVATE_STRING_INPUT_STREAM = makeSymbol("MAKE-PRIVATE-STRING-INPUT-STREAM");
  public static SubLSymbol $sym17$STREAM_INPUT_INDEX = makeSymbol("STREAM-INPUT-INDEX");
  public static SubLList $list18 = list(list(makeSymbol("VAR"), makeSymbol("STREAM")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str19$STREAM_VAR = makeString("STREAM-VAR");
  public static SubLSymbol $sym20$PWHEN = makeSymbol("PWHEN");
  public static SubLList $list21 = list(list(makeSymbol("STREAM"), makeSymbol("FILESPEC"), makeSymbol("&REST"), makeSymbol("KEYS")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLSymbol $sym22$WITH_OPEN_STREAM = makeSymbol("WITH-OPEN-STREAM");
  public static SubLSymbol $sym23$OPEN = makeSymbol("OPEN");
  public static SubLList $list24 = list(list(makeSymbol("SEQUENCE"), makeSymbol("START-VAR"), makeSymbol("END-VAR")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str25$LENGTH = makeString("LENGTH");
  public static SubLSymbol $sym26$LENGTH = makeSymbol("LENGTH");
  public static SubLSymbol $sym27$PUNLESS = makeSymbol("PUNLESS");
  public static SubLList $list28 = list(ZERO_INTEGER);
  public static SubLSymbol $sym29$MUST = makeSymbol("MUST");
  public static SubLSymbol $sym30$__ = makeSymbol(">=");
  public static SubLString $str31$Negative_start_index__D_given_for = makeString("Negative start index ~D given for ~S.");
  public static SubLSymbol $sym32$__ = makeSymbol("<=");
  public static SubLString $str33$The_end_index__D_given_for__S_is_ = makeString("The end index ~D given for ~S is greater than the length, ~D.");
  public static SubLString $str34$The_start_index__D_given_for__S_i = makeString("The start index ~D given for ~S is greater than the end index ~D.");
  public static SubLList $list35 = list(makeSymbol("STREAM"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str36$LOCK_VAR = makeString("LOCK-VAR");
  public static SubLSymbol $sym37$STREAM_LOCK = makeSymbol("STREAM-LOCK");
  public static SubLSymbol $sym38$PIF = makeSymbol("PIF");
  public static SubLSymbol $sym39$LOCK_P = makeSymbol("LOCK-P");
  public static SubLSymbol $sym40$WITH_LOCK_HELD = makeSymbol("WITH-LOCK-HELD");
  public static SubLList $list41 = list(makeSymbol("STREAM"));
  public static SubLSymbol $sym42$STREAM_STREAM_TYPE = makeSymbol("STREAM-STREAM-TYPE");
  public static SubLList $list43 = list(makeKeyword("SYNONYM"));
