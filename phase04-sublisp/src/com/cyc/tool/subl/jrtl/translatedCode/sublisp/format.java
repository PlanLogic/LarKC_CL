...
public  class format extends SubLTranslatedFile {
  ...
  public static SubLObject declare_format_file() {
    declareFunction(myName, "format_directive_p", "FORMAT-DIRECTIVE-P", 1, 0, false);
    declareFunction(myName, "matching_bracket", "MATCHING-BRACKET", 1, 0, false);
    declareFunction(myName, "call_format_directive", "CALL-FORMAT-DIRECTIVE", 10, 0, false);
    declareMacro(myName, "defformat", "DEFFORMAT");
    declareMacro(myName, "defformat_bracketed", "DEFFORMAT-BRACKETED");
    declareFunction(myName, "unimplemented_format_directive", "UNIMPLEMENTED-FORMAT-DIRECTIVE", 1, 1, false);
    declareFunction(myName, "check_flags", "CHECK-FLAGS", 5, 0, false);
    declareFunction(myName, "format_typep", "FORMAT-TYPEP", 2, 0, false);
    declareMacro(myName, "with_format_parameters", "WITH-FORMAT-PARAMETERS");
    declareFunction(myName, "illegal_directive", "ILLEGAL-DIRECTIVE", 2, 0, false);
    declareFunction(myName, "bad_format_directive", "BAD-FORMAT-DIRECTIVE", 2, 0, false);
    declareFunction(myName, "not_enough_format_arguments", "NOT-ENOUGH-FORMAT-ARGUMENTS", 1, 0, false);
    declareFunction(myName, "matching_bracket_not_found", "MATCHING-BRACKET-NOT-FOUND", 3, 0, false);
    declareFunction(myName, "not_a_list_argument", "NOT-A-LIST-ARGUMENT", 1, 0, false);
    declareFunction(myName, "not_a_format_control", "NOT-A-FORMAT-CONTROL", 1, 0, false);
    declareFunction(myName, "repitition_designator_value", "REPITITION-DESIGNATOR-VALUE", 1, 0, false);
    declareFunction(myName, "format_repeat", "FORMAT-REPEAT", 3, 0, false);
    declareFunction(myName, "format_padded", "FORMAT-PADDED", 7, 0, false);
    declareFunction(myName, "format_c_directive", "FORMAT-C-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_percent_directive", "FORMAT-PERCENT-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_ampersand_directive", "FORMAT-AMPERSAND-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_vertical_bar_directive", "FORMAT-VERTICAL-BAR-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_tilde_directive", "FORMAT-TILDE-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_integer_internal", "FORMAT-INTEGER-INTERNAL", 2, 0, false);
    declareFunction(myName, "format_integer", "FORMAT-INTEGER", 6, 0, false);
    declareFunction(myName, "integer_truncate", "INTEGER-TRUNCATE", 2, 0, false);
    declareFunction(myName, "format_cardinal_internal", "FORMAT-CARDINAL-INTERNAL", 4, 0, false);
    declareFunction(myName, "format_cardinal", "FORMAT-CARDINAL", 2, 0, false);
    declareFunction(myName, "format_ordinal", "FORMAT-ORDINAL", 2, 0, false);
    declareFunction(myName, "format_r_directive", "FORMAT-R-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_d_directive", "FORMAT-D-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_b_directive", "FORMAT-B-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_o_directive", "FORMAT-O-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_x_directive", "FORMAT-X-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "split_flonum_digits", "SPLIT-FLONUM-DIGITS", 2, 0, false);
    declareFunction(myName, "round_digits", "ROUND-DIGITS", 2, 0, false);
    declareFunction(myName, "digits_add_1_int", "DIGITS-ADD-1-INT", 1, 0, false);
    declareFunction(myName, "digits_add_1", "DIGITS-ADD-1", 1, 0, false);
    declareFunction(myName, "round_decimal_digits", "ROUND-DECIMAL-DIGITS", 3, 0, false);
    declareFunction(myName, "format_f_directive", "FORMAT-F-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_e_directive", "FORMAT-E-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_g_directive", "FORMAT-G-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_dollarsign_directive", "FORMAT-DOLLARSIGN-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_a_directive", "FORMAT-A-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_s_directive", "FORMAT-S-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_w_directive", "FORMAT-W-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_underscore_directive", "FORMAT-UNDERSCORE-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_i_directive", "FORMAT-I-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_slash_directive", "FORMAT-SLASH-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_t_directive", "FORMAT-T-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_less_than_directive", "FORMAT-LESS-THAN-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_greater_than_directive", "FORMAT-GREATER-THAN-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "backup_args", "BACKUP-ARGS", 3, 0, false);
    declareFunction(myName, "format_asterisk_directive", "FORMAT-ASTERISK-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_left_bracket_directive", "FORMAT-LEFT-BRACKET-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_right_bracket_directive", "FORMAT-RIGHT-BRACKET-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_sublist_iteration", "FORMAT-SUBLIST-ITERATION", 7, 0, false);
    declareFunction(myName, "format_iteration", "FORMAT-ITERATION", 7, 0, false);
    declareFunction(myName, "format_left_brace_directive", "FORMAT-LEFT-BRACE-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_right_brace_directive", "FORMAT-RIGHT-BRACE-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_question_mark_directive", "FORMAT-QUESTION-MARK-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_left_paren_directive", "FORMAT-LEFT-PAREN-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_right_paren_directive", "FORMAT-RIGHT-PAREN-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_p_directive", "FORMAT-P-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_semicolon_directive", "FORMAT-SEMICOLON-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_circumflex_directive", "FORMAT-CIRCUMFLEX-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "format_newline_directive", "FORMAT-NEWLINE-DIRECTIVE", 9, 0, false);
    declareFunction(myName, "really_format", "REALLY-FORMAT", 3, 0, false);
    declareFunction(myName, "format_internal", "FORMAT-INTERNAL", 6, 0, false);
    declareFunction(myName, "find_directive", "FIND-DIRECTIVE", 4, 0, false);
    declareFunction(myName, "parse_format_command", "PARSE-FORMAT-COMMAND", 3, 2, false);
    return NIL;
  }
  ...
  public static SubLInteger $int0$50 = makeInteger(50);
  public static SubLList $list1 = list(makeSymbol("NAME"), makeSymbol("CHARACTER"), makeSymbol("LAMBDA-LIST"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLSymbol $sym2$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym3$DECLAIM = makeSymbol("DECLAIM");
  public static SubLSymbol $sym4$FACCESS = makeSymbol("FACCESS");
  public static SubLSymbol $sym5$PRIVATE = makeSymbol("PRIVATE");
  public static SubLSymbol $sym6$DEFINE = makeSymbol("DEFINE");
  public static SubLSymbol $sym7$SETHASH = makeSymbol("SETHASH");
  public static SubLSymbol $sym8$_FORMAT_DIRECTIVES_ = makeSymbol("*FORMAT-DIRECTIVES*");
  public static SubLSymbol $sym9$FUNCTION = makeSymbol("FUNCTION");
  public static SubLList $list10 = list(makeSymbol("NAME"), makeSymbol("LEFT"), makeSymbol("RIGHT"), makeSymbol("LAMBDA-LIST"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLSymbol $sym11$_MATCHING_BRACKETS_ = makeSymbol("*MATCHING-BRACKETS*");
  public static SubLString $str12$The__A_format_directive_is_not_ye = makeString("The ~A format directive is not yet ~@[fully ~]implemented.");
  public static SubLString $str13$The____C_format_directive_does_no = makeString("The ~~~C format directive does not take an at-sign modifier.");
  public static SubLString $str14$The____C_format_directive_does_no = makeString("The ~~~C format directive does not take an colon modifier.");
  public static SubLString $str15$The____C_format_directive_does_no = makeString("The ~~~C format directive does not take both an at-sign and colon modifier.");
  public static SubLSymbol $sym16$OR = makeSymbol("OR");
  public static SubLSymbol $sym17$INTEGER = makeSymbol("INTEGER");
  public static SubLList $list18 = list(makeSymbol("&OPTIONAL"), makeSymbol("START"), makeSymbol("END"));
  public static SubLString $str19$Unrecognized_type_specifier__S_ = makeString("Unrecognized type specifier ~S.");
  public static SubLSymbol $sym20$CHARACTER = makeSymbol("CHARACTER");
  public static SubLSymbol $sym21$NULL = makeSymbol("NULL");
  public static SubLList $list22 = list(makeSymbol("PATTERN"), makeSymbol("PARAMETERS"), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str23$TAIL = makeString("TAIL");
  public static SubLList $list24 = list(makeSymbol("VAR"), makeSymbol("INIT"), makeSymbol("TYPE"));
  public static SubLSymbol $sym25$CSETF = makeSymbol("CSETF");
  public static SubLSymbol $sym26$CAR = makeSymbol("CAR");
  public static SubLSymbol $sym27$CPOP = makeSymbol("CPOP");
  public static SubLSymbol $sym28$PUNLESS = makeSymbol("PUNLESS");
  public static SubLSymbol $sym29$FORMAT_TYPEP = makeSymbol("FORMAT-TYPEP");
  public static SubLSymbol $sym30$QUOTE = makeSymbol("QUOTE");
  public static SubLSymbol $sym31$ERROR = makeSymbol("ERROR");
  public static SubLString $str32$The__S_parameter__S_is_not_of_typ = makeString("The ~S parameter ~S is not of type ~S.");
  public static SubLList $list33 = list(makeSymbol("QUOTE"), makeSymbol("FORMAT"));
  public static SubLSymbol $sym34$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym35$PWHEN = makeSymbol("PWHEN");
  public static SubLList $list36 = list(list(makeSymbol("ERROR"), makeString("Too many ~S parameters."), list(makeSymbol("QUOTE"), makeSymbol("FORMAT"))));
  public static SubLString $str37$Stray____C_directive_in__S_string = makeString("Stray ~~~C directive in ~S string ~S.");
  public static SubLSymbol $sym38$FORMAT = makeSymbol("FORMAT");
  public static SubLString $str39$_S_is_not_a_recognized__S_control = makeString("~S is not a recognized ~S control.");
  public static SubLString $str40$_S_directive__S_ran_out_of_argume = makeString("~S directive ~S ran out of arguments.");
  public static SubLString $str41$No_matching__S_found_for__S_in__S = makeString("No matching ~S found for ~S in ~S.");
  public static SubLString $str42$The__S__S_directive_takes_a_list_ = makeString("The ~S ~S directive takes a list as an argument.");
  public static SubLString $str43$_S_is_not_a_valid__S_control_ = makeString("~S is not a valid ~S control.");
  public static SubLString $str44$_S_is_not_a_valid__S_repitition_s = makeString("~S is not a valid ~S repitition specifier.");
  public static SubLString $str45$Too_many__S_parameters_ = makeString("Too many ~S parameters.");
  public static SubLSymbol $sym46$CHARACTERP = makeSymbol("CHARACTERP");
  public static SubLString $str47$__ = makeString("#\\");
  public static SubLSymbol $sym48$FORMAT_C_DIRECTIVE = makeSymbol("FORMAT-C-DIRECTIVE");
  public static SubLList $list49 = list(makeSymbol("OR"), makeSymbol("NULL"), list(makeSymbol("INTEGER"), ZERO_INTEGER));
  public static SubLSymbol $sym50$FORMAT_PERCENT_DIRECTIVE = makeSymbol("FORMAT-PERCENT-DIRECTIVE");
  public static SubLSymbol $sym51$FORMAT_AMPERSAND_DIRECTIVE = makeSymbol("FORMAT-AMPERSAND-DIRECTIVE");
  public static SubLSymbol $sym52$FORMAT_VERTICAL_BAR_DIRECTIVE = makeSymbol("FORMAT-VERTICAL-BAR-DIRECTIVE");
  public static SubLSymbol $sym53$FORMAT_TILDE_DIRECTIVE = makeSymbol("FORMAT-TILDE-DIRECTIVE");
  public static SubLList $list54 = list(makeSymbol("INTEGER"), ZERO_INTEGER);
  public static SubLList $list55 = list(makeSymbol("INTEGER"), ONE_INTEGER);
  public static SubLString $str56$_ = makeString("-");
  public static SubLString $str57$_ = makeString("+");
  public static SubLSymbol $sym58$INTEGERP = makeSymbol("INTEGERP");
  public static SubLObject $ic59 = Vectors.vector(new SubLObject[] {makeString(""), makeString(" thousand"), makeString(" million"), makeString(" billion"), makeString(" trillion"), makeString(" quadrillion"), makeString(" quintillion"), makeString(" sextillion"), makeString(" septillion"), makeString(" octillion"), makeString(" nonillion"), makeString(" decillion"), makeString(" undecillion"), makeString(" duodecillion"), makeString(" tredecillion"), makeString(" quattuordecillion"), makeString(" quindecillion"), makeString(" sexdecillion"), makeString(" septendecillion"), makeString(" octodecillion"), makeString(" novemdecillion"), makeString(" vigintillion")});
  public static SubLString $str60$_times_ten_to_the_ = makeString(" times ten to the ");
  public static SubLString $str61$_power = makeString(" power");
  public static SubLString $str62$_plus = makeString(" plus");
  public static SubLInteger $int63$1000 = makeInteger(1000);
  public static SubLInteger $int64$100 = makeInteger(100);
  public static SubLObject $ic65 = Vectors.vector(new SubLObject[] {NIL, makeString("one"), makeString("two"), makeString("three"), makeString("four"), makeString("five"), makeString("six"), makeString("seven"), makeString("eight"), makeString("nine")});
  public static SubLString $str66$_hundred = makeString(" hundred");
  public static SubLObject $ic67 = Vectors.vector(new SubLObject[] {makeString("ten"), makeString("eleven"), makeString("twelve"), makeString("thirteen"), makeString("fourteen"), makeString("fifteen"), makeString("sixteen"), makeString("seventeen"), makeString("eighteen"), makeString("nineteen")});
  public static SubLObject $ic68 = Vectors.vector(new SubLObject[] {NIL, NIL, makeString("twenty"), makeString("thirty"), makeString("forty"), makeString("fifty"), makeString("sixty"), makeString("seventy"), makeString("eighty"), makeString("ninety")});
  public static SubLObject $ic69 = Vectors.vector(new SubLObject[] {NIL, makeString("one"), makeString("two"), makeString("three"), makeString("four"), makeString("five"), makeString("six"), makeString("seven"), makeString("eight"), makeString("nine")});
  public static SubLString $str70$zero = makeString("zero");
  public static SubLString $str71$minus_ = makeString("minus ");
  public static SubLString $str72$zeroth = makeString("zeroth");
  public static SubLObject $ic73 = Vectors.vector(new SubLObject[] {NIL, makeString("tenth"), makeString("twentieth"), makeString("thirtieth"), makeString("fortieth"), makeString("fiftieth"), makeString("sixtieth"), makeString("seventieth"), makeString("eightieth"), makeString("ninetieth")});
  public static SubLObject $ic74 = Vectors.vector(new SubLObject[] {NIL, makeString("eleventh"), makeString("twelfth"), makeString("thirteenth"), makeString("fourteenth"), makeString("fifteenth"), makeString("sixteenth"), makeString("seventeenth"), makeString("eighteenth"), makeString("nineteenth")});
  public static SubLObject $ic75 = Vectors.vector(new SubLObject[] {NIL, makeString("first"), makeString("second"), makeString("third"), makeString("fourth"), makeString("fifth"), makeString("sixth"), makeString("seventh"), makeString("eighth"), makeString("ninth")});
  public static SubLString $str76$th = makeString("th");
  public static SubLInteger $int77$36 = makeInteger(36);
  public static SubLString $str78$_S_is_not_a_valid_radix_ = makeString("~S is not a valid radix.");
  public static SubLList $list79 = list(Characters.CHAR_M, Characters.CHAR_D, Characters.CHAR_C, Characters.CHAR_L, Characters.CHAR_X, Characters.CHAR_V, Characters.CHAR_I);
  public static SubLList $list80 = list(makeInteger(1000), makeInteger(500), makeInteger(100), makeInteger(50), TEN_INTEGER, FIVE_INTEGER, ONE_INTEGER);
  public static SubLList $list81 = list(makeInteger(900), makeInteger(400), makeInteger(90), makeInteger(40), NINE_INTEGER, FOUR_INTEGER);
  public static SubLList $list82 = list(Characters.CHAR_C, Characters.CHAR_C, Characters.CHAR_X, Characters.CHAR_X, Characters.CHAR_I, Characters.CHAR_I);
  public static SubLSymbol $sym83$FORMAT_R_DIRECTIVE = makeSymbol("FORMAT-R-DIRECTIVE");
  public static SubLSymbol $sym84$FORMAT_D_DIRECTIVE = makeSymbol("FORMAT-D-DIRECTIVE");
  public static SubLSymbol $sym85$FORMAT_B_DIRECTIVE = makeSymbol("FORMAT-B-DIRECTIVE");
  public static SubLSymbol $sym86$FORMAT_O_DIRECTIVE = makeSymbol("FORMAT-O-DIRECTIVE");
  public static SubLSymbol $sym87$FORMAT_X_DIRECTIVE = makeSymbol("FORMAT-X-DIRECTIVE");
  public static SubLList $list88 = list(makeSymbol("OR"), makeSymbol("NULL"), makeSymbol("CHARACTER"));
  public static SubLSymbol $sym89$FORMAT_F_DIRECTIVE = makeSymbol("FORMAT-F-DIRECTIVE");
  public static SubLSymbol $sym90$FORMAT_E_DIRECTIVE = makeSymbol("FORMAT-E-DIRECTIVE");
  public static SubLSymbol $sym91$FORMAT_G_DIRECTIVE = makeSymbol("FORMAT-G-DIRECTIVE");
  public static SubLSymbol $sym92$FORMAT_DOLLARSIGN_DIRECTIVE = makeSymbol("FORMAT-DOLLARSIGN-DIRECTIVE");
  public static SubLString $str93$__ = makeString("()");
  public static SubLSymbol $sym94$FORMAT_PADDED = makeSymbol("FORMAT-PADDED");
  public static SubLSymbol $sym95$FORMAT_A_DIRECTIVE = makeSymbol("FORMAT-A-DIRECTIVE");
  public static SubLSymbol $sym96$FORMAT_S_DIRECTIVE = makeSymbol("FORMAT-S-DIRECTIVE");
  public static SubLSymbol $kw97$STREAM = makeKeyword("STREAM");
  public static SubLSymbol $sym98$FORMAT_W_DIRECTIVE = makeSymbol("FORMAT-W-DIRECTIVE");
  public static SubLSymbol $sym99$FORMAT_UNDERSCORE_DIRECTIVE = makeSymbol("FORMAT-UNDERSCORE-DIRECTIVE");
  public static SubLSymbol $sym100$FORMAT_I_DIRECTIVE = makeSymbol("FORMAT-I-DIRECTIVE");
  public static SubLSymbol $sym101$CHAR_ = makeSymbol("CHAR=");
  public static SubLSymbol $sym102$FORMAT_SLASH_DIRECTIVE = makeSymbol("FORMAT-SLASH-DIRECTIVE");
  public static SubLSymbol $sym103$FORMAT_T_DIRECTIVE = makeSymbol("FORMAT-T-DIRECTIVE");
  public static SubLSymbol $sym104$FORMAT_LESS_THAN_DIRECTIVE = makeSymbol("FORMAT-LESS-THAN-DIRECTIVE");
  public static SubLSymbol $sym105$FORMAT_GREATER_THAN_DIRECTIVE = makeSymbol("FORMAT-GREATER-THAN-DIRECTIVE");
  public static SubLSymbol $sym106$FORMAT_ASTERISK_DIRECTIVE = makeSymbol("FORMAT-ASTERISK-DIRECTIVE");
  public static SubLString $str107$No_clause_marker_found_for__S__S_ = makeString("No clause marker found for ~S ~S directive.");
  public static SubLList $list108 = list(makeSymbol("OR"), makeSymbol("NULL"), makeSymbol("INTEGER"));
  public static SubLSymbol $sym109$FORMAT_LEFT_BRACKET_DIRECTIVE = makeSymbol("FORMAT-LEFT-BRACKET-DIRECTIVE");
  public static SubLSymbol $sym110$FORMAT_RIGHT_BRACKET_DIRECTIVE = makeSymbol("FORMAT-RIGHT-BRACKET-DIRECTIVE");
  public static SubLSymbol $sym111$UP_AND_ALL_THE_WAY_OUT = makeSymbol("UP-AND-ALL-THE-WAY-OUT");
  public static SubLSymbol $sym112$UP_AND_OUT = makeSymbol("UP-AND-OUT");
  public static SubLSymbol $sym113$FORMAT_LEFT_BRACE_DIRECTIVE = makeSymbol("FORMAT-LEFT-BRACE-DIRECTIVE");
  public static SubLSymbol $sym114$FORMAT_RIGHT_BRACE_DIRECTIVE = makeSymbol("FORMAT-RIGHT-BRACE-DIRECTIVE");
  public static SubLSymbol $sym115$STRINGP = makeSymbol("STRINGP");
  public static SubLSymbol $sym116$LISTP = makeSymbol("LISTP");
  public static SubLSymbol $sym117$FORMAT_QUESTION_MARK_DIRECTIVE = makeSymbol("FORMAT-QUESTION-MARK-DIRECTIVE");
  public static SubLSymbol $sym118$FORMAT_LEFT_PAREN_DIRECTIVE = makeSymbol("FORMAT-LEFT-PAREN-DIRECTIVE");
  public static SubLSymbol $sym119$FORMAT_RIGHT_PAREN_DIRECTIVE = makeSymbol("FORMAT-RIGHT-PAREN-DIRECTIVE");
  public static SubLString $str120$ies = makeString("ies");
  public static SubLSymbol $sym121$FORMAT_P_DIRECTIVE = makeSymbol("FORMAT-P-DIRECTIVE");
  public static SubLSymbol $sym122$FORMAT_SEMICOLON_DIRECTIVE = makeSymbol("FORMAT-SEMICOLON-DIRECTIVE");
  public static SubLSymbol $sym123$FORMAT_CIRCUMFLEX_DIRECTIVE = makeSymbol("FORMAT-CIRCUMFLEX-DIRECTIVE");
  public static SubLSymbol $sym124$FORMAT_NEWLINE_DIRECTIVE = makeSymbol("FORMAT-NEWLINE-DIRECTIVE");
  public static SubLString $str125$_S_does_not_support_string_destin = makeString("~S does not support string destinations.");
  public static SubLString $str126$_S_is_not_a_valid__S_destination_ = makeString("~S is not a valid ~S destination.");
  public static SubLString $str127$No_matching__A_found_for__A_in__S = makeString("No matching ~A found for ~A in ~S.");
  public static SubLSymbol $kw128$NORMAL = makeKeyword("NORMAL");
  public static SubLSymbol $kw129$TILDE = makeKeyword("TILDE");
  public static SubLSymbol $kw130$PARAM = makeKeyword("PARAM");
  public static SubLString $str131$_S_parameter__S_is_not_a_characte = makeString("~S parameter ~S is not a character, integer, or NIL.");
  public static SubLSymbol $kw132$QUOTE = makeKeyword("QUOTE");
  public static SubLSymbol $kw133$COLON = makeKeyword("COLON");
  public static SubLSymbol $kw134$AT_SIGN = makeKeyword("AT-SIGN");
  public static SubLSymbol $kw135$SIGN = makeKeyword("SIGN");
  public static SubLSymbol $kw136$NUMBER = makeKeyword("NUMBER");
  public static SubLString $str137$Bad__S_parameter_ = makeString("Bad ~S parameter.");
  public static SubLSymbol $kw138$COLON_AT = makeKeyword("COLON-AT");
  public static SubLString $str139$Unterminated__S_control_ = makeString("Unterminated ~S control.");
