...
and the universal time epoch (January 1, 1900 A.D.) */
            ...
            thread.resetMultipleValues();
            {
              ...
              thread.resetMultipleValues();
              {
                ...
                thread.resetMultipleValues();
                {
                  ...
                  thread.resetMultipleValues();
                  {
                    SubLObject last_day_of_cycle_p = makeBoolean((annuals.numE(FOUR_INTEGER)
                        || centennials.numE(FOUR_INTEGER)));
                    year = Numbers.add(new SubLObject[] {Numbers.multiply(quadricentennials, $int8$400), Numbers.multiply(centennials, $int9$100), Numbers.multiply(quadrennials, FOUR_INTEGER), annuals, ((NIL != last_day_of_cycle_p) ? ((SubLObject) ZERO_INTEGER) : ONE_INTEGER)});
                    if ((NIL != last_day_of_cycle_p)) {
                      month = TWELVE_INTEGER;
                      date = $int10$31;
                    } else {
                      {
                        SubLObject leap_days = ((Numbers.mod(year, FOUR_INTEGER).isZero()
                             && (NIL == conses_high.member(Numbers.mod(year, $int8$400), $list11, UNPROVIDED, UNPROVIDED))) ? ((SubLObject) ONE_INTEGER) : ZERO_INTEGER);
  ...
  public static SubLObject encode_universal_time_internal(SubLObject second, SubLObject minute, SubLObject hour, SubLObject date, SubLObject month, SubLObject year, SubLObject time_zone) {
    {
      ...
      if (month.numLE(TWO_INTEGER)) {
        february_adjustment = ZERO_INTEGER;
      } else if ((Numbers.mod(year, FOUR_INTEGER).isZero()
           && (NIL == conses_high.member(Numbers.mod(year, $int8$400), $list11, UNPROVIDED, UNPROVIDED)))) {
        february_adjustment = MINUS_ONE_INTEGER;
      } else {
        february_adjustment = $int13$_2;
      }
      days = Numbers.add(new SubLObject[] {MINUS_ONE_INTEGER, Numbers.add(new SubLObject[] {Numbers.multiply($int7$365, previous_year), Numbers.floor(previous_year, FOUR_INTEGER), Numbers.minus(Numbers.floor(previous_year, $int9$100)), Numbers.floor(previous_year, $int8$400)}), Numbers.floor(Numbers.subtract(Numbers.multiply($int15$367, month), $int16$362), TWELVE_INTEGER), february_adjustment, date, Numbers.minus($ut_offset_from_rata_die$.getGlobalValue())});
  ...
  public static SubLObject declare_time_high_file() {
    declareFunction(myName, "decode_universal_time", "DECODE-UNIVERSAL-TIME", 1, 1, false);
    declareFunction(myName, "guess_year_from_two_digits", "GUESS-YEAR-FROM-TWO-DIGITS", 1, 0, false);
    declareFunction(myName, "encode_universal_time", "ENCODE-UNIVERSAL-TIME", 6, 1, false);
    declareFunction(myName, "encode_universal_time_internal", "ENCODE-UNIVERSAL-TIME-INTERNAL", 7, 0, false);
    declareFunction(myName, "get_universal_time", "GET-UNIVERSAL-TIME", 0, 0, false);
    declareFunction(myName, "get_decoded_time", "GET-DECODED-TIME", 0, 0, false);
    declareFunction(myName, "get_internal_real_time", "GET-INTERNAL-REAL-TIME", 0, 0, false);
    declareFunction(myName, "get_internal_run_time", "GET-INTERNAL-RUN-TIME", 0, 0, false);
    return NIL;
  }
  ...
  public static SubLInteger $int0$1000000 = makeInteger(1000000);
  public static SubLInteger $int1$693595 = makeInteger(693595);
  public static SubLInteger $int2$3600 = makeInteger(3600);
  public static SubLInteger $int3$86400 = makeInteger(86400);
  public static SubLInteger $int4$146097 = makeInteger(146097);
  public static SubLInteger $int5$36524 = makeInteger(36524);
  public static SubLInteger $int6$1461 = makeInteger(1461);
  public static SubLInteger $int7$365 = makeInteger(365);
  public static SubLInteger $int8$400 = makeInteger(400);
  public static SubLInteger $int9$100 = makeInteger(100);
  public static SubLInteger $int10$31 = makeInteger(31);
  public static SubLList $list11 = list(makeInteger(100), makeInteger(200), makeInteger(300));
  public static SubLInteger $int12$59 = makeInteger(59);
  public static SubLInteger $int13$_2 = makeInteger(-2);
  public static SubLInteger $int14$373 = makeInteger(373);
  public static SubLInteger $int15$367 = makeInteger(367);
  public static SubLInteger $int16$362 = makeInteger(362);
  public static SubLInteger $int17$60 = makeInteger(60);
  public static SubLInteger $int18$50 = makeInteger(50);
  public static SubLInteger $int19$99 = makeInteger(99);
