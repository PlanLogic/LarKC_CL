...
public  class condition_macros extends SubLTranslatedFile {
  ...
  public static SubLList $list0 = list(list(makeSymbol("NAME"), makeSymbol("FORMAT-CONTROL"), makeSymbol("&REST"), makeSymbol("FORMAT-ARGUMENTS")), makeSymbol("&BODY"), makeSymbol("BODY"));
  public static SubLString $str1$RESTART_TAG = makeString("RESTART-TAG");
  public static SubLString $str2$DUMMY = makeString("DUMMY");
  public static SubLSymbol $sym3$CLET = makeSymbol("CLET");
  public static SubLSymbol $sym4$QUOTE = makeSymbol("QUOTE");
  public static SubLSymbol $sym5$IGNORE = makeSymbol("IGNORE");
  public static SubLSymbol $sym6$_RESTARTS_ = makeSymbol("*RESTARTS*");
  public static SubLSymbol $sym7$CONS = makeSymbol("CONS");
  public static SubLSymbol $sym8$LIST = makeSymbol("LIST");
  public static SubLList $list9 = list(makeSymbol("*RESTARTS*"));
  public static SubLSymbol $sym10$CCATCH = makeSymbol("CCATCH");
  public static SubLSymbol $sym11$PROGN = makeSymbol("PROGN");
  public static SubLSymbol $sym12$_ERROR_HANDLER_ = makeSymbol("*ERROR-HANDLER*");
  public static SubLString $str13$IGNORE_ERRORS_TAG = makeString("IGNORE-ERRORS-TAG");
  public static SubLSymbol $kw14$IGNORE_ERRORS_TARGET = makeKeyword("IGNORE-ERRORS-TARGET");
  public static SubLSymbol $sym15$WITH_ERROR_HANDLER = makeSymbol("WITH-ERROR-HANDLER");
  public static SubLList $list16 = list(makeSymbol("FUNCTION"), makeSymbol("IGNORE-ERRORS-HANDLER"));
