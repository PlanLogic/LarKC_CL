...
@see bug 18429 */
  ...
  public static SubLObject declare_conses_high_file() {
    ...
    declareFunction(myName, "union", "UNION", 2, 2, false); new $union$BinaryFunction();
  ...
  public static SubLSymbol $sym0$LISTP = makeSymbol("LISTP");
  public static SubLSymbol $sym1$FUNCTION_SPEC_P = makeSymbol("FUNCTION-SPEC-P");
  public static SubLSymbol $sym2$FIXNUMP = makeSymbol("FIXNUMP");
  public static SubLString $str3$_S_must_be_a_non_negative_integer = makeString("~S must be a non-negative integer");
  public static SubLString $str4$COPY_LIST_called_on_a_circular_li = makeString("COPY-LIST called on a circular list");
  public static SubLString $str5$COPY_ALIST_called_on_a_circular_l = makeString("COPY-ALIST called on a circular list");
  public static SubLString $str6$COPY_TREE_called_on_a_circular_li = makeString("COPY-TREE called on a circular list");
  public static SubLInteger $int7$68 = makeInteger(68);
  public static SubLString $str8$PAIRLIS_was_called_with_lists_of_ = makeString("PAIRLIS was called with lists of different lengths");
  public static SubLString $str9$LAST_called_with_negative_index_o = makeString("LAST called with negative index of ~S");
  public static SubLString $str10$LAST_called_on_circular_list = makeString("LAST called on circular list");
  public static SubLString $str11$NBUTLAST_called_with_negative_ind = makeString("NBUTLAST called with negative index of ~S");
  public static SubLString $str12$NBUTLAST_called_on_circular_list = makeString("NBUTLAST called on circular list");
