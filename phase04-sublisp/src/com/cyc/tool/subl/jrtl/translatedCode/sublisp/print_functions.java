...
plus that power is the corresponding entry in *max-fixnum-base-power*. */
  ...
  public static SubLInteger $int0$37 = makeInteger(37);
  public static SubLInteger $int1$36 = makeInteger(36);
  public static SubLSymbol $sym2$PRINT_OBJECT_BIGNUM_METHOD = makeSymbol("PRINT-OBJECT-BIGNUM-METHOD");
  public static SubLSymbol $sym3$PRINT_OBJECT_FIXNUM_METHOD = makeSymbol("PRINT-OBJECT-FIXNUM-METHOD");
  public static SubLString $str4$Inf = makeString("Inf");
  public static SubLString $str5$NaN = makeString("NaN");
  public static SubLInteger $int6$_2 = makeInteger(-2);
  public static SubLSymbol $sym7$PRINT_OBJECT_FLOAT_METHOD = makeSymbol("PRINT-OBJECT-FLOAT-METHOD");
  public static SubLSymbol $sym8$PRINT_OBJECT_CHARACTER_METHOD = makeSymbol("PRINT-OBJECT-CHARACTER-METHOD");
  public static SubLString $str9$__ = makeString("#:");
  public static SubLSymbol $kw10$INTERNAL = makeKeyword("INTERNAL");
  public static SubLSymbol $kw11$CAPITALIZE = makeKeyword("CAPITALIZE");
  public static SubLSymbol $kw12$UPCASE = makeKeyword("UPCASE");
  public static SubLSymbol $kw13$DOWNCASE = makeKeyword("DOWNCASE");
  public static SubLSymbol $sym14$PRINT_OBJECT_SYMBOL_METHOD = makeSymbol("PRINT-OBJECT-SYMBOL-METHOD");
  public static SubLSymbol $sym15$PRINT_OBJECT_STRING_METHOD = makeSymbol("PRINT-OBJECT-STRING-METHOD");
  public static SubLSymbol $sym16$QUOTE = makeSymbol("QUOTE");
  public static SubLSymbol $kw17$STREAM = makeKeyword("STREAM");
  public static SubLString $str18$___ = makeString(" . ");
  public static SubLString $str19$____ = makeString(" ...");
  public static SubLSymbol $sym20$PRINT_OBJECT_CONS_METHOD = makeSymbol("PRINT-OBJECT-CONS-METHOD");
  public static SubLString $str21$___ = makeString("...");
  public static SubLString $str22$__ = makeString("#<");
  public static SubLString $str23$_D = makeString("~D");
  public static SubLSymbol $kw24$BASE = makeKeyword("BASE");
  public static SubLSymbol $sym25$PRINT_OBJECT_VECTOR_METHOD = makeSymbol("PRINT-OBJECT-VECTOR-METHOD");
  public static SubLString $str26$TEST__A__D__D = makeString("TEST ~A ~D/~D");
  public static SubLSymbol $sym27$PRINT_OBJECT_HASH_TABLE_METHOD = makeSymbol("PRINT-OBJECT-HASH-TABLE-METHOD");
  public static SubLSymbol $sym28$PRINT_OBJECT_FUNCTION_METHOD = makeSymbol("PRINT-OBJECT-FUNCTION-METHOD");
  public static SubLString $str29$_G = makeString("#G");
  public static SubLSymbol $sym30$PRINT_OBJECT_GUID_METHOD = makeSymbol("PRINT-OBJECT-GUID-METHOD");
