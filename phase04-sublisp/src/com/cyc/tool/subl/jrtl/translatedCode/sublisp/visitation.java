...
public  class visitation extends SubLTranslatedFile {
  ...
  public static SubLString $str1$No_visitation_function_defined_fo = makeString("No visitation function defined for ~A.");
  public static SubLSymbol $sym2$VISIT_DEFSTRUCT_OBJECT_INTEGER_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-INTEGER-METHOD");
  public static SubLSymbol $sym3$VISIT_DEFSTRUCT_OBJECT_FLOAT_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-FLOAT-METHOD");
  public static SubLSymbol $sym4$VISIT_DEFSTRUCT_OBJECT_STRING_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-STRING-METHOD");
  public static SubLSymbol $sym5$VISIT_DEFSTRUCT_OBJECT_CHARACTER_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-CHARACTER-METHOD");
  public static SubLSymbol $sym6$VISIT_DEFSTRUCT_OBJECT_SYMBOL_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-SYMBOL-METHOD");
  public static SubLSymbol $sym7$VISIT_DEFSTRUCT_OBJECT_VECTOR_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-VECTOR-METHOD");
  public static SubLSymbol $sym8$VISIT_DEFSTRUCT_OBJECT_CONS_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-CONS-METHOD");
  public static SubLSymbol $sym9$VISIT_DEFSTRUCT_OBJECT_HASH_TABLE_METHOD = makeSymbol("VISIT-DEFSTRUCT-OBJECT-HASH-TABLE-METHOD");
  public static SubLString $str10$_A__A__A___A__ = makeString("~A ~A ~A: ~A~%");
