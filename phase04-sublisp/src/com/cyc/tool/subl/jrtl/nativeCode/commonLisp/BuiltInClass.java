...
public class BuiltInClass extends LispClass
{
  ...
  public static BuiltInClass CLASS_T              = addBuiltinClass(T);

  public static BuiltInClass ARRAY                = addBuiltinClass(LispSymbols.ARRAY);
  public static BuiltInClass BIGNUM               = addBuiltinClass(LispSymbols.BIGNUM);
  public static BuiltInClass BASE_STRING          = addBuiltinClass(LispSymbols.BASE_STRING);
  public static BuiltInClass BIT_VECTOR           = addBuiltinClass(LispSymbols.BIT_VECTOR);
  public static BuiltInClass CHARACTER            = addBuiltinClass(LispSymbols.CHARACTER);
  public static BuiltInClass COMPLEX              = addBuiltinClass(LispSymbols.COMPLEX);
  public static BuiltInClass CONS                 = addBuiltinClass(LispSymbols.CONS);
  public static BuiltInClass DOUBLE_FLOAT         = addBuiltinClass(LispSymbols.DOUBLE_FLOAT);
  public static BuiltInClass ENVIRONMENT          = addBuiltinClass(LispSymbols.ENVIRONMENT);
  public static BuiltInClass FIXNUM               = addBuiltinClass(LispSymbols.FIXNUM);
  public static BuiltInClass FLOAT                = addBuiltinClass(LispSymbols.FLOAT);
  public static BuiltInClass FUNCTION             = addBuiltinClass(LispSymbols.FUNCTION);
  public static BuiltInClass HASH_TABLE           = addBuiltinClass(LispSymbols.HASH_TABLE);
  public static BuiltInClass INTEGER              = addBuiltinClass(LispSymbols.INTEGER);
  public static BuiltInClass JAVA_OBJECT          = addBuiltinClass(LispSymbols.JAVA_OBJECT);
  public static BuiltInClass LIST                 = addBuiltinClass(LispSymbols.LIST);
  public static BuiltInClass LOGICAL_PATHNAME     = addBuiltinClass(LispSymbols.LOGICAL_PATHNAME);
  public static BuiltInClass MAILBOX              = addBuiltinClass(LispSymbols.MAILBOX);
  public static BuiltInClass METHOD_COMBINATION   = addBuiltinClass(LispSymbols.METHOD_COMBINATION);
  public static BuiltInClass MUTEX                = addBuiltinClass(LispSymbols.MUTEX);
  public static BuiltInClass NIL_VECTOR           = addBuiltinClass(LispSymbols.NIL_VECTOR);
  public static BuiltInClass NULL                 = addBuiltinClass(LispSymbols.NULL);
  public static BuiltInClass NUMBER               = addBuiltinClass(LispSymbols.NUMBER);
  public static BuiltInClass PACKAGE              = addBuiltinClass(LispSymbols.PACKAGE);
  public static BuiltInClass PATHNAME             = addBuiltinClass(LispSymbols.PATHNAME);
  public static BuiltInClass RANDOM_STATE         = addBuiltinClass(LispSymbols.RANDOM_STATE);
  public static BuiltInClass RATIO                = addBuiltinClass(LispSymbols.RATIO);
  public static BuiltInClass RATIONAL             = addBuiltinClass(LispSymbols.RATIONAL);
  public static BuiltInClass READTABLE            = addBuiltinClass(LispSymbols.READTABLE);
  public static BuiltInClass REAL                 = addBuiltinClass(LispSymbols.REAL);
  public static BuiltInClass RESTART              = addBuiltinClass(LispSymbols.RESTART);
  public static BuiltInClass SIMPLE_ARRAY         = addBuiltinClass(LispSymbols.SIMPLE_ARRAY);
  public static BuiltInClass SIMPLE_BASE_STRING   = addBuiltinClass(LispSymbols.SIMPLE_BASE_STRING);
  public static BuiltInClass SIMPLE_BIT_VECTOR    = addBuiltinClass(LispSymbols.SIMPLE_BIT_VECTOR);
  public static BuiltInClass SIMPLE_STRING        = addBuiltinClass(LispSymbols.SIMPLE_STRING);
  public static BuiltInClass SIMPLE_VECTOR        = addBuiltinClass(LispSymbols.SIMPLE_VECTOR);
  public static BuiltInClass SINGLE_FLOAT         = addBuiltinClass(LispSymbols.SINGLE_FLOAT);
  public static BuiltInClass STRING               = addBuiltinClass(LispSymbols.STRING);
  public static BuiltInClass SYMBOL               = addBuiltinClass(LispSymbols.SYMBOL);
  public static BuiltInClass THREAD               = addBuiltinClass(LispSymbols.THREAD);
  public static BuiltInClass VECTOR               = addBuiltinClass(LispSymbols.VECTOR);
  public static BuiltInClass STACK_FRAME          = addBuiltinClass(LispSymbols.STACK_FRAME);
  public static BuiltInClass LISP_STACK_FRAME     = addBuiltinClass(LispSymbols.LISP_STACK_FRAME);
  public static BuiltInClass JAVA_STACK_FRAME     = addBuiltinClass(LispSymbols.JAVA_STACK_FRAME);


  public static StructureClass STRUCTURE_OBJECT =
    (StructureClass)addClass(LispSymbols.STRUCTURE_OBJECT,
             new StructureClass(LispSymbols.STRUCTURE_OBJECT, list(CLASS_T)));

    public static SlotClass SEQUENCE =
