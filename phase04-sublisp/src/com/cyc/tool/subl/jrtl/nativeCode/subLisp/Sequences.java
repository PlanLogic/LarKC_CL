...
public  class Sequences extends SubLTrampolineFile {
  ...
  public static SubLObject position(SubLObject item, SubLObject sequence,
  ...
  public static SubLObject position_if(SubLObject test, SubLObject sequence, 
  ...
  public static SubLObject remove(SubLObject item, SubLObject sequence,
  ...
  public static SubLObject delete(SubLObject item, SubLObject sequence,
    SubLObject test, SubLObject key, SubLObject start, SubLObject end, SubLObject count) {
    SubLSequence sequenceTyped = sequence.toSeq();
    BinaryFunction testFunction = extractBinaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject replace(SubLObject sequence1, SubLObject sequence2,
  ...
  public static SubLObject count(SubLObject item, SubLObject sequence, 
      SubLObject test, SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
    BinaryFunction testFunction = extractBinaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject count_if(SubLObject test, SubLObject sequence, 
      SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
  ...
  public static SubLObject creduce(SubLObject function, SubLObject sequence, 
  ...
  public static SubLObject delete_duplicates(SubLObject sequence, 
      SubLObject test, SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
    BinaryFunction testFunction = extractBinaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject delete_if(SubLObject test, SubLObject sequence, 
  ...
  public static SubLObject fill(SubLObject sequence, SubLObject item, 
  ...
  public static SubLObject find(SubLObject item, SubLObject sequence, 
      SubLObject test, SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
    BinaryFunction testFunction = extractBinaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject find_if(SubLObject test, SubLObject sequence, 
      SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
    UnaryFunction testFunction = extractUnaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject mismatch(SubLObject sequence1, SubLObject sequence2, 
  ...
  public static SubLObject nsubstitute(SubLObject newItem, SubLObject oldItem, 
  ...
  public static SubLObject nsubstitute_if(SubLObject newItem, 
  ...
  public static SubLObject remove_duplicates(SubLObject sequence, 
      SubLObject test, SubLObject key, SubLObject start, SubLObject end) {
    SubLSequence sequenceTyped = sequence.toSeq();
    BinaryFunction testFunction = extractBinaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject remove_if(SubLObject test, SubLObject sequence, 
      SubLObject key, SubLObject start, SubLObject end, SubLObject count) {
    SubLSequence sequenceTyped = sequence.toSeq();
    UnaryFunction testFunction = extractUnaryFunc(test);
    UnaryFunction keyFunction = extractUnaryFunc(key);
  ...
  public static SubLObject search(SubLObject sequence1, SubLObject sequence2, 
  ...
  public static SubLObject substitute(SubLObject newItem, SubLObject oldItem, 
  ...
  public static SubLObject substitute_if(SubLObject newItem, SubLObject test, 
