...
public class StreamFunctions {
	...
	private static Primitive _WRITE_CHAR = new JavaPrimitive("%stream-write-char", PACKAGE_SYS, true,
	...
	private static Primitive _STREAM_WRITE_CHAR = new JavaPrimitive("%write-char", PACKAGE_SYS, false,
			"character output-stream") {
	...
	private static Primitive _WRITE_STRING = new JavaPrimitive("%write-string", PACKAGE_SYS, false,
	...
	private static Primitive _FINISH_OUTPUT = new JavaPrimitive("%finish-output", PACKAGE_SYS, false,
			"output-stream") {
	...
	private static Primitive _FORCE_OUTPUT = new JavaPrimitive("%force-output", PACKAGE_SYS, false, "output-stream") {
	...
	// it does nothing."
	private static Primitive _CLEAR_OUTPUT = new JavaPrimitive("%clear-output", PACKAGE_SYS, false, "output-stream") {
	...
	private static Primitive OUT_SYNONYM_OF = new JavaPrimitive("out-synonym-of", PACKAGE_SYS, true,
			"stream-designator") {
	...
	private static Primitive WRITE_8_BITS = new JavaPrimitive("write-8-bits", PACKAGE_SYS, true, "byte stream") {
	...
	private static Primitive READ_8_BITS = new JavaPrimitive("read-8-bits", PACKAGE_SYS, true,
	...
	// => object, position
	private static Primitive _READ_FROM_STRING = new JavaPrimitive("%read-from-string", PACKAGE_SYS, false) {
	...
	private static Primitive UNREAD_CHAR = new JavaPrimitive(LispSymbols.UNREAD_CHAR, "character &optional input-stream") {
	...
	// ### stream-line-number
	private static Primitive STREAM_LINE_NUMBER = new JavaPrimitive("stream-line-number", PACKAGE_SYS, false,
			"stream") {
	...
	// ### stream-offset
	private static Primitive STREAM_OFFSET = new JavaPrimitive("stream-offset", PACKAGE_SYS, false, "stream") {
	...
	private static Primitive STREAM_CHARPOS = new JavaPrimitive("stream-charpos", PACKAGE_SYS, false) {
	...
	private static Primitive STREAM_SET_CHARPOS = new JavaPrimitive("stream-%set-charpos", PACKAGE_SYS, false) {
	...
	private static Primitive MAKE_FILE_STREAM = new JavaPrimitive("make-file-stream", PACKAGE_SYS, true,
	...
	// echo-stream => output-stream
	private static Primitive ECHO_STREAM_OUTPUT_STREAM = new JavaPrimitive("echo-stream-output-stream",
			"echo-stream") {
	...
	private static Primitive GET_OUTPUT_STREAM_BYTES = new JavaPrimitive("%get-output-stream-bytes", PACKAGE_SYS,
	...
	private static Primitive GET_OUTPUT_STREAM_ARRAY = new JavaPrimitive("%get-output-stream-array", PACKAGE_SYS,
			false, "byte-array-output-stream") {
	...
	private static Primitive MAKE_CASE_FROB_STREAM = new JavaPrimitive("make-case-frob-stream", PACKAGE_SYS, false,
			"target kind") {
	...
	private static Primitive MAKE_CONCATENATED_STREAM = new JavaPrimitive("make-concatenated-stream",
			"&rest streams") {
	...
	private static Primitive MAKE_SLIME_OUTPUT_STREAM = new JavaPrimitive("make-slime-output-stream", PACKAGE_EXT,
			true, "function") {
	...
	private static Primitive MAKE_SLIME_INPUT_STREAM = new JavaPrimitive("make-slime-input-stream", PACKAGE_EXT,
  ...
  private static Primitive MAKE_SYNONYM_STREAM =
  ...
  private static Primitive SYNONYM_STREAM_STREAMS =
