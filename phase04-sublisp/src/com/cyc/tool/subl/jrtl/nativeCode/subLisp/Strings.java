...
public  class Strings extends SubLTrampolineFile {
  ...
  public static SubLObject string_equal(SubLObject string1, 
  ...
  public static SubLObject string_greaterp(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
  ...
  public static SubLObject string_lessp(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
  ...
  public static SubLObject string_not_greaterp(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
  ...
  public static SubLObject string_not_lessp(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
  ...
  public static SubLObject string_upcase(SubLObject string,
  ...
  public static SubLObject string_downcase(SubLObject string,
      SubLObject start, SubLObject end) {
    SubLString stringTyped = string.toStr();
    int startTyped = extractStart(start);
    int endTyped = extractEnd(end);
  ...
  public static SubLObject string_capitalize(SubLObject string,
      SubLObject start, SubLObject end) {
    SubLString stringTyped = string.toStr();
    int startTyped = extractStart(start);
    int endTyped = extractEnd(end);
  ...
  public static SubLObject nstring_upcase(SubLObject string,
      SubLObject start, SubLObject end) {
    SubLString stringTyped = string.toStr();
    int startTyped = extractStart(start);
    int endTyped = extractEnd(end);
  ...
  public static SubLObject nstring_downcase(SubLObject string,
      SubLObject start, SubLObject end) {
    SubLString stringTyped = string.toStr();
    int startTyped = extractStart(start);
    int endTyped = extractEnd(end);
  ...
  public static SubLObject nstring_capitalize(SubLObject string,
      SubLObject start, SubLObject end) {
    SubLString stringTyped = string.toStr();
    int startTyped = extractStart(start);
    int endTyped = extractEnd(end);
  ...
  public static SubLObject stringNE(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
  ...
  public static SubLObject string_not_equal(SubLObject string1, 
      SubLObject string2, SubLObject start1, SubLObject end1, 
      SubLObject start2, SubLObject end2) {
    return SubLObjectFactory.
  ...
  //// Protected Area
  //// Private Area
  private static SubLObject compare(SubLObject string1, SubLObject string2,
