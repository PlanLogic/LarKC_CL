...
public  class SubLInputBinaryStreamImpl extends AbstractSubLBinaryStream implements SubLInputBinaryStream, CommonSymbols {
  //// Constructors
  /**
  ...
  public int read(byte[] b, int off, int len) {//@note make this interruptable
    ensureOpen("READ");
    if (isRandomAccess()) {
