  ...
  extends StackFrame
{
  ...
  static SubLSymbol CLASS = internKeyword("CLASS");
  static SubLSymbol METHOD = internKeyword("METHOD");
  static SubLSymbol FILE = internKeyword("FILE");
  static SubLSymbol LINE = internKeyword("LINE");
  static SubLSymbol NATIVE_METHOD = internKeyword("NATIVE-METHOD");
