...
public class Readtable extends AbstractLispObject
{
  ...
  protected CharHashMap<Byte> syntax = new CharHashMap<Byte>(Byte.class,SYNTAX_TYPE_CONSTITUENT);
  ...
  // ### readtablep
  private static Primitive READTABLEP =
  ...
  // ### copy-readtable
  private static Primitive COPY_READTABLE =
  ...
  private static Primitive GET_MACRO_CHARACTER =
  ...
  // => t
  private static Primitive SET_MACRO_CHARACTER =
  ...
  // => t
  private static Primitive MAKE_DISPATCH_MACRO_CHARACTER =
  ...
  // => function
  private static Primitive GET_DISPATCH_MACRO_CHARACTER =
  ...
  // => t
  private static Primitive SET_DISPATCH_MACRO_CHARACTER =
  ...
  // => t
  private static Primitive SET_SYNTAX_FROM_CHAR =
  ...
  private static Primitive READTABLE_CASE =
  ...
  private static Primitive _SET_READTABLE_CASE =
                  ...
                  "readtable new-mode")
    {
      ...
      {
            Readtable readtable = checkReadtable(first);
