...
public class SubLNumberFactory {
  ...
  public static int FIXNUM_BIT_SIZE = 24;
  public static int MAX_FIXNUM = (int)Math.pow(2, FIXNUM_BIT_SIZE - 1) - 1;
  public static int MIN_FIXNUM = (int)-Math.pow(2, FIXNUM_BIT_SIZE - 1);
  public static int FIXNUM_MAGNITUDE = (int)Math.pow(2, FIXNUM_BIT_SIZE);
  
  public static int FIXNUM_BIT_SIZE_TO_PRECACHE = 16;
  public static int MAX_FIXNUM_TO_PRECACHE = (int)Math.pow(2, FIXNUM_BIT_SIZE_TO_PRECACHE - 1) - 1;
  public static int MIN_FIXNUM_TO_PRECACHE = (int)-Math.pow(2, FIXNUM_BIT_SIZE_TO_PRECACHE - 1);
  public static int FIXNUM_MAGNITUDE_TO_PRECACHE = (int)Math.pow(2, FIXNUM_BIT_SIZE_TO_PRECACHE);
  private static SubLFixnum[] fixNumCache = new SubLFixnum[FIXNUM_MAGNITUDE];
  static {
