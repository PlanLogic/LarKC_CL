...
public class StringFunctions {
	...
	@InlinableMethod
	static public SubLObject pf__string_not_equal_execute(SubLObject string1, SubLObject string2,
	...
	@InlinableMethod
	static public SubLObject pf__string_less_than_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
	...
	@InlinableMethod
	static public SubLObject pf__string_greater_than_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
	...
	@InlinableMethod
	static public SubLObject pf__string_not_lessp_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		// note the swap of the strings and lengths here..
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string2, string1, start2, end2, start1, end1);
		indicesAndChars.convertCase = true;
	...
	@InlinableMethod
	static public SubLObject pf__string_not_greaterp_execute(SubLObject string1, SubLObject string2,
			SubLObject start1, SubLObject end1, SubLObject start2, SubLObject end2) {
		StringIndicesAndChars indicesAndChars = stringIndicesAndChars(string1, string2, start1, end1, start2, end2);
		indicesAndChars.convertCase = true;
		int tmp = lessThanOrEqual(indicesAndChars);
