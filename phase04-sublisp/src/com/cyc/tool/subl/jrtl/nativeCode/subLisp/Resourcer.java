...
public  class Resourcer extends RuntimeException implements CommonSymbols {
  ...
  */
  ...
  public SubLHashtableKeyEntryImpl acquireHashtableKeyEntry() {
    SubLHashtableKeyEntryImpl keyEntry = (SubLHashtableKeyEntryImpl)hashtableKeyEntryPool.acquire();
    return keyEntry;
  }
  ...
  private static class SubLArrayListListIteratorObjectPool extends ObjectPool {
    public void resetPoolItem(Object item) { ((SubLListListIterator)item).reset(); }
    public Object makePoolItem() { return new SubLArrayListListIterator(); }
  }
  private static class SubLConsListListIteratorObjectPool extends ObjectPool {
    public void resetPoolItem(Object item) { ((SubLListListIterator)item).reset(); }
    public Object makePoolItem() { return new SubLConsListListIterator(); }
  }
  static class ObjectArrayObjectPool extends ObjectPool {
    ...
    public void resetPoolItem(Object item) { Arrays.fill((Object[])item, null); } //allow gc to work
    public Object makePoolItem() { return new Object[arraySize]; }
  ...
  private static class ArrayListPool extends ObjectPool {
    ...
    public Object makePoolItem() { return new ArrayList(DEFAULT_SIZE); }
  ...
  private static class StringBuilderPool extends ObjectPool {
    ...
    public void resetPoolItem(Object item) { ((StringBuilder)item).setLength(0); } //allow gc to work
    public Object makePoolItem() { return new StringBuilder(DEFAULT_SIZE); }
    public static int DEFAULT_SIZE = 8192;
  }
  static class SubLObjectArrayObjectPool extends ObjectPool {
    ...
    public void resetPoolItem(Object item) { Arrays.fill((SubLObject[])item, null); } //allow gc to work
    public Object makePoolItem() { return new SubLObject[arraySize]; }
    private int arraySize;
    public static int MAX_ARRAY_SIZE = 24;
  }
  private static class HashtableKeyEntryPool extends ObjectPool {
    HashtableKeyEntryPool() { super(16); }
    public void resetPoolItem(Object item) { ((SubLHashtableKeyEntry)item).clear(); }
    public Object makePoolItem() { return new SubLHashtableKeyEntryImpl(); }
  } 
  /*private static class SubLIntegerBignumObjectPool extends ObjectPool {
    SubLIntegerBignumObjectPool() { super(1024 * 10); }
    public void resetPoolItem(Object item) { }
    public Object makePoolItem() { return new SubLIntegerBignum.MutableSubLIntegerBignum(0); }
  }*/
}
