...
public  class Numbers extends SubLTrampolineFile {
  ...
  private static SubLObject RET_T = T;
  ...
  public static SubLObject integer_length(SubLObject integer) {
    ...
    if (zerop(integerTyped) == T) {
      ...
      if (index == INTEGER_LENGTH_TABLE.length) {
        ...
        int length = (insertPosition-1); // this returns the index of the next higher pow2, so decrement
  ...
  //// Protected Area
  //// Private Area
  private static SubLObject processMultiArgMathFunction(SubLObject[] args,
  ...
  private static MathFuncProcessingByType INTEGER_PROCESSING_FUNC = funcProcessing[0];
  private static MathFuncProcessingByType LONG_PROCESSING_FUNC = funcProcessing[1];
  private static MathFuncProcessingByType BIGINT_PROCESSING_FUNC = funcProcessing[2];
  private static MathFuncProcessingByType DOUBLE_PROCESSING_FUNC = funcProcessing[3];
