...
public class InlinedPrimitiveRegistry {
	...
	private static Primitive INLINED_PRIMITIVE_METHOD = new JavaPrimitive("INLINED-PRIMITIVE-METHOD", PACKAGE_SYS) {
	...
	private static Primitive INLINED_PRIMITIVE_REPORT = new JavaPrimitive("INLINE-PRIMITIVE-REPORT", PACKAGE_SYS) {
	...
	private static Primitive INLINED_PRIMITIVE_P = new JavaPrimitive("INLINED-PRIMITIVE-P", PACKAGE_SYS) {
