...
public class StandardObject extends AbstractLispObject
{
  ...
  public SubLObject typeOf()
  {
    ...
    if (name != NIL && name != UNBOUND_VALUE)
      {
        // TYPE-OF.9
        SubLObject c2 = LispClass.findClass(checkSymbol(name));
        if (c2 == c1)
          return name;
      }
    return c1;
  ...
  private static Primitive SWAP_SLOTS =
    new JavaPrimitive("swap-slots", PACKAGE_SYS, true, "instance-1 instance-2")
    {
      ...
      {
        StandardObject obj1 = checkStandardObject(first);
        StandardObject obj2 = checkStandardObject(second);
  ...
  // ### std-instance-layout
  private static Primitive STD_INSTANCE_LAYOUT =
    new JavaPrimitive("std-instance-layout", PACKAGE_SYS, true)
    {
      
      public SubLObject execute(SubLObject arg)
      {
        StandardObject instance = checkStandardObject(arg);
  ...
  private static Primitive _SET_STD_INSTANCE_LAYOUT =
  ...
  // ### std-instance-class
  private static Primitive STD_INSTANCE_CLASS =
  ...
  private static Primitive STANDARD_INSTANCE_ACCESS =
                  ...
                  "instance location")
    {
      ...
      {
        StandardObject instance = checkStandardObject(first);
        int index;
  ...
  private static Primitive _SET_STANDARD_INSTANCE_ACCESS =
  ...
  // ### std-slot-boundp
  private static Primitive STD_SLOT_BOUNDP =
  ...
  public SubLObject SLOT_VALUE(SubLObject slotName)
  {
    ...
    SubLObject value;
    SubLObject index = layout.slotTable.getHT(slotName);
    if (index != null)
      {
        // Found instance slot.
  ...
  // ### std-slot-value
  private static Primitive STD_SLOT_VALUE =
  ...
  // ### set-std-slot-value
  private static Primitive SET_STD_SLOT_VALUE =
