...
public  class SubLCompiledFunction extends AbstractSubLFunction implements SubLFunction {
  ...
  public boolean isInterpreted() { return false; }
  ...
  */
  ...
  public static ArrayList<FuncallCounts> funcallCountsArray = SHOULD_MAINTAIN_FUNCALL_COUNTS ? new ArrayList<FuncallCounts>() : null;
