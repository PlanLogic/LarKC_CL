...
public  class Values extends SubLTrampolineFile {
  ...
  public static SubLObject values(SubLObject value1, SubLObject value2, SubLObject value3, SubLObject value4, SubLObject value5) {
 ...
 * @param _values
 */
public static void restoreValuesFromVector(SubLObject _values) {
    // TODO Auto-generated method stub
    if(true)throw new NoSuchMethodError(); 
}
  //// Protected Area
