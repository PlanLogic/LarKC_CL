...
//    	return null;
    ...
    public SubLObject[] accumulateValues(SubLObject result,
                                               SubLObject[] oldValues)
    {
        ...
        if (_values != null) {
            if (_values.length == 0)
                return oldValues;
            int totalLength = oldValues.length + _values.length;
     ...
     *
     */
    static AtomicInteger lastSpecial
  ...
  if (profiling)
    ...
    // ### make-thread
    private static Primitive MAKE_THREAD =
    ...
    // ### threadp
    private static Primitive THREADP =
    ...
    // ### thread-alive-p
    private static Primitive THREAD_ALIVE_P =
    ...
    // ### thread-name
    private static Primitive THREAD_NAME =
    ...
    // ### sleep
    private static Primitive SLEEP = new JavaPrimitive("sleep", PACKAGE_CL, true, "seconds",
    ...
    // ### mapcar-threads
    private static Primitive MAPCAR_THREADS =
    ...
    // ### destroy-thread
    private static Primitive DESTROY_THREAD =
    ...
    private static Primitive INTERRUPT_THREAD =
    ...
    // ### current-thread
    private static Primitive CURRENT_THREAD =
    ...
    // ### backtrace
    private static Primitive BACKTRACE =
    ...
    // ### frame-to-string
    private static Primitive FRAME_TO_STRING =
    ...
    // ### frame-to-list
    private static Primitive FRAME_TO_LIST =
    ...
    // ### use-fast-calls
    private static Primitive USE_FAST_CALLS =
    ...
    // ### synchronized-on
    private static SpecialOperator SYNCHRONIZED_ON =
    ...
    // ### object-wait
    private static Primitive OBJECT_WAIT =
    ...
    // ### object-notify
    private static Primitive OBJECT_NOTIFY =
    ...
    // ### object-notify-all
    private static Primitive OBJECT_NOTIFY_ALL =
