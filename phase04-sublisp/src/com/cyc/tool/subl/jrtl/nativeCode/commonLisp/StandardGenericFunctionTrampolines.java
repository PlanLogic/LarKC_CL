...
public class StandardGenericFunctionTrampolines {
	...
	// ### %generic-function-name
	private static Primitive _GENERIC_FUNCTION_NAME = new JavaPrimitive("%generic-function-name", PACKAGE_SYS, true) {
	...
	private static Primitive _SET_GENERIC_FUNCTION_LAMBDA_LIST = new JavaPrimitive(
	...
	// AMOP p. 230
	private static Primitive SET_FUNCALLABLE_INSTANCE_FUNCTION = new JavaPrimitive(
	...
	// ### gf-required-args
	private static Primitive GF_REQUIRED_ARGS = new JavaPrimitive("gf-required-args", PACKAGE_SYS, true) {
	...
	private static Primitive _SET_GF_REQUIRED_ARGS = new JavaPrimitive("%set-gf-required-args", PACKAGE_SYS, true) {
	...
	private static Primitive GENERIC_FUNCTION_INITIAL_METHODS = new JavaPrimitive(
	...
	// ### generic-function-methods
	private static Primitive GENERIC_FUNCTION_METHODS = new JavaPrimitive("generic-function-methods", PACKAGE_SYS,
			true) {
	...
	private static Primitive SET_GENERIC_FUNCTION_METHOD_CLASS = new JavaPrimitive(
	...
	// ### cache-emf
	private static Primitive CACHE_EMF = new JavaPrimitive("cache-emf", PACKAGE_SYS, true,
	...
	// ### get-cached-emf
	private static Primitive GET_CACHED_EMF = new JavaPrimitive("get-cached-emf", PACKAGE_SYS, true,
	...
	private static Primitive _GET_ARG_SPECIALIZATION = new JavaPrimitive("%get-arg-specialization", PACKAGE_SYS,
	...
	// ### cache-slot-location
	private static Primitive CACHE_SLOT_LOCATION = new JavaPrimitive("cache-slot-location", PACKAGE_SYS, true,
	...
	private static Primitive GET_CACHED_SLOT_LOCATION = new JavaPrimitive("get-cached-slot-location", PACKAGE_SYS,
	...
	private static StandardGenericFunction GENERIC_FUNCTION_NAME = new StandardGenericFunction(
