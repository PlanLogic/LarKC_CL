...
//    }
//
//    public SubLStream(SubLSymbol structureClass, InputStream inputStream, SubLObject elementType) {
...
//    }
//
//    public SubLStream(SubLSymbol structureClass, InputStream inputStream, SubLObject elementType, boolean interactive) {
//        this(structureClass, inputStream, elementType);
//        setInteractive(interactive);
//    }
//
//    public SubLStream(SubLSymbol structureClass, OutputStream outputStream, SubLObject elementType) {
//        this(structureClass, outputStream, elementType, keywordDefault);
//    }
//
//    // Output stream constructors.
//    public SubLStream(SubLSymbol structureClass, OutputStream outputStream, SubLObject elementType, SubLObject format) {
//        this(structureClass);
//        this.elementType = elementType;
//        setExternalFormat(format);
//        if (elementType == LispSymbols.CHARACTER || elementType == LispSymbols.BASE_CHAR) {
...
//    }
	...
	//SubLObject readCharacterLiteral(Readtable instance, LispThread currentThread);
	...
	SubLObject readPreservingWhitespace(boolean eofError, SubLObject eofValue, boolean recursive, LispThread currentThread);
