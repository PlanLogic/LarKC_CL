...
public  class Regex extends SubLTrampolineFile {
  ...
  public static SubLObject compile_regular_expression_impl(SubLObject regularExpressionString, 
      SubLObject options) {
  ...
  public static SubLObject match_regular_expression_pattern_offsets_impl(SubLObject regexPattern, 
