...
public class Pathname extends AbstractLispObject {
    ...
    private static SubLSymbol _LOGICAL_PATHNAME_TRANSLATIONS_ =
    ...
    private static class pf_parse_namestring extends JavaPrimitive {
        ...
        public SubLObject execute(SubLObject first, SubLObject second, SubLObject third) {
            LispThread thread = LispThread.currentThread();
            SubLString namestring = checkString(first);
            ...
            SubLString host = checkString(second);
    ...
    private static class pf_match_wild_jar_pathname extends JavaPrimitive {
        ...
        public SubLObject execute(SubLObject arg) {
            ...
            SubLString wildcard = makeString(wild);
    ...
    public static Pathname mergePathnames(Pathname pathname,
                                                Pathname defaultPathname,
                                                SubLObject defaultVersion) 
    {
        Pathname result;
    ...
    private static SubLObject mergeDirectories(SubLObject dir,
    ...
    private static class pf_rename_file extends JavaPrimitive {
        ...
        public SubLObject execute(SubLObject first, SubLObject second) {
            Pathname original = (Pathname) truename(first, true);
