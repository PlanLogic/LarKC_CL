...
public  abstract class AbstractSubLSequence extends AbstractSubLObject implements SubLSequence {
  ...
  public static SubLObject reduce(SubLSequence seq, BinaryFunction func, int start, int end, SubLObject initialValue) {
    int size = seq.size();
    if (start < 0) { start = 0; }
  ...
  public static SubLSequence remove(SubLSequence seq, SubLObject item, boolean isDestructive,
  ...
  public static SubLSequence removeIf(SubLSequence seq, UnaryFunction test, boolean isDestructive,
  ...
  public static SubLSequence removeDuplicates(SubLSequence seq, boolean isDestructive, 
      BinaryFunction test, UnaryFunction key, int start, int end) {
    SubLSequence result = isDestructive ? seq : seq.makeCopy().toSeq();
  ...
  public static SubLSequence substitute(SubLSequence seq, SubLObject newItem, SubLObject oldItem, boolean isDestructive,
      BinaryFunction test, UnaryFunction key, int start, int end, int count) {
    SubLSequence result = isDestructive ? seq : seq.makeCopy().toSeq();
    int size = seq.size();
    if (start < 0) { start = 0; }
  ...
  public static SubLSequence substituteIf(SubLSequence seq, SubLObject newItem, UnaryFunction test, boolean isDestructive,
      UnaryFunction key, int start, int end, int count) {
    SubLSequence result = isDestructive ? seq : seq.makeCopy().toSeq();
    int size = seq.size();
    if (start < 0) { start = 0; }
  ...
  public static SubLObject find(SubLSequence seq, SubLObject item, BinaryFunction test, UnaryFunction key, int start, int end) {
    if (start < 0) { start = 0; }
    if (end > seq.size()) { end = seq.size(); }
    SubLObject curObj;
    for (int i = start; i < end; i++) {
  ...
  public static int positionOf(SubLSequence seq, SubLObject item, 
      BinaryFunction test, UnaryFunction key, int start, int end) {
    if (start < 0) { start = 0; }
    if (end > seq.size()) { end = seq.size(); }
    SubLObject curObj;
  ...
  public static int count(SubLSequence seq, SubLObject item, BinaryFunction test, UnaryFunction key, int start, int end) {
    int result = 0;
    if (start < 0) { start = 0; }
    if (end > seq.size()) { end = seq.size(); }
    SubLObject curItem;
  ...
  public static int indexOfMismatch(SubLSequence seq, SubLSequence otherSeq, BinaryFunction test,
  ...
  public static int search(SubLSequence seq, SubLSequence otherSeq, BinaryFunction test,
      UnaryFunction key, int start1, int end1, int start2, int end2) {
    if (seq.size() == 0) {
      return start2;
    }
  ...
  public static SubLSequence replace(SubLSequence theSeq, SubLSequence seq, int start1, int end1, int start2, int end2) {
