...
public abstract class FixedArityFunctor implements CommonSymbols {
  ...
  static private String SUBLOBJECT_LNAME = "L" + SUBLOBJECT_INAME + ";";
  static private String SUBLFUNCTION_LNAME = "L" + Type.getInternalName(SubLFunction.class) + ";";  // maybe for later   abstract public int getArity();
