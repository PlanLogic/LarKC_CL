...
public  class SubLObjectFactory {
  ...
  /*public static SubLSymbol makeSymbol(SubLString symbolName, SubLString packageName) {
  ...
  public static SubLStream makeFileStream(String fileName, SubLSymbol direction,
  ...
  public static SubLOutputTextStream makeOutputTextStream(String fileName, 
  ...
  public static SubLInputTextStream makeInputTextStream(String fileName, 
      SubLSymbol ifExists, SubLSymbol ifNotExists) {
  ...
  public static SubLOutputBinaryStream makeOutputBinaryStream(String fileName, 
      SubLSymbol ifExists, SubLSymbol ifNotExists) {
  ...
  public static SubLInputBinaryStream makeInputBinaryStream(String fileName, 
      SubLSymbol ifExists, SubLSymbol ifNotExists) {
  ...
  public static SubLInOutTextStream makeInOutTextStream(String fileName, 
      SubLSymbol ifExists, SubLSymbol ifNotExists) {
    return SubLStreamFactory.makeInOutTextStream(fileName, ifExists, ifNotExists);
  }
  public static SubLInOutBinaryStream makeInOutBinaryStream(String fileName, 
      SubLSymbol ifExists, SubLSymbol ifNotExists) {
  ...
  // @note if this cache is to be used in multiple threads then a synchronized version must be made -APB
  private static Map<String, SubLInteger> integerParsingCache = new LinkedHashMap<String, SubLInteger>(MAX_INTEGER_CACHE_SIZE+1, .75F, true) {
    // This method is called just after a new entry has been added
    public boolean removeEldestEntry(Map.Entry eldest) {
  ...
  // @note if this cache is to be used in multiple threads then a synchronized version must be made -APB
  private static Map<String, SubLCharacter> charParsingCache = new LinkedHashMap<String, SubLCharacter>(MAX_FP_PARSING_CACHE_SIZE+1, .75F, true) {
    // This method is called just after a new entry has been added
    public boolean removeEldestEntry(Map.Entry eldest) {
