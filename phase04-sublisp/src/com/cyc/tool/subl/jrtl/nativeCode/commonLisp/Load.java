...
public class Load
{
    ...
    public static SubLObject load(Pathname pathname,
                                        boolean verbose,
                                        boolean print,
    ...
    static SubLObject COMPILE_FILE_INIT_FASL_TYPE = makeString("_");
     ...
     *
     */
    public static SubLSymbol _FASL_ANONYMOUS_PACKAGE_ =
    ...
    private static SubLObject loadFileFromStream(Pathname pathname,
                                                       Pathname truename,
                                                       LispStream in,
                                                       boolean verbose,
                                                       boolean print,
    ...
    private static SubLObject loadFileFromStream(SubLObject pathname,
                                                       SubLObject truename,
                                                       LispStream in,
                                                       boolean verbose,
                                                       boolean print,
...

    {
        ...
        String prefix = getLoadVerbosePrefix(loadDepth);
        try {
    ...
    private static SubLObject loadStream(LispStream in, boolean print,
                                               LispThread thread)
        {
    ...
    static SubLObject load(SubLObject filespec,
                                         SubLObject verbose,
                                         SubLObject print,
