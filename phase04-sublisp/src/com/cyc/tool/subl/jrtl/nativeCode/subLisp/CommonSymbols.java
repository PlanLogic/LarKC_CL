...
public interface CommonSymbols {
  ...
  public static SubLObject RET_T = T;
  public static SubLNil NIL = SubLNil.NIL;
  public static SubLObject RET_NIL = NIL;
  // Equality
  ...
  public static SubLDoubleFloat ZERO_DOUBLE = (SubLDoubleFloat)SubLObjectFactory.makeDouble(0.0);
  ...
  public static SubLSymbol APPEND_STACK_TRACES_TO_ERROR_MESSAGES = SubLObjectFactory.makeSublispSymbol("*APPEND_STACK_TRACES_TO_ERROR_MESSAGES?*");
  ...
  public static SubLSymbol STRING_GREATER_THAN_OR_EQUAL_SYMBOL = SubLObjectFactory.makeSublispSymbol("STRING-NOT-LESSP");
  public static SubLSymbol STRING_LESS_THAN_OR_EQUAL_SYMBOL = SubLObjectFactory.makeSublispSymbol("STRING-NOT-GREATERP");
  ...
  public static SubLSymbol ASSEMBLE_FIXNUMS_TO_INTEGER = SubLObjectFactory.makeSublispSymbol("ASSEMBLE-FIXNUMS-TO-INTEGER");
 ...
 // Special operators
  ...
  public static SubLSymbol BOOLEANP = SubLObjectFactory.makeCycSymbol("BOOLEANP"); // @hack Cyc package hack to be consistent with Allegro/C
