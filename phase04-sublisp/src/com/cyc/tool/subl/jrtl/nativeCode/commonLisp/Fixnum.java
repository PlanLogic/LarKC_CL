...
{
  public static int MAX_POS_CACHE = 256;//just like before - however never set this to less than 256
  public static Fixnum[] constants = new Fixnum[MAX_POS_CACHE];
  static
  {
  ...
  public static Fixnum ZERO      = constants[0];
  public static Fixnum ONE       = constants[1];
  public static Fixnum TWO       = constants[2];
  public static Fixnum THREE     = constants[3];
