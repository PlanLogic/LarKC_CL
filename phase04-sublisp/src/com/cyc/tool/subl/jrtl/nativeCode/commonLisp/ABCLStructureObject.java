...
public class ABCLStructureObject extends AbstractStructureObject
{
  ...
  private static Primitive STRUCTURE_OBJECT_P =
  ...
  private static Primitive STRUCTURE_LENGTH =
  ...
  private static Primitive STRUCTURE_REF =
  ...
  private static Primitive STRUCTURE_SET =
  ...
  // ### make-structure
  private static Primitive MAKE_STRUCTURE =
  ...
  private static Primitive _MAKE_STRUCTURE =
    new JavaPrimitive("%make-structure", PACKAGE_SYS, true)
    {
  ...
  private static Primitive COPY_STRUCTURE =
