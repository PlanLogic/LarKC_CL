...
public  class Eval implements SubLFile {
  ...
  public Eval() {}
  public static SubLFile me = new Eval();
  //// Public Area
  ...
  private static SubLSymbol EOF_KEYWORD = SubLObjectFactory.makeKeyword("EOF");
  private static SubLString LOAD_ERROR_STRING_1 = SubLObjectFactory.makeString("Read error occured at position ~S of file ~S");
  private static SubLString LOAD_ERROR_STRING_2 = SubLObjectFactory.makeString("Could not load file ~S.");
  ...
  //// Protected Area
  //// Private Area
  private static IsolatedClassLoader isolatedClassLoader = new IsolatedClassLoader();
  //// Internal Rep
  //// Main
}
