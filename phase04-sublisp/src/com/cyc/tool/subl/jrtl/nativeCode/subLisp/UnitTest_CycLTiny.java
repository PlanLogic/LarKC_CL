      ...
      SubLProcess subLProcess = new SubLProcess("Initial Lisp Listener") {
        public void safeRun() {
          ...
          if (!SubLMain.shouldRunInBackground()) {
            ...
            System.out.println("Total memory allocated to VM: " + (int)(rt.totalMemory()/(1024.0*1024.0)) + "MB.");
            System.out.println("Memory currently available: " + (int)(rt.freeMemory()/(1024.0*1024.0)) + "MB.");
            System.out.println("Memory currently used: " + (int)((rt.totalMemory() - rt.freeMemory())/(1024*1024.0)) + "MB.");
