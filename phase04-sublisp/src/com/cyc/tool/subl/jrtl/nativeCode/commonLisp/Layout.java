...
public class Layout extends AbstractLispObject
{
  ...
  // ### make-layout
  private static Primitive MAKE_LAYOUT =
  ...
  // ### layout-class
  private static Primitive LAYOUT_CLASS =
  ...
  // ### layout-length
  private static Primitive LAYOUT_LENGTH =
  ...
  private static Primitive LAYOUT_SLOT_INDEX =
    new JavaPrimitive("layout-slot-index", PACKAGE_SYS, true)
    {
      ...
      {
          SubLObject slotNames[] = checkLayout(first).slotNames;
          for (int i = slotNames.length; i-- > 0;)
            {
  ...
  private static Primitive LAYOUT_SLOT_LOCATION =
    new JavaPrimitive("layout-slot-location", PACKAGE_SYS, true, "layout slot-name")
    {
      ...
      {
                Layout layOutFirst = checkLayout(first);
  ...
  private static Primitive _MAKE_INSTANCES_OBSOLETE =
    new JavaPrimitive("%make-instances-obsolete", PACKAGE_SYS, true, "class")
    {
      
      public SubLObject execute(SubLObject arg)
      {
        LispClass lispClass = checkClass(arg);
