...
{
    // ### read-comment
    public static ReaderMacroFunction READ_COMMENT =
    ...
    // ### read-string
    public static ReaderMacroFunction READ_STRING =
    ...
    // ### read-list
    public static ReaderMacroFunction READ_LIST =
    ...
    // ### read-right-paren
    public static ReaderMacroFunction READ_RIGHT_PAREN =
    ...
    // ### read-quote
    public static ReaderMacroFunction READ_QUOTE =
    ...
    // ### read-dispatch-char
    public static ReaderMacroFunction READ_DISPATCH_CHAR =
    ...
    // ### sharp-left-paren
    public static DispatchMacroFunction SHARP_LEFT_PAREN =
    ...
    // ### sharp-star
    public static DispatchMacroFunction SHARP_STAR =
                                  ...
                                  "stream sub-char numarg")
    {
...

        {
            LispThread thread = LispThread.currentThread();
            Readtable rt = (Readtable) LispSymbols.CURRENT_READTABLE.symbolValue(thread);
            boolean suppress = LispSymbols.READ_SUPPRESS.symbolValue(thread) != NIL;
            StringBuilder sb = new StringBuilder();
            try 
              {
                while (true) {
    ...
    // ### sharp-dot
    public static DispatchMacroFunction SHARP_DOT =
    ...
    // ### sharp-colon
    public static DispatchMacroFunction SHARP_COLON =
    ...
    // ### sharp-a
    public static DispatchMacroFunction SHARP_A =
    ...
    // ### sharp-b
    public static DispatchMacroFunction SHARP_B =
    ...
    // ### sharp-c
    public static DispatchMacroFunction SHARP_C =
    ...
    // ### sharp-o
    public static DispatchMacroFunction SHARP_O =
    ...
    // ### sharp-p
    public static DispatchMacroFunction SHARP_P =
    ...
    // ### sharp-r
    public static DispatchMacroFunction SHARP_R =
    ...
    // ### sharp-s
    public static DispatchMacroFunction SHARP_S =
    ...
    // ### sharp-x
    public static DispatchMacroFunction SHARP_X =
    ...
    // ### sharp-quote
    public static DispatchMacroFunction SHARP_QUOTE =
    ...
    // ### sharp-backslash
    public static DispatchMacroFunction SHARP_BACKSLASH =
    ...
    // ### sharp-vertical-bar
    public static DispatchMacroFunction SHARP_VERTICAL_BAR =
    ...
    // ### sharp-illegal
    public static DispatchMacroFunction SHARP_ILLEGAL =
