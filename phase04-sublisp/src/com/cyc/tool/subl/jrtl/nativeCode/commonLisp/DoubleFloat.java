...
public class DoubleFloat extends LispFloat
{
    public static DoubleFloat ZERO       = new DoubleFloat(0);
    public static DoubleFloat MINUS_ZERO = new DoubleFloat(-0.0d);
    public static DoubleFloat ONE        = new DoubleFloat(1);
    public static DoubleFloat MINUS_ONE  = new DoubleFloat(-1);

    public static DoubleFloat DOUBLE_FLOAT_POSITIVE_INFINITY =
        makeDouble(Double.POSITIVE_INFINITY);

    public static DoubleFloat DOUBLE_FLOAT_NEGATIVE_INFINITY =
