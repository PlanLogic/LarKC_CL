...
{
  static SubLObject FUNCTION_EQ =
    LispSymbols.EQ.getSymbolFunction();
  static SubLObject FUNCTION_EQL =
    LispSymbols.EQL.getSymbolFunction();
  static SubLObject FUNCTION_EQUAL =
    LispSymbols.EQUAL.getSymbolFunction();
  static SubLObject FUNCTION_EQUALP =
    LispSymbols.EQUALP.getSymbolFunction();

  // ### %make-hash-table
  private static Primitive _MAKE_HASH_TABLE =
  ...
  private static Primitive GETHASH =
  ...
  private static Primitive GETHASH1 =
    new JavaPrimitive(LispSymbols.GETHASH1, "key hash-table")
    {
      ...
      {
        HashTable ht = checkHashTable(second);
        synchronized (ht)
          {
  ...
  private static Primitive PUTHASH =
  ...
  private static Primitive REMHASH =
  ...
  private static Primitive CLRHASH =
  ...
  // ### hash-table-count
  private static Primitive HASH_TABLE_COUNT =
  ...
  private static Primitive SXHASH =
  ...
  private static Primitive PSXHASH =
  ...
  // ### hash-table-p
  private static Primitive HASH_TABLE_P =
  ...
  // ### hash-table-entries
  private static Primitive HASH_TABLE_ENTRIES =
  ...
  // ### hash-table-test
  private static Primitive HASH_TABLE_TEST =
  ...
  // ### hash-table-size
  private static Primitive HASH_TABLE_SIZE =
  ...
  private static Primitive HASH_TABLE_REHASH_SIZE =
  ...
  private static Primitive HASH_TABLE_REHASH_THRESHOLD =
  ...
  // ### maphash
  private static Primitive MAPHASH =
