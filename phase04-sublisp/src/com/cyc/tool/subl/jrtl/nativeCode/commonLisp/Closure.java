...
public class Closure extends Function
{
  ...
  public Closure(SubLObject name, SubLObject lambdaExpression,
                 Environment env)
  ...
  private void processParameters(ArrayList<SubLSymbol> vars,
  ...
  private void bindRequiredParameters(Environment ext,
                                            LispThread thread,
                                            SubLObject[] objects)
...

  {
    ...
    if (argsLength < minArgs)
      error(new WrongNumberOfArgumentsException(this));
    SubLObject[] array = new SubLObject[variables.length];
    int index = 0;
  ...
  private void bindParameterDefaults(Parameter[] parameters,
                                           Environment env,
                                           LispThread thread)
  ...
  // ### lambda-list-names
  private static Primitive LAMBDA_LIST_NAMES =
