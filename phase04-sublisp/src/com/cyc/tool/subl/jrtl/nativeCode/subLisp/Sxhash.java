...
public  class Sxhash extends SubLTrampolineFile {
  ...
  public static SubLVector hashVector = SubLObjectFactory.makeVector(256, NIL);
  public static int MAX_STRUCT_DECLARATIONS = 2048;
  public static UnaryFunction[] structHashMeths = new UnaryFunction[MAX_STRUCT_DECLARATIONS];
  ...
  public static int SXHASH_BIT_LIMIT2 = SXHASH_BIT_LIMIT.intValue();
