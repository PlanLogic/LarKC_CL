...
public  class SubLFiles {
   ...
   */
  public static void declareFunction(SubLFile file, String methodName, 
  ...
  public static void declareFunction(String className, String methodName, 
      String functionName, int requiredArgCount, int optionalArgCount, boolean allowsRest) {
    try {
      List<Class> parameterTypes = new ArrayList<Class>();
      for (int i = 0; i < requiredArgCount + optionalArgCount; i++) {
  ...
  public static abstract class VariableAccessMode {
    public String toString() { return toSymbol().toString(); }
    public abstract SubLSymbol toSymbol();
    
    public static VariableAccessMode CONSTANT = new VariableAccessMode() {
      public SubLSymbol toSymbol() { return CommonSymbols.CONSTANT; }
    };
    public static VariableAccessMode LEXICAL  = new VariableAccessMode()  {
      public SubLSymbol toSymbol() { return CommonSymbols.LEXICAL; }
    };
    public static VariableAccessMode DYNAMIC  = new VariableAccessMode() {
      public SubLSymbol toSymbol() { return CommonSymbols.DYNAMIC; }
    };
    public static VariableAccessMode UNDECLARED  = new VariableAccessMode() {
      public SubLSymbol toSymbol() { return CommonSymbols.UNDECLARED; }
    };
  }
  
  private static SubLSymbol declareGlobal(
