...
public abstract class AbstractSubLStruct extends AbstractSubLObject implements SubLStruct {
	...
	public boolean equalp(SubLObject obj) {
		...
		if (decl != null && otherDecl != null) {
			if (decl.isInterned || decl != otherDecl)
				return false;
		} else if (!this.getField0().equalp(otherStuct.getField0()) || !this.getField1().equalp(otherStuct.getField1()))
			return false;
	...
	public String toString() {
		try {
			...
			return "#<" + this.toTypeName() + " " + this.getName() + " @ " + System.identityHashCode(this) + ">";
		}
	}
