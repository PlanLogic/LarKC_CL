...
public abstract class AbstractSubLSequence extends AbstractSubLObject implements SubLSequence {
	...
	static {
		AbstractSubLSequence.FAST_DELETE_DUPLICATES_CONS_CUTOFF = 80;
		AbstractSubLSequence.FAST_DELETE_DUPLICATES_ARRAY_CUTOFF = 20;
	}
	...
	public static SubLSequence removeDuplicates(SubLSequence seq, boolean isDestructive, BinaryFunction test,
		...
		if (key == UnaryFunction.IDENTITY_UNARY_FUNC && size >= AbstractSubLSequence.FAST_DELETE_DUPLICATES_ARRAY_CUTOFF
	...
	public int count(SubLObject item, BinaryFunction test) {
		return this.count(item, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public int countIf(UnaryFunction test) {
		return this.countIf(test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public SubLObject find(SubLObject item, BinaryFunction test) {
		return this.find(item, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public int indexOfMismatch(SubLSequence otherSeq, BinaryFunction test) {
		return this.indexOfMismatch(otherSeq, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, 0,
				Integer.MAX_VALUE);
	}
	...
	public int positionOf(SubLObject item, BinaryFunction test) {
		return this.positionOf(item, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public int positionOfIf(UnaryFunction test) {
		return this.positionOfIf(test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public SubLSequence remove(SubLObject item, boolean isDestructive, BinaryFunction test) {
		return this.remove(item, isDestructive, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE,
				Integer.MAX_VALUE);
	}
	...
	public SubLSequence removeDuplicates(boolean isDestructive) {
		return this.removeDuplicates(isDestructive, AbstractSubLSequence.EQL_TEST,
				AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE);
	}
	...
	public SubLSequence removeIf(UnaryFunction test, boolean isDestructive) {
		return this.removeIf(test, isDestructive, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE,
				Integer.MAX_VALUE);
	}
	...
	public int search(SubLSequence otherSeq, BinaryFunction test) {
		return this.search(otherSeq, test, AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, 0,
				Integer.MAX_VALUE);
	}
	...
	public SubLSequence substitute(SubLObject newItem, SubLObject oldItem, boolean isDestructive) {
		return this.substitute(newItem, oldItem, isDestructive, AbstractSubLSequence.EQL_TEST,
				AbstractSubLSequence.IDENTITY_UNARY_FUNC, 0, Integer.MAX_VALUE, Integer.MAX_VALUE);
	}
