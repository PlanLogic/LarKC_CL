...
public class Functions extends SubLTrampolineFile {
	...
	public static SubLObject apply(SubLObject function, SubLObject arg) {
		...
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2);
		SubLObject arg3 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3);
		SubLObject arg4 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4);
		SubLObject arg5 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5);
		SubLObject arg6 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5, arg6);
		SubLObject arg7 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5, arg6, arg7);
		SubLObject arg8 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		SubLObject arg9 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
		SubLObject arg10 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
	...
	public static SubLObject apply(SubLObject function, SubLObject arg, SubLObject otherArgs) {
		if (otherArgs == CommonSymbols.NIL)
			return Functions.funcall(function, arg);
		SubLObject arg2 = otherArgs.first();
		SubLObject loopVar = otherArgs.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2);
		SubLObject arg3 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3);
		SubLObject arg4 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4);
		SubLObject arg5 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4, arg5);
		SubLObject arg6 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4, arg5, arg6);
		SubLObject arg7 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4, arg5, arg6, arg7);
		SubLObject arg8 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
		SubLObject arg9 = loopVar.first();
		loopVar = loopVar.rest();
		if (loopVar == CommonSymbols.NIL)
			return Functions.funcall(function, arg, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
