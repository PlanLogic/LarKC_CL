...
public class SubLInOutTextStreamImpl extends AbstractSubLTextStream
	...
	public long readByteSequenceToPositiveInteger(int bytesInInteger) {
		...
		return this.toInputBinaryStream().readByteSequenceToPositiveInteger(bytesInInteger);
	}
	...
	public long readByteSequenceToPositiveInteger(int bytesInInteger, boolean useNetworkByteOrder) {
		...
		return this.toInputBinaryStream().readByteSequenceToPositiveInteger(bytesInInteger, useNetworkByteOrder);
	}
