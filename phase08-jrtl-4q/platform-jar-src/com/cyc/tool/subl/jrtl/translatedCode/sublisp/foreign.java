...
public class foreign extends SubLTranslatedFile {
	...
	static {
		...
		foreign.$str0$Foreign_Shared_Libraries_Lock = SubLObjectFactory.makeString("Foreign Shared Libraries Lock");
		foreign.$list1 = ConsesLow.list(
		...
		foreign.$list2 = ConsesLow.list(SubLObjectFactory.makeKeyword("OPAQUE"),
				SubLObjectFactory.makeKeyword("ALIEN"));
		foreign.$list3 = ConsesLow.list(SubLObjectFactory.makeKeyword("INT32"),
				SubLObjectFactory.makeKeyword("FIXNUM"));
		foreign.$kw4$FILENAME = SubLObjectFactory.makeKeyword("FILENAME");
		foreign.$str5$Foreign_shared_library_must_have_ = SubLObjectFactory
				.makeString("Foreign shared library must have :FILENAME property.");
		foreign.$kw6$DEPENDS_ON = SubLObjectFactory.makeKeyword("DEPENDS-ON");
		foreign.$str7$_A_does_not_reference_a_known_for = SubLObjectFactory
				.makeString("~A does not reference a known foreign shared library.");
		foreign.$str8$Active_Foreign_Shared_Libraries = SubLObjectFactory.makeString("Active Foreign Shared Libraries");
		foreign.$str9$_S_is_not_associated_with_any_for = SubLObjectFactory
				.makeString("~S is not associated with any foreign shared library.");
		foreign.$str10$Shared_library__S___S__is_already = SubLObjectFactory
				.makeString("Shared library ~S (~S) is already loaded.");
		foreign.$str11$_S_does_not_designate_one_of_the_ = SubLObjectFactory
				.makeString("~S does not designate one of the libraries (~S) currently loaded.");
		foreign.$str12$_S_does_not_designate_a_known_sha = SubLObjectFactory
				.makeString("~S does not designate a known shared library.");
		foreign.$str13$_ = SubLObjectFactory.makeString("%");
		foreign.$list14 = ConsesLow.list(SubLObjectFactory.makeSymbol("SYMBOL"),
				SubLObjectFactory.makeSymbol("ARGLIST"), SubLObjectFactory.makeSymbol("RULES"));
		foreign.$sym15$SYMBOLP = SubLObjectFactory.makeSymbol("SYMBOLP");
		foreign.$sym16$LISTP = SubLObjectFactory.makeSymbol("LISTP");
		foreign.$list17 = ConsesLow.list(SubLObjectFactory.makeSymbol("&KEY"),
		...
		foreign.$list18 = ConsesLow.list(SubLObjectFactory.makeKeyword("CALLING-CONVENTION"),
		...
		foreign.$kw19$ALLOW_OTHER_KEYS = SubLObjectFactory.makeKeyword("ALLOW-OTHER-KEYS");
		foreign.$kw20$CALLING_CONVENTION = SubLObjectFactory.makeKeyword("CALLING-CONVENTION");
		foreign.$kw21$C = SubLObjectFactory.makeKeyword("C");
		foreign.$kw22$FOREIGN_SHARED_LIBRARY = SubLObjectFactory.makeKeyword("FOREIGN-SHARED-LIBRARY");
		foreign.$kw23$FOREIGN_NAME = SubLObjectFactory.makeKeyword("FOREIGN-NAME");
		foreign.$kw24$ARG_CONVERSION = SubLObjectFactory.makeKeyword("ARG-CONVERSION");
		foreign.$kw25$RETURN_TYPE = SubLObjectFactory.makeKeyword("RETURN-TYPE");
		foreign.$kw26$VOID = SubLObjectFactory.makeKeyword("VOID");
		foreign.$str27$Currently__only_calling_conventio = SubLObjectFactory
				.makeString("Currently, only calling-convention :C is supported.");
		foreign.$str28$_FOREIGN_NAME_expects_STRING__not = SubLObjectFactory
				.makeString(":FOREIGN-NAME expects STRING, not ~S.");
		foreign.$str29$The_argument_list__S_and_the__ARG = SubLObjectFactory
				.makeString("The argument list ~S and the :ARG-CONVERSION pattern ~S appear malaligned.");
		foreign.$str30$_S_is_not_a_valid__ARG_CONVERSION = SubLObjectFactory
				.makeString("~S is not a valid :ARG-CONVERSION argument.");
		foreign.$str31$_S_is_not_a_valid__RETURN_TYPE_ar = SubLObjectFactory
				.makeString("~S is not a valid :RETURN-TYPE argument.");
		foreign.$str32$Do_not_know_how_to_generate_a_for = SubLObjectFactory
				.makeString("Do not know how to generate a foreign name from ~S for ~S.");
		foreign.$list33 = ConsesLow.list(SubLObjectFactory.makeSymbol("SYMBOL"), SubLObjectFactory.makeSymbol("&REST"),
				SubLObjectFactory.makeSymbol("ARGS"));
		foreign.$sym34$FUNCALL = SubLObjectFactory.makeSymbol("FUNCALL");
		foreign.$sym35$DEF_FOREIGN_FUNCTION = SubLObjectFactory.makeSymbol("DEF-FOREIGN-FUNCTION");
		foreign.$sym36$QUOTE = SubLObjectFactory.makeSymbol("QUOTE");
		foreign.$sym37$PROGN = SubLObjectFactory.makeSymbol("PROGN");
		foreign.$sym38$DEFINE = SubLObjectFactory.makeSymbol("DEFINE");
		foreign.$sym39$CLET = SubLObjectFactory.makeSymbol("CLET");
		foreign.$sym40$_VAL = SubLObjectFactory.makeSymbol("%VAL");
		foreign.$sym41$FFUNCALL = SubLObjectFactory.makeSymbol("FFUNCALL");
		foreign.$sym42$PIF = SubLObjectFactory.makeSymbol("PIF");
		foreign.$list43 = ConsesLow.list(SubLObjectFactory.makeSymbol("ALIEN-NULL-PTR?"),
				SubLObjectFactory.makeSymbol("%VAL"), SubLObjectFactory.makeKeyword("C"));
		foreign.$sym44$RET = SubLObjectFactory.makeSymbol("RET");
		foreign.$list45 = ConsesLow
	...
	public static SubLObject analyze_define_foreign_function_arguments(SubLObject symbol, SubLObject arglist,
		...
		while (CommonSymbols.NIL != rest) {
			...
			rest = rest.rest();
			cdestructuring_bind.destructuring_bind_must_consp(rest, rules, foreign.$list17);
			if (CommonSymbols.NIL == conses_high.member(current_$1, foreign.$list18, CommonSymbols.UNPROVIDED,
		...
		SubLObject calling_convention_tail = cdestructuring_bind.property_list_member(foreign.$kw20$CALLING_CONVENTION,
				rules);
		SubLObject calling_convention = CommonSymbols.NIL != calling_convention_tail
				? conses_high.cadr(calling_convention_tail) : foreign.$kw21$C;
		SubLObject foreign_shared_library_tail = cdestructuring_bind
				.property_list_member(foreign.$kw22$FOREIGN_SHARED_LIBRARY, rules);
		SubLObject foreign_shared_library = CommonSymbols.NIL != foreign_shared_library_tail
				? conses_high.cadr(foreign_shared_library_tail) : CommonSymbols.NIL;
		SubLObject foreign_name_tail = cdestructuring_bind.property_list_member(foreign.$kw23$FOREIGN_NAME, rules);
		SubLObject foreign_name = CommonSymbols.NIL != foreign_name_tail ? conses_high.cadr(foreign_name_tail)
				: CommonSymbols.NIL;
		SubLObject arg_conversion_tail = cdestructuring_bind.property_list_member(foreign.$kw24$ARG_CONVERSION, rules);
		SubLObject arg_conversion = CommonSymbols.NIL != arg_conversion_tail ? conses_high.cadr(arg_conversion_tail)
				: CommonSymbols.NIL;
		SubLObject return_type_tail = cdestructuring_bind.property_list_member(foreign.$kw25$RETURN_TYPE, rules);
		SubLObject return_type = CommonSymbols.NIL != return_type_tail ? conses_high.cadr(return_type_tail)
				: foreign.$kw26$VOID;
		if (CommonSymbols.NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
				&& calling_convention != foreign.$kw21$C)
		...
		if (CommonSymbols.NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !foreign_name.isString())
			Errors.error(foreign.$str28$_FOREIGN_NAME_expects_STRING__not, foreign_name);
		if (CommonSymbols.NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
				&& !Sequences.length(arglist).numE(Sequences.length(arg_conversion)))
			Errors.error(foreign.$str29$The_argument_list__S_and_the__ARG, arglist, arg_conversion);
		if (CommonSymbols.NIL == Errors.$ignore_mustsP$.getDynamicValue(thread)
				&& CommonSymbols.NIL == foreign.valid_arg_conversion_pattern(arg_conversion))
			Errors.error(foreign.$str30$_S_is_not_a_valid__ARG_CONVERSION, arg_conversion);
		if (CommonSymbols.NIL == Errors.$ignore_mustsP$.getDynamicValue(thread) && !return_type.isKeyword()
				&& !return_type.isList())
	...
	public static SubLObject declare_foreign_file() {
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"declare_foreign_shared_library", "DECLARE-FOREIGN-SHARED-LIBRARY", 2, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"find_foreign_shared_library_by_pathname", "FIND-FOREIGN-SHARED-LIBRARY-BY-PATHNAME", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"get_foreign_shared_library_pathname", "GET-FOREIGN-SHARED-LIBRARY-PATHNAME", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"get_foreign_shared_library_dependencies", "GET-FOREIGN-SHARED-LIBRARY-DEPENDENCIES", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"get_foreign_shared_library_property", "GET-FOREIGN-SHARED-LIBRARY-PROPERTY", 2, 1, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "foreign_shared_library_p",
				"FOREIGN-SHARED-LIBRARY-P", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"undeclare_foreign_shared_library", "UNDECLARE-FOREIGN-SHARED-LIBRARY", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"all_foreign_shared_libraries", "ALL-FOREIGN-SHARED-LIBRARIES", 0, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"foreign_shared_library_loadableP", "FOREIGN-SHARED-LIBRARY-LOADABLE?", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"find_foreign_shared_library_by_property", "FIND-FOREIGN-SHARED-LIBRARY-BY-PROPERTY", 2, 1, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"find_foreign_shared_library_int", "FIND-FOREIGN-SHARED-LIBRARY-INT", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"edit_foreign_shared_library", "EDIT-FOREIGN-SHARED-LIBRARY", 2, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"foreign_shared_library_accessibleP", "FOREIGN-SHARED-LIBRARY-ACCESSIBLE?", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"load_foreign_shared_library", "LOAD-FOREIGN-SHARED-LIBRARY", 1, 1, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"ensure_foreign_shared_library_loaded", "ENSURE-FOREIGN-SHARED-LIBRARY-LOADED", 1, 1, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"foreign_shared_library_loadedP", "FOREIGN-SHARED-LIBRARY-LOADED?", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"unload_foreign_shared_library", "UNLOAD-FOREIGN-SHARED-LIBRARY", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"foreign_shared_library_installedP", "FOREIGN-SHARED-LIBRARY-INSTALLED?", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "load_shared_library_int",
				"LOAD-SHARED-LIBRARY-INT", 3, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "unload_shared_library_int",
				"UNLOAD-SHARED-LIBRARY-INT", 2, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"foreign_shared_library_loaded_intP", "FOREIGN-SHARED-LIBRARY-LOADED-INT?", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "return_type_string_p",
				"RETURN-TYPE-STRING-P", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "return_type_pointer_p",
				"RETURN-TYPE-POINTER-P", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "default_return_value",
				"DEFAULT-RETURN-VALUE", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"make_helper_function_symbol", "MAKE-HELPER-FUNCTION-SYMBOL", 2, 0, false);
		SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "define_foreign_function",
				"DEFINE-FOREIGN-FUNCTION");
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"analyze_define_foreign_function_arguments", "ANALYZE-DEFINE-FOREIGN-FUNCTION-ARGUMENTS", 3, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"generate_foreign_name_from_sublisp_symbol", "GENERATE-FOREIGN-NAME-FROM-SUBLISP-SYMBOL", 2, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"valid_arg_conversion_pattern", "VALID-ARG-CONVERSION-PATTERN", 1, 0, false);
		SubLFiles.declareMacro("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "ffuncall", "FFUNCALL");
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "make_dummy_arg_list",
				"MAKE-DUMMY-ARG-LIST", 1, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign",
				"define_foreign_function_internal", "DEFINE-FOREIGN-FUNCTION-INTERNAL", 7, 0, false);
		SubLFiles.declareFunction("com.cyc.tool.subl.jrtl.translatedCode.sublisp.foreign", "vector_for_marshalling",
				"VECTOR-FOR-MARSHALLING", 3, 0, false);
	...
	public static SubLObject define_foreign_function(SubLObject macroform, SubLObject environment) {
		...
		assert CommonSymbols.NIL != Types.symbolp(symbol) : symbol;
		assert CommonSymbols.NIL != Types.listp(arglist) : arglist;
		assert CommonSymbols.NIL != Types.listp(rules) : rules;
		thread.resetMultipleValues();
		SubLObject calling_convention = foreign.analyze_define_foreign_function_arguments(symbol, arglist, rules);
		...
		thread.resetMultipleValues();
		return foreign.define_foreign_function_internal(symbol, arglist, calling_convention, foreign_shared_library,
				foreign_name, arg_conversion, return_type);
	}
	...
	public static SubLObject define_foreign_function_internal(SubLObject symbol, SubLObject arglist,
		...
		SubLObject ret_type = return_type.isList() ? return_type.first() : CommonSymbols.NIL;
		...
		SubLObject main_function = ConsesLow.list(foreign.$sym35$DEF_FOREIGN_FUNCTION, foreign_shared_library,
				...
				ConsesLow.list(foreign.$sym36$QUOTE, arg_conversion), ConsesLow.list(foreign.$sym36$QUOTE, ret_type),
				calling_convention, default_return_value);
		if (!symbol.equal(symbol_ff)) {
			SubLObject dummy_arglist = foreign.make_dummy_arg_list(arglist);
			SubLObject retit = ConsesLow.list(foreign.$sym37$PROGN, main_function, ConsesLow.list(foreign.$sym38$DEFINE,
					symbol, dummy_arglist,
					ConsesLow.list(foreign.$sym39$CLET, ConsesLow.list(ConsesLow.list(foreign.$sym40$_VAL,
							ConsesLow.listS(foreign.$sym41$FFUNCALL, ConsesLow.list(foreign.$sym36$QUOTE, symbol_ff),
									ConsesLow.append(dummy_arglist, CommonSymbols.NIL)))),
							ConsesLow.listS(foreign.$sym42$PIF, foreign.$list43,
									ConsesLow.list(foreign.$sym44$RET, default_return_value), foreign.$list45))));
			return retit;
		}
		...
		if (CommonSymbols.NIL == foreign.foreign_shared_library_loaded_intP(moniker)) {
			...
			try {
				...
				if (CommonSymbols.NIL == foreign.foreign_shared_library_loadedP(moniker)) {
					...
					SubLObject dependencies = cdolist_list_var = foreign
							.get_foreign_shared_library_dependencies(moniker);
	...
	public static SubLObject find_foreign_shared_library_by_property(SubLObject property, SubLObject value,
		...
		if (CommonSymbols.NIL == found) {
			...
			while (CommonSymbols.NIL == found && CommonSymbols.NIL != csome_list_var) {
	...
	public static SubLObject foreign_shared_library_loadableP(SubLObject moniker) {
		...
		if (CommonSymbols.NIL != pathname)
			return CommonSymbols.NIL != Filesys.probe_file(pathname) ? CommonSymbols.T : CommonSymbols.NIL;
		return CommonSymbols.NIL;
	}
	...
	public static SubLObject load_foreign_shared_library(SubLObject moniker, SubLObject options) {
		...
		try {
			...
			if (CommonSymbols.NIL != foreign.foreign_shared_library_loadedP(moniker))
				...
				foreign.$active_foreign_shared_libraries$.setDynamicValue(
						ConsesLow.cons(moniker, foreign.$active_foreign_shared_libraries$.getDynamicValue(thread)),
						thread);
			}
		} finally {
			if (CommonSymbols.NIL != release)
	...
	public static SubLObject unload_foreign_shared_library(SubLObject moniker) {
		...
		try {
			...
			if (CommonSymbols.NIL != foreign.foreign_shared_library_loadedP(moniker)) {
				...
				foreign.$active_foreign_shared_libraries$.setDynamicValue(
						Sequences.delete(moniker, foreign.$active_foreign_shared_libraries$.getDynamicValue(thread),
								CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED,
								CommonSymbols.UNPROVIDED, CommonSymbols.UNPROVIDED),
						thread);
