...
public class time_high extends SubLTranslatedFile {
	...
	static {
		time_high.me = new time_high();
		time_high.$internal_time_units_per_second$ = null;
		time_high.$ut_offset_from_rata_die$ = null;
		time_high.$int0$1000000 = SubLObjectFactory.makeInteger(1000000);
		time_high.$int1$693595 = SubLObjectFactory.makeInteger(693595);
		time_high.$int2$3600 = SubLObjectFactory.makeInteger(3600);
		time_high.$int3$86400 = SubLObjectFactory.makeInteger(86400);
		time_high.$int4$146097 = SubLObjectFactory.makeInteger(146097);
		time_high.$int5$36524 = SubLObjectFactory.makeInteger(36524);
		time_high.$int6$1461 = SubLObjectFactory.makeInteger(1461);
		time_high.$int7$365 = SubLObjectFactory.makeInteger(365);
		time_high.$int8$400 = SubLObjectFactory.makeInteger(400);
		time_high.$int9$100 = SubLObjectFactory.makeInteger(100);
		time_high.$int10$31 = SubLObjectFactory.makeInteger(31);
		time_high.$list11 = ConsesLow.list(SubLObjectFactory.makeInteger(100), SubLObjectFactory.makeInteger(200),
				SubLObjectFactory.makeInteger(300));
		time_high.$int12$59 = SubLObjectFactory.makeInteger(59);
		time_high.$int13$_2 = SubLObjectFactory.makeInteger(-2);
		time_high.$int14$373 = SubLObjectFactory.makeInteger(373);
		time_high.$int15$367 = SubLObjectFactory.makeInteger(367);
		time_high.$int16$362 = SubLObjectFactory.makeInteger(362);
		time_high.$int17$60 = SubLObjectFactory.makeInteger(60);
		time_high.$int18$50 = SubLObjectFactory.makeInteger(50);
		time_high.$int19$99 = SubLObjectFactory.makeInteger(99);
	}
	...
	public static SubLObject decode_universal_time(SubLObject universal_time, SubLObject time_zone) {
		...
		year = Numbers.add(new SubLObject[] { Numbers.multiply(quadricentennials, time_high.$int8$400),
				...
				CommonSymbols.NIL != last_day_of_cycle_p ? CommonSymbols.ZERO_INTEGER : CommonSymbols.ONE_INTEGER });
	...
	public static SubLObject encode_universal_time_internal(SubLObject second, SubLObject minute, SubLObject hour,
		...
		if (month.numLE(CommonSymbols.TWO_INTEGER))
			february_adjustment = CommonSymbols.ZERO_INTEGER;
				...
				&& CommonSymbols.NIL == conses_high.member(Numbers.mod(year, time_high.$int8$400), time_high.$list11,
