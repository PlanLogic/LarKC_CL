...
public class stream_macros extends SubLTranslatedFile {
	...
	static {
		stream_macros.me = new stream_macros();
		stream_macros.$stream_requires_locking$ = null;
		stream_macros.$sym0$CLET = SubLObjectFactory.makeSymbol("CLET");
		stream_macros.$list1 = ConsesLow
				.list(ConsesLow.list(SubLObjectFactory.makeSymbol("*STREAM-REQUIRES-LOCKING*"), CommonSymbols.NIL));
		stream_macros.$list2 = ConsesLow.list(
		...
		stream_macros.$sym3$CUNWIND_PROTECT = SubLObjectFactory.makeSymbol("CUNWIND-PROTECT");
		stream_macros.$sym4$PROGN = SubLObjectFactory.makeSymbol("PROGN");
		stream_macros.$sym5$CSETQ = SubLObjectFactory.makeSymbol("CSETQ");
		stream_macros.$list6 = ConsesLow
				.list(ConsesLow.list(SubLObjectFactory.makeSymbol("MAKE-PRIVATE-STRING-OUTPUT-STREAM")));
		stream_macros.$sym7$CSETF = SubLObjectFactory.makeSymbol("CSETF");
		stream_macros.$sym8$GET_OUTPUT_STREAM_STRING = SubLObjectFactory.makeSymbol("GET-OUTPUT-STREAM-STRING");
		stream_macros.$sym9$CLOSE = SubLObjectFactory.makeSymbol("CLOSE");
		stream_macros.$list10 = ConsesLow.list(
				...
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		stream_macros.$list11 = ConsesLow.list(SubLObjectFactory.makeKeyword("INDEX"),
				SubLObjectFactory.makeKeyword("START"), SubLObjectFactory.makeKeyword("END"));
		stream_macros.$kw12$ALLOW_OTHER_KEYS = SubLObjectFactory.makeKeyword("ALLOW-OTHER-KEYS");
		stream_macros.$kw13$INDEX = SubLObjectFactory.makeKeyword("INDEX");
		stream_macros.$kw14$START = SubLObjectFactory.makeKeyword("START");
		stream_macros.$kw15$END = SubLObjectFactory.makeKeyword("END");
		stream_macros.$sym16$MAKE_PRIVATE_STRING_INPUT_STREAM = SubLObjectFactory
				.makeSymbol("MAKE-PRIVATE-STRING-INPUT-STREAM");
		stream_macros.$sym17$STREAM_INPUT_INDEX = SubLObjectFactory.makeSymbol("STREAM-INPUT-INDEX");
		stream_macros.$list18 = ConsesLow.list(
				ConsesLow.list(SubLObjectFactory.makeSymbol("VAR"), SubLObjectFactory.makeSymbol("STREAM")),
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		stream_macros.$str19$STREAM_VAR = SubLObjectFactory.makeString("STREAM-VAR");
		stream_macros.$sym20$PWHEN = SubLObjectFactory.makeSymbol("PWHEN");
		stream_macros.$list21 = ConsesLow.list(
				...
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		stream_macros.$sym22$WITH_OPEN_STREAM = SubLObjectFactory.makeSymbol("WITH-OPEN-STREAM");
		stream_macros.$sym23$OPEN = SubLObjectFactory.makeSymbol("OPEN");
		stream_macros.$list24 = ConsesLow.list(
				...
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		stream_macros.$str25$LENGTH = SubLObjectFactory.makeString("LENGTH");
		stream_macros.$sym26$LENGTH = SubLObjectFactory.makeSymbol("LENGTH");
		stream_macros.$sym27$PUNLESS = SubLObjectFactory.makeSymbol("PUNLESS");
		stream_macros.$list28 = ConsesLow.list(CommonSymbols.ZERO_INTEGER);
		stream_macros.$sym29$MUST = SubLObjectFactory.makeSymbol("MUST");
		stream_macros.$sym30$__ = SubLObjectFactory.makeSymbol(">=");
		stream_macros.$str31$Negative_start_index__D_given_for = SubLObjectFactory
				.makeString("Negative start index ~D given for ~S.");
		stream_macros.$sym32$__ = SubLObjectFactory.makeSymbol("<=");
		stream_macros.$str33$The_end_index__D_given_for__S_is_ = SubLObjectFactory
				.makeString("The end index ~D given for ~S is greater than the length, ~D.");
		stream_macros.$str34$The_start_index__D_given_for__S_i = SubLObjectFactory
				.makeString("The start index ~D given for ~S is greater than the end index ~D.");
		stream_macros.$list35 = ConsesLow.list(SubLObjectFactory.makeSymbol("STREAM"),
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		stream_macros.$str36$LOCK_VAR = SubLObjectFactory.makeString("LOCK-VAR");
		stream_macros.$sym37$STREAM_LOCK = SubLObjectFactory.makeSymbol("STREAM-LOCK");
		stream_macros.$sym38$PIF = SubLObjectFactory.makeSymbol("PIF");
		stream_macros.$sym39$LOCK_P = SubLObjectFactory.makeSymbol("LOCK-P");
		stream_macros.$sym40$WITH_LOCK_HELD = SubLObjectFactory.makeSymbol("WITH-LOCK-HELD");
		stream_macros.$list41 = ConsesLow.list(SubLObjectFactory.makeSymbol("STREAM"));
		stream_macros.$sym42$STREAM_STREAM_TYPE = SubLObjectFactory.makeSymbol("STREAM-STREAM-TYPE");
		stream_macros.$list43 = ConsesLow.list(SubLObjectFactory.makeKeyword("SYNONYM"));
	}
	...
	public static SubLObject with_input_from_string(SubLObject macroform, SubLObject environment) {
		...
		while (CommonSymbols.NIL != rest) {
			...
			rest = rest.rest();
			cdestructuring_bind.destructuring_bind_must_consp(rest, datum, stream_macros.$list10);
			if (CommonSymbols.NIL == conses_high.member(current_$1, stream_macros.$list11, CommonSymbols.UNPROVIDED,
		...
		SubLObject index = CommonSymbols.NIL != index_tail ? conses_high.cadr(index_tail) : CommonSymbols.NIL;
		SubLObject start_tail = cdestructuring_bind.property_list_member(stream_macros.$kw14$START, current);
		SubLObject start = CommonSymbols.NIL != start_tail ? conses_high.cadr(start_tail) : CommonSymbols.ZERO_INTEGER;
		SubLObject end_tail = cdestructuring_bind.property_list_member(stream_macros.$kw15$END, current);
		SubLObject end = CommonSymbols.NIL != end_tail ? conses_high.cadr(end_tail) : CommonSymbols.NIL;
		SubLObject body;
		current = body = temp;
		return stream_macros.with_input_from_string_internal(var, string, index, start, end, body);
	}
	...
	public static SubLObject with_open_file(SubLObject macroform, SubLObject environment) {
		...
		return ConsesLow.listS(stream_macros.$sym22$WITH_OPEN_STREAM, ConsesLow.list(stream,
				ConsesLow.listS(stream_macros.$sym23$OPEN, filespec, ConsesLow.append(keys, CommonSymbols.NIL))),
				ConsesLow.append(body, CommonSymbols.NIL));
	}
