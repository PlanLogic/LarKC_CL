...
public class compatibility extends SubLTranslatedFile {
	...
	static {
		compatibility.me = new compatibility();
		compatibility.$kw0$INPUT = SubLObjectFactory.makeKeyword("INPUT");
		compatibility.$kw1$DIRECTION = SubLObjectFactory.makeKeyword("DIRECTION");
		compatibility.$kw2$IF_DOES_NOT_EXIST = SubLObjectFactory.makeKeyword("IF-DOES-NOT-EXIST");
		compatibility.$kw3$ELEMENT_TYPE = SubLObjectFactory.makeKeyword("ELEMENT-TYPE");
		compatibility.$kw4$TEXT = SubLObjectFactory.makeKeyword("TEXT");
		compatibility.$kw5$OUTPUT = SubLObjectFactory.makeKeyword("OUTPUT");
		compatibility.$kw6$IF_EXISTS = SubLObjectFactory.makeKeyword("IF-EXISTS");
		compatibility.$kw7$NEW_VERSION = SubLObjectFactory.makeKeyword("NEW-VERSION");
		compatibility.$kw8$CREATE = SubLObjectFactory.makeKeyword("CREATE");
		compatibility.$kw9$APPEND = SubLObjectFactory.makeKeyword("APPEND");
		compatibility.$str10$_S_called_with_invalid_direction_ = SubLObjectFactory
				.makeString("~S called with invalid direction argument of ~S.");
		compatibility.$sym11$OPEN_TEXT = SubLObjectFactory.makeSymbol("OPEN-TEXT");
		compatibility.$kw12$BINARY = SubLObjectFactory.makeKeyword("BINARY");
		compatibility.$kw13$IO = SubLObjectFactory.makeKeyword("IO");
		compatibility.$str14$_S_called_with_invalid_direction_ = SubLObjectFactory
				.makeString("~S called with invalid direction argument of ~A");
		compatibility.$sym15$OPEN_BINARY = SubLObjectFactory.makeSymbol("OPEN-BINARY");
		compatibility.$list16 = ConsesLow.list(
		...
		compatibility.$str17$STREAM = SubLObjectFactory.makeString("STREAM");
		compatibility.$str18$_S_invoked_with_invalid_file_type = SubLObjectFactory
				.makeString("~S invoked with invalid file type ~S specified.");
		compatibility.$sym19$WITH_STREAMED_FILE_INTERNAL = SubLObjectFactory.makeSymbol("WITH-STREAMED-FILE-INTERNAL");
		compatibility.$sym20$CSETQ = SubLObjectFactory.makeSymbol("CSETQ");
		compatibility.$kw21$PRIVATE = SubLObjectFactory.makeKeyword("PRIVATE");
		compatibility.$sym22$ENSURE_PRIVATE_STREAM = SubLObjectFactory.makeSymbol("ENSURE-PRIVATE-STREAM");
		compatibility.$kw23$PUBLIC = SubLObjectFactory.makeKeyword("PUBLIC");
		compatibility.$str24$_S_invoked_with_invalid_access_se = SubLObjectFactory
				.makeString("~S invoked with invalid access setting ~S.");
		compatibility.$sym25$CLET = SubLObjectFactory.makeSymbol("CLET");
		compatibility.$sym26$CUNWIND_PROTECT = SubLObjectFactory.makeSymbol("CUNWIND-PROTECT");
		compatibility.$sym27$PROGN = SubLObjectFactory.makeSymbol("PROGN");
		compatibility.$sym28$PUNLESS = SubLObjectFactory.makeSymbol("PUNLESS");
		compatibility.$sym29$STREAMP = SubLObjectFactory.makeSymbol("STREAMP");
		compatibility.$sym30$ERROR = SubLObjectFactory.makeSymbol("ERROR");
		compatibility.$str31$Unable_to_open__S = SubLObjectFactory.makeString("Unable to open ~S");
		compatibility.$sym32$PWHEN = SubLObjectFactory.makeSymbol("PWHEN");
		compatibility.$sym33$CLOSE = SubLObjectFactory.makeSymbol("CLOSE");
		compatibility.$list34 = ConsesLow.list(
				ConsesLow.list(SubLObjectFactory.makeSymbol("STREAM"), SubLObjectFactory.makeSymbol("FILENAME"),
						SubLObjectFactory.makeSymbol("DIRECTION")),
				SubLObjectFactory.makeSymbol("&BODY"), SubLObjectFactory.makeSymbol("BODY"));
		compatibility.$list35 = ConsesLow.list(SubLObjectFactory.makeKeyword("PUBLIC"),
				SubLObjectFactory.makeKeyword("TEXT"));
		compatibility.$list36 = ConsesLow.list(SubLObjectFactory.makeKeyword("PRIVATE"),
				SubLObjectFactory.makeKeyword("TEXT"));
		compatibility.$list37 = ConsesLow.list(SubLObjectFactory.makeKeyword("PUBLIC"),
				SubLObjectFactory.makeKeyword("BINARY"));
		compatibility.$list38 = ConsesLow.list(SubLObjectFactory.makeKeyword("PRIVATE"),
				SubLObjectFactory.makeKeyword("BINARY"));
	}
