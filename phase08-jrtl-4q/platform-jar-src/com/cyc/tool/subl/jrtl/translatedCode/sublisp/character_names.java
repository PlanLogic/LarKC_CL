...
public class character_names extends SubLTranslatedFile {
	...
	static {
		character_names.me = new character_names();
		character_names.$character_names_table$ = null;
		character_names.$name_character_table$ = null;
		character_names.$int0$256 = SubLObjectFactory.makeInteger(256);
		character_names.$str1$Null = SubLObjectFactory.makeString("Null");
		character_names.$str2$NUL = SubLObjectFactory.makeString("NUL");
		character_names.$str3$Control_a = SubLObjectFactory.makeString("Control-a");
		character_names.$str4$c_a = SubLObjectFactory.makeString("c-a");
		character_names.$str5$Control_b = SubLObjectFactory.makeString("Control-b");
		character_names.$str6$c_b = SubLObjectFactory.makeString("c-b");
		character_names.$str7$Control_c = SubLObjectFactory.makeString("Control-c");
		character_names.$str8$c_c = SubLObjectFactory.makeString("c-c");
		character_names.$str9$Control_d = SubLObjectFactory.makeString("Control-d");
		character_names.$str10$c_d = SubLObjectFactory.makeString("c-d");
		character_names.$str11$Control_e = SubLObjectFactory.makeString("Control-e");
		character_names.$str12$c_e = SubLObjectFactory.makeString("c-e");
		character_names.$str13$Control_f = SubLObjectFactory.makeString("Control-f");
		character_names.$str14$c_f = SubLObjectFactory.makeString("c-f");
		character_names.$str15$Bell = SubLObjectFactory.makeString("Bell");
		character_names.$str16$BEL = SubLObjectFactory.makeString("BEL");
		character_names.$str17$Backspace = SubLObjectFactory.makeString("Backspace");
		character_names.$str18$BS = SubLObjectFactory.makeString("BS");
		character_names.$str19$Tab = SubLObjectFactory.makeString("Tab");
		character_names.$str20$HT = SubLObjectFactory.makeString("HT");
		character_names.$str21$Newline = SubLObjectFactory.makeString("Newline");
		character_names.$str22$Linefeed = SubLObjectFactory.makeString("Linefeed");
		character_names.$str23$Vertical_Tab = SubLObjectFactory.makeString("Vertical-Tab");
		character_names.$str24$VT = SubLObjectFactory.makeString("VT");
		character_names.$str25$Page = SubLObjectFactory.makeString("Page");
		character_names.$str26$FF = SubLObjectFactory.makeString("FF");
		character_names.$str27$Return = SubLObjectFactory.makeString("Return");
		character_names.$str28$CR = SubLObjectFactory.makeString("CR");
		character_names.$str29$Control_n = SubLObjectFactory.makeString("Control-n");
		character_names.$str30$c_n = SubLObjectFactory.makeString("c-n");
		character_names.$str31$Control_o = SubLObjectFactory.makeString("Control-o");
		character_names.$str32$c_o = SubLObjectFactory.makeString("c-o");
		character_names.$str33$Control_p = SubLObjectFactory.makeString("Control-p");
		character_names.$str34$c_p = SubLObjectFactory.makeString("c-p");
		character_names.$str35$Control_q = SubLObjectFactory.makeString("Control-q");
		character_names.$str36$c_q = SubLObjectFactory.makeString("c-q");
		character_names.$str37$Control_r = SubLObjectFactory.makeString("Control-r");
		character_names.$str38$c_r = SubLObjectFactory.makeString("c-r");
		character_names.$str39$Control_s = SubLObjectFactory.makeString("Control-s");
		character_names.$str40$c_s = SubLObjectFactory.makeString("c-s");
		character_names.$str41$Control_t = SubLObjectFactory.makeString("Control-t");
		character_names.$str42$c_t = SubLObjectFactory.makeString("c-t");
		character_names.$int43$21 = SubLObjectFactory.makeInteger(21);
		character_names.$str44$Control_u = SubLObjectFactory.makeString("Control-u");
		character_names.$str45$c_u = SubLObjectFactory.makeString("c-u");
		character_names.$int46$22 = SubLObjectFactory.makeInteger(22);
		character_names.$str47$Control_v = SubLObjectFactory.makeString("Control-v");
		character_names.$str48$c_v = SubLObjectFactory.makeString("c-v");
		character_names.$int49$23 = SubLObjectFactory.makeInteger(23);
		character_names.$str50$Control_w = SubLObjectFactory.makeString("Control-w");
		character_names.$str51$c_w = SubLObjectFactory.makeString("c-w");
		character_names.$int52$24 = SubLObjectFactory.makeInteger(24);
		character_names.$str53$Control_x = SubLObjectFactory.makeString("Control-x");
		character_names.$str54$c_x = SubLObjectFactory.makeString("c-x");
		character_names.$int55$25 = SubLObjectFactory.makeInteger(25);
		character_names.$str56$Control_y = SubLObjectFactory.makeString("Control-y");
		character_names.$str57$c_y = SubLObjectFactory.makeString("c-y");
		character_names.$int58$26 = SubLObjectFactory.makeInteger(26);
		character_names.$str59$Control_z = SubLObjectFactory.makeString("Control-z");
		character_names.$str60$c_z = SubLObjectFactory.makeString("c-z");
		character_names.$int61$27 = SubLObjectFactory.makeInteger(27);
		character_names.$str62$Escape = SubLObjectFactory.makeString("Escape");
		character_names.$str63$ESC = SubLObjectFactory.makeString("ESC");
		character_names.$int64$28 = SubLObjectFactory.makeInteger(28);
		character_names.$str65$Control__ = SubLObjectFactory.makeString("Control-\\");
		character_names.$str66$c__ = SubLObjectFactory.makeString("c-\\");
		character_names.$int67$29 = SubLObjectFactory.makeInteger(29);
		character_names.$str68$Control__ = SubLObjectFactory.makeString("Control-]");
		character_names.$str69$c__ = SubLObjectFactory.makeString("c-]");
		character_names.$int70$30 = SubLObjectFactory.makeInteger(30);
		character_names.$str71$Control__ = SubLObjectFactory.makeString("Control-^");
		character_names.$str72$c__ = SubLObjectFactory.makeString("c-^");
		character_names.$int73$31 = SubLObjectFactory.makeInteger(31);
		character_names.$str74$Control__ = SubLObjectFactory.makeString("Control-_");
		character_names.$str75$c__ = SubLObjectFactory.makeString("c-_");
		character_names.$int76$32 = SubLObjectFactory.makeInteger(32);
		character_names.$str77$Space = SubLObjectFactory.makeString("Space");
		character_names.$str78$SP = SubLObjectFactory.makeString("SP");
		character_names.$int79$127 = SubLObjectFactory.makeInteger(127);
		character_names.$str80$Rubout = SubLObjectFactory.makeString("Rubout");
		character_names.$str81$DEL = SubLObjectFactory.makeString("DEL");
		character_names.$int82$128 = SubLObjectFactory.makeInteger(128);
		character_names.$str83$Meta_Null = SubLObjectFactory.makeString("Meta-Null");
		character_names.$str84$m_Null = SubLObjectFactory.makeString("m-Null");
		character_names.$int85$129 = SubLObjectFactory.makeInteger(129);
		character_names.$str86$Control_Meta_a = SubLObjectFactory.makeString("Control-Meta-a");
		character_names.$str87$c_m_a = SubLObjectFactory.makeString("c-m-a");
		character_names.$int88$130 = SubLObjectFactory.makeInteger(130);
		character_names.$str89$Control_Meta_b = SubLObjectFactory.makeString("Control-Meta-b");
		character_names.$str90$c_m_b = SubLObjectFactory.makeString("c-m-b");
		character_names.$int91$131 = SubLObjectFactory.makeInteger(131);
		character_names.$str92$Control_Meta_c = SubLObjectFactory.makeString("Control-Meta-c");
		character_names.$str93$c_m_c = SubLObjectFactory.makeString("c-m-c");
		character_names.$int94$132 = SubLObjectFactory.makeInteger(132);
		character_names.$str95$Control_Meta_d = SubLObjectFactory.makeString("Control-Meta-d");
		character_names.$str96$c_m_d = SubLObjectFactory.makeString("c-m-d");
		character_names.$int97$133 = SubLObjectFactory.makeInteger(133);
		character_names.$str98$Control_Meta_e = SubLObjectFactory.makeString("Control-Meta-e");
		character_names.$str99$c_m_e = SubLObjectFactory.makeString("c-m-e");
		character_names.$int100$134 = SubLObjectFactory.makeInteger(134);
		character_names.$str101$Control_Meta_f = SubLObjectFactory.makeString("Control-Meta-f");
		character_names.$str102$c_m_f = SubLObjectFactory.makeString("c-m-f");
		character_names.$int103$135 = SubLObjectFactory.makeInteger(135);
		character_names.$str104$Meta_Bell = SubLObjectFactory.makeString("Meta-Bell");
		character_names.$str105$m_Bell = SubLObjectFactory.makeString("m-Bell");
		character_names.$int106$136 = SubLObjectFactory.makeInteger(136);
		character_names.$str107$Meta_Backspace = SubLObjectFactory.makeString("Meta-Backspace");
		character_names.$str108$m_Backspace = SubLObjectFactory.makeString("m-Backspace");
		character_names.$int109$137 = SubLObjectFactory.makeInteger(137);
		character_names.$str110$Meta_Tab = SubLObjectFactory.makeString("Meta-Tab");
		character_names.$str111$m_Tab = SubLObjectFactory.makeString("m-Tab");
		character_names.$int112$138 = SubLObjectFactory.makeInteger(138);
		character_names.$str113$Meta_Newline = SubLObjectFactory.makeString("Meta-Newline");
		character_names.$str114$m_Newline = SubLObjectFactory.makeString("m-Newline");
		character_names.$int115$139 = SubLObjectFactory.makeInteger(139);
		character_names.$str116$Meta_Vertical_Tab = SubLObjectFactory.makeString("Meta-Vertical-Tab");
		character_names.$str117$m_Vertical_Tab = SubLObjectFactory.makeString("m-Vertical-Tab");
		character_names.$int118$140 = SubLObjectFactory.makeInteger(140);
		character_names.$str119$Meta_Page = SubLObjectFactory.makeString("Meta-Page");
		character_names.$str120$m_Page = SubLObjectFactory.makeString("m-Page");
		character_names.$int121$141 = SubLObjectFactory.makeInteger(141);
		character_names.$str122$Meta_Return = SubLObjectFactory.makeString("Meta-Return");
		character_names.$str123$m_Return = SubLObjectFactory.makeString("m-Return");
		character_names.$int124$142 = SubLObjectFactory.makeInteger(142);
		character_names.$str125$Control_Meta_n = SubLObjectFactory.makeString("Control-Meta-n");
		character_names.$str126$c_m_n = SubLObjectFactory.makeString("c-m-n");
		character_names.$int127$143 = SubLObjectFactory.makeInteger(143);
		character_names.$str128$Control_Meta_o = SubLObjectFactory.makeString("Control-Meta-o");
		character_names.$str129$c_m_o = SubLObjectFactory.makeString("c-m-o");
		character_names.$int130$144 = SubLObjectFactory.makeInteger(144);
		character_names.$str131$Control_Meta_p = SubLObjectFactory.makeString("Control-Meta-p");
		character_names.$str132$c_m_p = SubLObjectFactory.makeString("c-m-p");
		character_names.$int133$145 = SubLObjectFactory.makeInteger(145);
		character_names.$str134$Control_Meta_q = SubLObjectFactory.makeString("Control-Meta-q");
		character_names.$str135$c_m_q = SubLObjectFactory.makeString("c-m-q");
		character_names.$int136$146 = SubLObjectFactory.makeInteger(146);
		character_names.$str137$Control_Meta_r = SubLObjectFactory.makeString("Control-Meta-r");
		character_names.$str138$c_m_r = SubLObjectFactory.makeString("c-m-r");
		character_names.$int139$147 = SubLObjectFactory.makeInteger(147);
		character_names.$str140$Control_Meta_s = SubLObjectFactory.makeString("Control-Meta-s");
		character_names.$str141$c_m_s = SubLObjectFactory.makeString("c-m-s");
		character_names.$int142$148 = SubLObjectFactory.makeInteger(148);
		character_names.$str143$Control_Meta_t = SubLObjectFactory.makeString("Control-Meta-t");
		character_names.$str144$c_m_t = SubLObjectFactory.makeString("c-m-t");
		character_names.$int145$149 = SubLObjectFactory.makeInteger(149);
		character_names.$str146$Control_Meta_u = SubLObjectFactory.makeString("Control-Meta-u");
		character_names.$str147$c_m_u = SubLObjectFactory.makeString("c-m-u");
		character_names.$int148$150 = SubLObjectFactory.makeInteger(150);
		character_names.$str149$Control_Meta_v = SubLObjectFactory.makeString("Control-Meta-v");
		character_names.$str150$c_m_v = SubLObjectFactory.makeString("c-m-v");
		character_names.$int151$151 = SubLObjectFactory.makeInteger(151);
		character_names.$str152$Control_Meta_w = SubLObjectFactory.makeString("Control-Meta-w");
		character_names.$str153$c_m_w = SubLObjectFactory.makeString("c-m-w");
		character_names.$int154$152 = SubLObjectFactory.makeInteger(152);
		character_names.$str155$Control_Meta_x = SubLObjectFactory.makeString("Control-Meta-x");
		character_names.$str156$c_m_x = SubLObjectFactory.makeString("c-m-x");
		character_names.$int157$153 = SubLObjectFactory.makeInteger(153);
		character_names.$str158$Control_Meta_y = SubLObjectFactory.makeString("Control-Meta-y");
		character_names.$str159$c_m_y = SubLObjectFactory.makeString("c-m-y");
		character_names.$int160$154 = SubLObjectFactory.makeInteger(154);
		character_names.$str161$Control_Meta_z = SubLObjectFactory.makeString("Control-Meta-z");
		character_names.$str162$c_m_z = SubLObjectFactory.makeString("c-m-z");
		character_names.$int163$155 = SubLObjectFactory.makeInteger(155);
		character_names.$str164$Meta_Escape = SubLObjectFactory.makeString("Meta-Escape");
		character_names.$str165$m_Escape = SubLObjectFactory.makeString("m-Escape");
		character_names.$int166$156 = SubLObjectFactory.makeInteger(156);
		character_names.$str167$Control_Meta__ = SubLObjectFactory.makeString("Control-Meta-\\");
		character_names.$str168$c_m__ = SubLObjectFactory.makeString("c-m-\\");
		character_names.$int169$157 = SubLObjectFactory.makeInteger(157);
		character_names.$str170$Control_Meta__ = SubLObjectFactory.makeString("Control-Meta-]");
		character_names.$str171$c_m__ = SubLObjectFactory.makeString("c-m-]");
		character_names.$int172$158 = SubLObjectFactory.makeInteger(158);
		character_names.$str173$Control_Meta__ = SubLObjectFactory.makeString("Control-Meta-^");
		character_names.$str174$c_m__ = SubLObjectFactory.makeString("c-m-^");
		character_names.$int175$159 = SubLObjectFactory.makeInteger(159);
		character_names.$str176$Control_Meta__ = SubLObjectFactory.makeString("Control-Meta-_");
		character_names.$str177$c_m__ = SubLObjectFactory.makeString("c-m-_");
		character_names.$int178$160 = SubLObjectFactory.makeInteger(160);
		character_names.$str179$Meta_Space = SubLObjectFactory.makeString("Meta-Space");
		character_names.$str180$m_Space = SubLObjectFactory.makeString("m-Space");
		character_names.$int181$161 = SubLObjectFactory.makeInteger(161);
		character_names.$str182$Meta__ = SubLObjectFactory.makeString("Meta-!");
		character_names.$str183$m__ = SubLObjectFactory.makeString("m-!");
		character_names.$int184$162 = SubLObjectFactory.makeInteger(162);
		character_names.$str185$Meta__ = SubLObjectFactory.makeString("Meta-\"");
		character_names.$str186$m__ = SubLObjectFactory.makeString("m-\"");
		character_names.$int187$163 = SubLObjectFactory.makeInteger(163);
		character_names.$str188$Meta__ = SubLObjectFactory.makeString("Meta-#");
		character_names.$str189$m__ = SubLObjectFactory.makeString("m-#");
		character_names.$int190$164 = SubLObjectFactory.makeInteger(164);
		character_names.$str191$Meta__ = SubLObjectFactory.makeString("Meta-$");
		character_names.$str192$m__ = SubLObjectFactory.makeString("m-$");
		character_names.$int193$165 = SubLObjectFactory.makeInteger(165);
		character_names.$str194$Meta__ = SubLObjectFactory.makeString("Meta-%");
		character_names.$str195$m__ = SubLObjectFactory.makeString("m-%");
		character_names.$int196$166 = SubLObjectFactory.makeInteger(166);
		character_names.$str197$Meta__ = SubLObjectFactory.makeString("Meta-&");
		character_names.$str198$m__ = SubLObjectFactory.makeString("m-&");
		character_names.$int199$167 = SubLObjectFactory.makeInteger(167);
		character_names.$str200$Meta__ = SubLObjectFactory.makeString("Meta-'");
		character_names.$str201$m__ = SubLObjectFactory.makeString("m-'");
		character_names.$int202$168 = SubLObjectFactory.makeInteger(168);
		character_names.$str203$Meta__ = SubLObjectFactory.makeString("Meta-(");
		character_names.$str204$m__ = SubLObjectFactory.makeString("m-(");
		character_names.$int205$169 = SubLObjectFactory.makeInteger(169);
		character_names.$str206$Meta__ = SubLObjectFactory.makeString("Meta-)");
		character_names.$str207$m__ = SubLObjectFactory.makeString("m-)");
		character_names.$int208$170 = SubLObjectFactory.makeInteger(170);
		character_names.$str209$Meta__ = SubLObjectFactory.makeString("Meta-*");
		character_names.$str210$m__ = SubLObjectFactory.makeString("m-*");
		character_names.$int211$171 = SubLObjectFactory.makeInteger(171);
		character_names.$str212$Meta__ = SubLObjectFactory.makeString("Meta-+");
		character_names.$str213$m__ = SubLObjectFactory.makeString("m-+");
		character_names.$int214$172 = SubLObjectFactory.makeInteger(172);
		character_names.$str215$Meta__ = SubLObjectFactory.makeString("Meta-,");
		character_names.$str216$m__ = SubLObjectFactory.makeString("m-,");
		character_names.$int217$173 = SubLObjectFactory.makeInteger(173);
		character_names.$str218$Meta__ = SubLObjectFactory.makeString("Meta--");
		character_names.$str219$m__ = SubLObjectFactory.makeString("m--");
		character_names.$int220$174 = SubLObjectFactory.makeInteger(174);
		character_names.$str221$Meta__ = SubLObjectFactory.makeString("Meta-.");
		character_names.$str222$m__ = SubLObjectFactory.makeString("m-.");
		character_names.$int223$175 = SubLObjectFactory.makeInteger(175);
		character_names.$str224$Meta__ = SubLObjectFactory.makeString("Meta-/");
		character_names.$str225$m__ = SubLObjectFactory.makeString("m-/");
		character_names.$int226$176 = SubLObjectFactory.makeInteger(176);
		character_names.$str227$Meta_0 = SubLObjectFactory.makeString("Meta-0");
		character_names.$str228$m_0 = SubLObjectFactory.makeString("m-0");
		character_names.$int229$177 = SubLObjectFactory.makeInteger(177);
		character_names.$str230$Meta_1 = SubLObjectFactory.makeString("Meta-1");
		character_names.$str231$m_1 = SubLObjectFactory.makeString("m-1");
		character_names.$int232$178 = SubLObjectFactory.makeInteger(178);
		character_names.$str233$Meta_2 = SubLObjectFactory.makeString("Meta-2");
		character_names.$str234$m_2 = SubLObjectFactory.makeString("m-2");
		character_names.$int235$179 = SubLObjectFactory.makeInteger(179);
		character_names.$str236$Meta_3 = SubLObjectFactory.makeString("Meta-3");
		character_names.$str237$m_3 = SubLObjectFactory.makeString("m-3");
		character_names.$int238$180 = SubLObjectFactory.makeInteger(180);
		character_names.$str239$Meta_4 = SubLObjectFactory.makeString("Meta-4");
		character_names.$str240$m_4 = SubLObjectFactory.makeString("m-4");
		character_names.$int241$181 = SubLObjectFactory.makeInteger(181);
		character_names.$str242$Meta_5 = SubLObjectFactory.makeString("Meta-5");
		character_names.$str243$m_5 = SubLObjectFactory.makeString("m-5");
		character_names.$int244$182 = SubLObjectFactory.makeInteger(182);
		character_names.$str245$Meta_6 = SubLObjectFactory.makeString("Meta-6");
		character_names.$str246$m_6 = SubLObjectFactory.makeString("m-6");
		character_names.$int247$183 = SubLObjectFactory.makeInteger(183);
		character_names.$str248$Meta_7 = SubLObjectFactory.makeString("Meta-7");
		character_names.$str249$m_7 = SubLObjectFactory.makeString("m-7");
		character_names.$int250$184 = SubLObjectFactory.makeInteger(184);
		character_names.$str251$Meta_8 = SubLObjectFactory.makeString("Meta-8");
		character_names.$str252$m_8 = SubLObjectFactory.makeString("m-8");
		character_names.$int253$185 = SubLObjectFactory.makeInteger(185);
		character_names.$str254$Meta_9 = SubLObjectFactory.makeString("Meta-9");
		character_names.$str255$m_9 = SubLObjectFactory.makeString("m-9");
		character_names.$int256$186 = SubLObjectFactory.makeInteger(186);
		character_names.$str257$Meta__ = SubLObjectFactory.makeString("Meta-:");
		character_names.$str258$m__ = SubLObjectFactory.makeString("m-:");
		character_names.$int259$187 = SubLObjectFactory.makeInteger(187);
		character_names.$str260$Meta__ = SubLObjectFactory.makeString("Meta-;");
		character_names.$str261$m__ = SubLObjectFactory.makeString("m-;");
		character_names.$int262$188 = SubLObjectFactory.makeInteger(188);
		character_names.$str263$Meta__ = SubLObjectFactory.makeString("Meta-<");
		character_names.$str264$m__ = SubLObjectFactory.makeString("m-<");
		character_names.$int265$189 = SubLObjectFactory.makeInteger(189);
		character_names.$str266$Meta__ = SubLObjectFactory.makeString("Meta-=");
		character_names.$str267$m__ = SubLObjectFactory.makeString("m-=");
		character_names.$int268$190 = SubLObjectFactory.makeInteger(190);
		character_names.$str269$Meta__ = SubLObjectFactory.makeString("Meta->");
		character_names.$str270$m__ = SubLObjectFactory.makeString("m->");
		character_names.$int271$191 = SubLObjectFactory.makeInteger(191);
		character_names.$str272$Meta__ = SubLObjectFactory.makeString("Meta-?");
		character_names.$str273$m__ = SubLObjectFactory.makeString("m-?");
		character_names.$int274$192 = SubLObjectFactory.makeInteger(192);
		character_names.$str275$Meta__ = SubLObjectFactory.makeString("Meta-@");
		character_names.$str276$m__ = SubLObjectFactory.makeString("m-@");
		character_names.$int277$193 = SubLObjectFactory.makeInteger(193);
		character_names.$str278$Meta_A = SubLObjectFactory.makeString("Meta-A");
		character_names.$str279$m_A = SubLObjectFactory.makeString("m-A");
		character_names.$int280$194 = SubLObjectFactory.makeInteger(194);
		character_names.$str281$Meta_B = SubLObjectFactory.makeString("Meta-B");
		character_names.$str282$m_B = SubLObjectFactory.makeString("m-B");
		character_names.$int283$195 = SubLObjectFactory.makeInteger(195);
		character_names.$str284$Meta_C = SubLObjectFactory.makeString("Meta-C");
		character_names.$str285$m_C = SubLObjectFactory.makeString("m-C");
		character_names.$int286$196 = SubLObjectFactory.makeInteger(196);
		character_names.$str287$Meta_D = SubLObjectFactory.makeString("Meta-D");
		character_names.$str288$m_D = SubLObjectFactory.makeString("m-D");
		character_names.$int289$197 = SubLObjectFactory.makeInteger(197);
		character_names.$str290$Meta_E = SubLObjectFactory.makeString("Meta-E");
		character_names.$str291$m_E = SubLObjectFactory.makeString("m-E");
		character_names.$int292$198 = SubLObjectFactory.makeInteger(198);
		character_names.$str293$Meta_F = SubLObjectFactory.makeString("Meta-F");
		character_names.$str294$m_F = SubLObjectFactory.makeString("m-F");
		character_names.$int295$199 = SubLObjectFactory.makeInteger(199);
		character_names.$str296$Meta_G = SubLObjectFactory.makeString("Meta-G");
		character_names.$str297$m_G = SubLObjectFactory.makeString("m-G");
		character_names.$int298$200 = SubLObjectFactory.makeInteger(200);
		character_names.$str299$Meta_H = SubLObjectFactory.makeString("Meta-H");
		character_names.$str300$m_H = SubLObjectFactory.makeString("m-H");
		character_names.$int301$201 = SubLObjectFactory.makeInteger(201);
		character_names.$str302$Meta_I = SubLObjectFactory.makeString("Meta-I");
		character_names.$str303$m_I = SubLObjectFactory.makeString("m-I");
		character_names.$int304$202 = SubLObjectFactory.makeInteger(202);
		character_names.$str305$Meta_J = SubLObjectFactory.makeString("Meta-J");
		character_names.$str306$m_J = SubLObjectFactory.makeString("m-J");
		character_names.$int307$203 = SubLObjectFactory.makeInteger(203);
		character_names.$str308$Meta_K = SubLObjectFactory.makeString("Meta-K");
		character_names.$str309$m_K = SubLObjectFactory.makeString("m-K");
		character_names.$int310$204 = SubLObjectFactory.makeInteger(204);
		character_names.$str311$Meta_L = SubLObjectFactory.makeString("Meta-L");
		character_names.$str312$m_L = SubLObjectFactory.makeString("m-L");
		character_names.$int313$205 = SubLObjectFactory.makeInteger(205);
		character_names.$str314$Meta_M = SubLObjectFactory.makeString("Meta-M");
		character_names.$str315$m_M = SubLObjectFactory.makeString("m-M");
		character_names.$int316$206 = SubLObjectFactory.makeInteger(206);
		character_names.$str317$Meta_N = SubLObjectFactory.makeString("Meta-N");
		character_names.$str318$m_N = SubLObjectFactory.makeString("m-N");
		character_names.$int319$207 = SubLObjectFactory.makeInteger(207);
		character_names.$str320$Meta_O = SubLObjectFactory.makeString("Meta-O");
		character_names.$str321$m_O = SubLObjectFactory.makeString("m-O");
		character_names.$int322$208 = SubLObjectFactory.makeInteger(208);
		character_names.$str323$Meta_P = SubLObjectFactory.makeString("Meta-P");
		character_names.$str324$m_P = SubLObjectFactory.makeString("m-P");
		character_names.$int325$209 = SubLObjectFactory.makeInteger(209);
		character_names.$str326$Meta_Q = SubLObjectFactory.makeString("Meta-Q");
		character_names.$str327$m_Q = SubLObjectFactory.makeString("m-Q");
		character_names.$int328$210 = SubLObjectFactory.makeInteger(210);
		character_names.$str329$Meta_R = SubLObjectFactory.makeString("Meta-R");
		character_names.$str330$m_R = SubLObjectFactory.makeString("m-R");
		character_names.$int331$211 = SubLObjectFactory.makeInteger(211);
		character_names.$str332$Meta_S = SubLObjectFactory.makeString("Meta-S");
		character_names.$str333$m_S = SubLObjectFactory.makeString("m-S");
		character_names.$int334$212 = SubLObjectFactory.makeInteger(212);
		character_names.$str335$Meta_T = SubLObjectFactory.makeString("Meta-T");
		character_names.$str336$m_T = SubLObjectFactory.makeString("m-T");
		character_names.$int337$213 = SubLObjectFactory.makeInteger(213);
		character_names.$str338$Meta_U = SubLObjectFactory.makeString("Meta-U");
		character_names.$str339$m_U = SubLObjectFactory.makeString("m-U");
		character_names.$int340$214 = SubLObjectFactory.makeInteger(214);
		character_names.$str341$Meta_V = SubLObjectFactory.makeString("Meta-V");
		character_names.$str342$m_V = SubLObjectFactory.makeString("m-V");
		character_names.$int343$215 = SubLObjectFactory.makeInteger(215);
		character_names.$str344$Meta_W = SubLObjectFactory.makeString("Meta-W");
		character_names.$str345$m_W = SubLObjectFactory.makeString("m-W");
		character_names.$int346$216 = SubLObjectFactory.makeInteger(216);
		character_names.$str347$Meta_X = SubLObjectFactory.makeString("Meta-X");
		character_names.$str348$m_X = SubLObjectFactory.makeString("m-X");
		character_names.$int349$217 = SubLObjectFactory.makeInteger(217);
		character_names.$str350$Meta_Y = SubLObjectFactory.makeString("Meta-Y");
		character_names.$str351$m_Y = SubLObjectFactory.makeString("m-Y");
		character_names.$int352$218 = SubLObjectFactory.makeInteger(218);
		character_names.$str353$Meta_Z = SubLObjectFactory.makeString("Meta-Z");
		character_names.$str354$m_Z = SubLObjectFactory.makeString("m-Z");
		character_names.$int355$219 = SubLObjectFactory.makeInteger(219);
		character_names.$str356$Meta__ = SubLObjectFactory.makeString("Meta-[");
		character_names.$str357$m__ = SubLObjectFactory.makeString("m-[");
		character_names.$int358$220 = SubLObjectFactory.makeInteger(220);
		character_names.$str359$Meta__ = SubLObjectFactory.makeString("Meta-\\");
		character_names.$str360$m__ = SubLObjectFactory.makeString("m-\\");
		character_names.$int361$221 = SubLObjectFactory.makeInteger(221);
		character_names.$str362$Meta__ = SubLObjectFactory.makeString("Meta-]");
		character_names.$str363$m__ = SubLObjectFactory.makeString("m-]");
		character_names.$int364$222 = SubLObjectFactory.makeInteger(222);
		character_names.$str365$Meta__ = SubLObjectFactory.makeString("Meta-^");
		character_names.$str366$m__ = SubLObjectFactory.makeString("m-^");
		character_names.$int367$223 = SubLObjectFactory.makeInteger(223);
		character_names.$str368$Meta__ = SubLObjectFactory.makeString("Meta-_");
		character_names.$str369$m__ = SubLObjectFactory.makeString("m-_");
		character_names.$int370$224 = SubLObjectFactory.makeInteger(224);
		character_names.$str371$Meta__ = SubLObjectFactory.makeString("Meta-`");
		character_names.$str372$m__ = SubLObjectFactory.makeString("m-`");
		character_names.$int373$225 = SubLObjectFactory.makeInteger(225);
		character_names.$str374$Meta_a = SubLObjectFactory.makeString("Meta-a");
		character_names.$str375$m_a = SubLObjectFactory.makeString("m-a");
		character_names.$int376$226 = SubLObjectFactory.makeInteger(226);
		character_names.$str377$Meta_b = SubLObjectFactory.makeString("Meta-b");
		character_names.$str378$m_b = SubLObjectFactory.makeString("m-b");
		character_names.$int379$227 = SubLObjectFactory.makeInteger(227);
		character_names.$str380$Meta_c = SubLObjectFactory.makeString("Meta-c");
		character_names.$str381$m_c = SubLObjectFactory.makeString("m-c");
		character_names.$int382$228 = SubLObjectFactory.makeInteger(228);
		character_names.$str383$Meta_d = SubLObjectFactory.makeString("Meta-d");
		character_names.$str384$m_d = SubLObjectFactory.makeString("m-d");
		character_names.$int385$229 = SubLObjectFactory.makeInteger(229);
		character_names.$str386$Meta_e = SubLObjectFactory.makeString("Meta-e");
		character_names.$str387$m_e = SubLObjectFactory.makeString("m-e");
		character_names.$int388$230 = SubLObjectFactory.makeInteger(230);
		character_names.$str389$Meta_f = SubLObjectFactory.makeString("Meta-f");
		character_names.$str390$m_f = SubLObjectFactory.makeString("m-f");
		character_names.$int391$231 = SubLObjectFactory.makeInteger(231);
		character_names.$str392$Meta_g = SubLObjectFactory.makeString("Meta-g");
		character_names.$str393$m_g = SubLObjectFactory.makeString("m-g");
		character_names.$int394$232 = SubLObjectFactory.makeInteger(232);
		character_names.$str395$Meta_h = SubLObjectFactory.makeString("Meta-h");
		character_names.$str396$m_h = SubLObjectFactory.makeString("m-h");
		character_names.$int397$233 = SubLObjectFactory.makeInteger(233);
		character_names.$str398$Meta_i = SubLObjectFactory.makeString("Meta-i");
		character_names.$str399$m_i = SubLObjectFactory.makeString("m-i");
		character_names.$int400$234 = SubLObjectFactory.makeInteger(234);
		character_names.$str401$Meta_j = SubLObjectFactory.makeString("Meta-j");
		character_names.$str402$m_j = SubLObjectFactory.makeString("m-j");
		character_names.$int403$235 = SubLObjectFactory.makeInteger(235);
		character_names.$str404$Meta_k = SubLObjectFactory.makeString("Meta-k");
		character_names.$str405$m_k = SubLObjectFactory.makeString("m-k");
		character_names.$int406$236 = SubLObjectFactory.makeInteger(236);
		character_names.$str407$Meta_l = SubLObjectFactory.makeString("Meta-l");
		character_names.$str408$m_l = SubLObjectFactory.makeString("m-l");
		character_names.$int409$237 = SubLObjectFactory.makeInteger(237);
		character_names.$str410$Meta_m = SubLObjectFactory.makeString("Meta-m");
		character_names.$str411$m_m = SubLObjectFactory.makeString("m-m");
		character_names.$int412$238 = SubLObjectFactory.makeInteger(238);
		character_names.$str413$Meta_n = SubLObjectFactory.makeString("Meta-n");
		character_names.$str414$m_n = SubLObjectFactory.makeString("m-n");
		character_names.$int415$239 = SubLObjectFactory.makeInteger(239);
		character_names.$str416$Meta_o = SubLObjectFactory.makeString("Meta-o");
		character_names.$str417$m_o = SubLObjectFactory.makeString("m-o");
		character_names.$int418$240 = SubLObjectFactory.makeInteger(240);
		character_names.$str419$Meta_p = SubLObjectFactory.makeString("Meta-p");
		character_names.$str420$m_p = SubLObjectFactory.makeString("m-p");
		character_names.$int421$241 = SubLObjectFactory.makeInteger(241);
		character_names.$str422$Meta_q = SubLObjectFactory.makeString("Meta-q");
		character_names.$str423$m_q = SubLObjectFactory.makeString("m-q");
		character_names.$int424$242 = SubLObjectFactory.makeInteger(242);
		character_names.$str425$Meta_r = SubLObjectFactory.makeString("Meta-r");
		character_names.$str426$m_r = SubLObjectFactory.makeString("m-r");
		character_names.$int427$243 = SubLObjectFactory.makeInteger(243);
		character_names.$str428$Meta_s = SubLObjectFactory.makeString("Meta-s");
		character_names.$str429$m_s = SubLObjectFactory.makeString("m-s");
		character_names.$int430$244 = SubLObjectFactory.makeInteger(244);
		character_names.$str431$Meta_t = SubLObjectFactory.makeString("Meta-t");
		character_names.$str432$m_t = SubLObjectFactory.makeString("m-t");
		character_names.$int433$245 = SubLObjectFactory.makeInteger(245);
		character_names.$str434$Meta_u = SubLObjectFactory.makeString("Meta-u");
		character_names.$str435$m_u = SubLObjectFactory.makeString("m-u");
		character_names.$int436$246 = SubLObjectFactory.makeInteger(246);
		character_names.$str437$Meta_v = SubLObjectFactory.makeString("Meta-v");
		character_names.$str438$m_v = SubLObjectFactory.makeString("m-v");
		character_names.$int439$247 = SubLObjectFactory.makeInteger(247);
		character_names.$str440$Meta_w = SubLObjectFactory.makeString("Meta-w");
		character_names.$str441$m_w = SubLObjectFactory.makeString("m-w");
		character_names.$int442$248 = SubLObjectFactory.makeInteger(248);
		character_names.$str443$Meta_x = SubLObjectFactory.makeString("Meta-x");
		character_names.$str444$m_x = SubLObjectFactory.makeString("m-x");
		character_names.$int445$249 = SubLObjectFactory.makeInteger(249);
		character_names.$str446$Meta_y = SubLObjectFactory.makeString("Meta-y");
		character_names.$str447$m_y = SubLObjectFactory.makeString("m-y");
		character_names.$int448$250 = SubLObjectFactory.makeInteger(250);
		character_names.$str449$Meta_z = SubLObjectFactory.makeString("Meta-z");
		character_names.$str450$m_z = SubLObjectFactory.makeString("m-z");
		character_names.$int451$251 = SubLObjectFactory.makeInteger(251);
		character_names.$str452$Meta__ = SubLObjectFactory.makeString("Meta-{");
		character_names.$str453$m__ = SubLObjectFactory.makeString("m-{");
		character_names.$int454$252 = SubLObjectFactory.makeInteger(252);
		character_names.$str455$Meta__ = SubLObjectFactory.makeString("Meta-|");
		character_names.$str456$m__ = SubLObjectFactory.makeString("m-|");
		character_names.$int457$253 = SubLObjectFactory.makeInteger(253);
		character_names.$str458$Meta__ = SubLObjectFactory.makeString("Meta-}");
		character_names.$str459$m__ = SubLObjectFactory.makeString("m-}");
		character_names.$int460$254 = SubLObjectFactory.makeInteger(254);
		character_names.$str461$Meta__ = SubLObjectFactory.makeString("Meta-~");
		character_names.$str462$m__ = SubLObjectFactory.makeString("m-~");
		character_names.$int463$255 = SubLObjectFactory.makeInteger(255);
		character_names.$str464$Meta_Rubout = SubLObjectFactory.makeString("Meta-Rubout");
		character_names.$str465$m_Rubout = SubLObjectFactory.makeString("m-Rubout");
	}
