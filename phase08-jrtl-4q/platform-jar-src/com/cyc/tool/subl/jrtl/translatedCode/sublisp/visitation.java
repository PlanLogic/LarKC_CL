...
public class visitation extends SubLTranslatedFile {
	...
	static {
		visitation.me = new visitation();
		visitation.$visit_defstruct_object_method_table$ = null;
		visitation.$int0$256 = SubLObjectFactory.makeInteger(256);
		visitation.$str1$No_visitation_function_defined_fo = SubLObjectFactory
				.makeString("No visitation function defined for ~A.");
		visitation.$sym2$VISIT_DEFSTRUCT_OBJECT_INTEGER_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-INTEGER-METHOD");
		visitation.$sym3$VISIT_DEFSTRUCT_OBJECT_FLOAT_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-FLOAT-METHOD");
		visitation.$sym4$VISIT_DEFSTRUCT_OBJECT_STRING_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-STRING-METHOD");
		visitation.$sym5$VISIT_DEFSTRUCT_OBJECT_CHARACTER_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-CHARACTER-METHOD");
		visitation.$sym6$VISIT_DEFSTRUCT_OBJECT_SYMBOL_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-SYMBOL-METHOD");
		visitation.$sym7$VISIT_DEFSTRUCT_OBJECT_VECTOR_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-VECTOR-METHOD");
		visitation.$sym8$VISIT_DEFSTRUCT_OBJECT_CONS_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-CONS-METHOD");
		visitation.$sym9$VISIT_DEFSTRUCT_OBJECT_HASH_TABLE_METHOD = SubLObjectFactory
				.makeSymbol("VISIT-DEFSTRUCT-OBJECT-HASH-TABLE-METHOD");
		visitation.$str10$_A__A__A___A__ = SubLObjectFactory.makeString("~A ~A ~A: ~A~%");
	}
