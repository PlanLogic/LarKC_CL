...
public class subl_benchmarks implements SubLFile {
	...
	static {
		subl_benchmarks.me = new subl_benchmarks();
		subl_benchmarks.$constants = new SubLObject[7];
	...
	public static SubLObject benchmark_hash_table_exerciser(SubLObject thread_count, SubLObject throwaway_thread_n,
		...
		SubLObject i;
		for (i = CommonSymbols.NIL, i = CommonSymbols.ZERO_INTEGER; SubLNil
		...
		for (i = CommonSymbols.NIL, i = CommonSymbols.ZERO_INTEGER; SubLNil
			...
			Storage.gc_ephemeral();
			times = ConsesLow.cons(subl_benchmarks.benchmark_hash_table_exerciser_guts(thread_count, hash_table_size),
					times);
		}
	...
	public static SubLObject benchmark_hash_table_exerciser_sorter(SubLObject table) {
		...
		subl_benchmarks.benchmark_hash_table_exerciser_verify_sort(
	...
	public static SubLObject benchmark_hash_table_exerciser_verify_sort(SubLObject vector) {
		...
		SubLObject a;
		SubLObject b;
		for (i = CommonSymbols.NIL, i = CommonSymbols.ZERO_INTEGER; SubLNil.toBool(
