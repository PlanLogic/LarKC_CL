...
public class SubLFiles {
	public abstract static class VariableAccessMode {
		...
		static {
			VariableAccessMode.CONSTANT = new VariableAccessMode() {

				public SubLSymbol toSymbol() {
					return CommonSymbols.CONSTANT;
				}
			};
			VariableAccessMode.LEXICAL = new VariableAccessMode() {

				public SubLSymbol toSymbol() {
					return CommonSymbols.LEXICAL;
				}
			};
			VariableAccessMode.DYNAMIC = new VariableAccessMode() {

				public SubLSymbol toSymbol() {
					return CommonSymbols.DYNAMIC;
				}
			};
			VariableAccessMode.UNDECLARED = new VariableAccessMode() {
	...
	static {
		SubLFiles.symbolInitializationOrder = new LinkedHashSet<SubLSymbol>();
	}
