...
public class SubLDigestInputTextStream implements SubLStream, SubLInputTextStream, CommonSymbols {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		System.out.println("--  " + makeHexStringFromByteArray(digest.digest()));
		byte[] curr = { 0, 10 };
		for (int i = 0; i < 256; ++i) {
			curr[0] = (byte) i;
			System.out.print(makeHexStringFromByteArray(curr));
			System.out.print("  ");
			digest.update(curr);
			byte[] result = digest.digest();
			System.out.println(makeHexStringFromByteArray(result));
		}
	}
