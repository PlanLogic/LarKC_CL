...
public class SubLQuote extends AbstractSubLObject implements SubLObject, SubLSymbol {
	...
	public static String QUOTE_TYPE_NAME;
	static {
		QUOTE_SYMBOL = new SubLQuote("SUBLISP", "QUOTE", "'");
		BACK_QUOTE_SYMBOL = new SubLQuote("SUBLISP", "BACKQUOTE", "`");
		UNQUOTE_SYMBOL = new SubLQuote("SUBLISP", "UNQUOTE", ",");
		SPLICING_UNQUOTE_SYMBOL = new SubLQuote("SUBLISP", "SPLICING-UNQUOTE", ",@");
		FUNCTION_QUOTE_SYMBOL = new SubLQuote("SUBLISP", "FUNCTION", "#'");
		SubLQuote.QUOTE_TYPE_NAME = "QUOTE";
	}
