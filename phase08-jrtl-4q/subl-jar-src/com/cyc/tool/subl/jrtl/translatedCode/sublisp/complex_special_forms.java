...
public class complex_special_forms extends SubLTranslatedFile {
	...
	public static SubLObject defstruct_expand(SubLObject analysis) {
		...
		SubLObject host_fn_form = CommonSymbols.NIL != generate_visit_functionP
				? defstruct_host_function(name, host_fn_name, constructor, slot_keywords, getters) : CommonSymbols.NIL;
	...
	public static SubLObject defstruct_type_var(SubLObject name) {
		return intern_accessor(Sequences.cconcatenate(complex_special_forms.$str19$_DTP_,
	...
	public static SubLObject dtp_var(SubLObject name) {
		SubLObject symbol = intern_accessor(Sequences.cconcatenate(complex_special_forms.$str19$_DTP_,
				new SubLObject[] { Symbols.symbol_name(name), complex_special_forms.$str15$_ }));
		return symbol;
	}
	...
	public static SubLObject method_function_var(SubLObject name, SubLObject type) {
		return intern_accessor(Sequences.cconcatenate(Symbols.symbol_name(name), new SubLObject[] {
				complex_special_forms.$str17$_, Symbols.symbol_name(type), complex_special_forms.$str18$_METHOD }));
	}
	...
	public static SubLObject method_table_var(SubLObject name) {
		...
		try {
			...
			symbol = intern_accessor(Sequences.cconcatenate(complex_special_forms.$str15$_,
	...
	static {
		...
		$int110$1000 = SubLObjectFactory.makeInteger(1000);
