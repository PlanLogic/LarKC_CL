...
public class TestJUnit extends TestCase {
	...
	public void testCompoundZeroArity2() {
		...
		// System.out.println("type = " + t.prologTypeName());
		assertTrue(t.name().equals("foo"));
		assertTrue(t.arity() == 0);
	}
	...
	public void testprologTypeName1() {
		assertEquals("Y = foo binds Y to an Atom", Query.oneSolution("Y = foo").get("Y").prologTypeName(), "Atom");
	}

	public void testprologTypeName2() {
		assertEquals("Y = 3.14159 binds Y to a Float", Query.oneSolution("Y = 3.14159").get("Y").prologTypeName(), "Float");
	}

	public void testprologTypeName4() {
		assertEquals("Y = 6 binds Y to an Integer", Query.oneSolution("Y = 6").get("Y").prologTypeName(), "Integer");
	}

	public void testprologTypeName5() {
		assertEquals("Y = _ binds Y to a Variable", Query.oneSolution("Y = _").get("Y").prologTypeName(), "Variable");
	}

	public void testprologTypeName3() {
		assertEquals("Y = f(x) binds Y to a Compound", Query.oneSolution("Y = f(x)").get("Y").prologTypeName(), "Compound");
	}
	...
	public void testJRef1() {
		...
		Query q = new Query("jpl_call(?,intValue,[],I2)", new Term[] { ATerm.objectToJRef(I) });
