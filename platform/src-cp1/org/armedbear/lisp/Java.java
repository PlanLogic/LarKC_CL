...
public final class Java
{
    ...
    static final LispObject jstatic(Primitive fun, LispObject[] args, boolean translate) {
    	return jstatic(fun, args, translate, true);

    }
    public static final LispObject jstatic(Primitive fun, LispObject[] args, boolean translate, boolean strict)

    {
        if (strict && args.length < 2)
    ...
    public static boolean isApplicableMethod(Class<?>[] methodTypes,
            Object[] args) {
