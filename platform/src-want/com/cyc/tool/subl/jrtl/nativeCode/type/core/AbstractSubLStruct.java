...
public abstract class AbstractSubLStruct extends StandardObject implements SubLStruct {

	//public org.jpl7.Term termRef;
	public AbstractSubLStruct() {
		if(this instanceof Condition) return;
		if(this instanceof Stream) return;
		if(this instanceof GenericFunction) return;
	...
	public SubLObject getField(SubLSymbol fieldName) {
		int fieldNum = getStructFieldNumForSymbol(fieldName);
	...
	@Override
	abstract public int hashCode(int p0);
	...
	abstract public SubLObject getField(int fieldNum);
	abstract public void setField(int fieldNum, SubLObject value);
	...
	@Override abstract public String printObjectImpl();
	...
	{
		return PrologSync.toProlog(getName().getName(), this,s);
	}
