...
public class PrologSync extends SubLTrampolineFile
{
	...
	public static final class SyncState extends Term
	{
	...
	{
		(new org.jpl7.Query("assert",
				new Compound("sync",
						new Term[]
				{ new org.jpl7.Atom(className), new org.jpl7.Integer(serial), shouldBe })))
								.oneSolution();
	}

	private static void prologRetract(String className, long serial, Term shouldBe)
	{
		(new org.jpl7.Query("retract",
				new Compound("sync",
						new Term[]
				{ new org.jpl7.Atom(className), new org.jpl7.Integer(serial), shouldBe })))
								.oneSolution();
