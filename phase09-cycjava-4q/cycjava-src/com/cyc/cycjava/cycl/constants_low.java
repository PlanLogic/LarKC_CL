...
public final class constants_low extends SubLTranslatedFile
{
    ...
    public static SubLObject setup_constant_guid_table(final SubLObject size, final SubLObject exactP) {
        SubLObject setupP = (SubLObject)NIL;
        if (NIL == id_index.id_index_p($constant_guid_table$.getGlobalValue())) {
            $constant_guid_table$.setGlobalValue(id_index.new_id_index(size, (SubLObject)ZERO_INTEGER));
            setupP = (SubLObject)T;
        }
        if (NIL == id_index.id_index_p($constant_merged_guid_table$.getGlobalValue())) {
            $constant_merged_guid_table$.setGlobalValue(id_index.new_id_index((SubLObject)$int4$750, (SubLObject)ZERO_INTEGER));
            setupP = (SubLObject)T;
        }
        if (!$constant_from_guid$.getGlobalValue().isHashtable()) {
            $constant_from_guid$.setGlobalValue(Hashtables.make_hash_table(size, Symbols.symbol_function((SubLObject)EQUALP), (SubLObject)UNPROVIDED));
            setupP = (SubLObject)T;
        }
        return setupP;
    }
    ...
    public static SubLObject lookup_constant_guid(final SubLObject id) {
        return id_index.id_index_lookup($constant_guid_table$.getGlobalValue(), id, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject lookup_constant_merged_guid(final SubLObject id) {
        return id_index.id_index_lookup($constant_merged_guid_table$.getGlobalValue(), id, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject lookup_constant_by_guid(final SubLObject guid) {
        return Hashtables.gethash_without_values(guid, $constant_from_guid$.getGlobalValue(), (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject kb_create_constant_kb_store(final SubLObject name, final SubLObject external_id_0) {
        SubLObject constant = lookup_constant_by_guid(external_id_0);
        if (NIL != constant) {
            return constants_high.constant_internal_id(constant);
        }
        final SubLObject suid = constant_handles.make_constant_suid();
        constant = constant_handles.make_constant_shell(name, (SubLObject)T);
        constant_handles.install_constant_suid(constant, suid);
        if (name.isString()) {
            constant_handles.deregister_invalid_constant_by_name(name);
        }
        kb_create_constant_int(constant, name, external_id_0);
        return suid;
    ...
    public static SubLObject kb_create_constant_cyc(final SubLObject name, final SubLObject internal_id) {
        final SubLObject constant = constant_handles.make_constant_shell(name, (SubLObject)T);
    ...
    public static SubLObject install_constant_external_id(final SubLObject constant, final SubLObject external_id) {
        SubLObject guid = (SubLObject)NIL;
    ...
    public static SubLObject kb_new_constant_info_iterator_internal() {
        ...
        return iteration.new_indirect_iterator(input_iterator, (SubLObject)$sym5$CONSTANT_INFO, (SubLObject)UNPROVIDED);
    }
    ...
    public static SubLObject constant_info(final SubLObject constant) {
        final SubLObject suid = constant_handles.constant_suid(constant);
        final SubLObject name = constant_name_internal(constant);
        final SubLObject guid = (SubLObject)(suid.isInteger() ? constant_guid_internal(constant) : NIL);
    ...
    public static SubLObject kb_rename_constant_internal(final SubLObject constant, final SubLObject new_name) {
        if (NIL != constants_interface.kb_lookup_constant_by_name(new_name)) {
            Errors.error((SubLObject)$str6$A_constant_with_the_name__s_alrea, new_name);
        }
    ...
    public static SubLObject random_constant_internal(SubLObject test) {
        if (test == UNPROVIDED) {
            test = Symbols.symbol_function((SubLObject)$sym9$TRUE);
        }
        if (constant_handles.constant_count().numG((SubLObject)ZERO_INTEGER)) {
            final SubLObject max_id = constant_handles.next_constant_suid();
            SubLObject v_answer;
            SubLObject candidate;
            for (v_answer = (SubLObject)NIL; NIL == v_answer; v_answer = candidate) {
    ...
    public static SubLObject init_constants_low_file() {
        $constant_guid_table$ = SubLFiles.deflexical("*CONSTANT-GUID-TABLE*", (SubLObject)((NIL != Symbols.boundp((SubLObject)$sym0$_CONSTANT_GUID_TABLE_)) ? $constant_guid_table$.getGlobalValue() : $kw1$UNINITIALIZED));
        $constant_merged_guid_table$ = SubLFiles.deflexical("*CONSTANT-MERGED-GUID-TABLE*", (SubLObject)((NIL != Symbols.boundp((SubLObject)$sym2$_CONSTANT_MERGED_GUID_TABLE_)) ? $constant_merged_guid_table$.getGlobalValue() : $kw1$UNINITIALIZED));
        $constant_from_guid$ = SubLFiles.deflexical("*CONSTANT-FROM-GUID*", (SubLObject)((NIL != Symbols.boundp((SubLObject)$sym3$_CONSTANT_FROM_GUID_)) ? $constant_from_guid$.getGlobalValue() : NIL));
        return (SubLObject)NIL;
    }

    public static SubLObject setup_constants_low_file() {
        subl_macro_promotions.declare_defglobal((SubLObject)$sym0$_CONSTANT_GUID_TABLE_);
        subl_macro_promotions.declare_defglobal((SubLObject)$sym2$_CONSTANT_MERGED_GUID_TABLE_);
        subl_macro_promotions.declare_defglobal((SubLObject)$sym3$_CONSTANT_FROM_GUID_);
        return (SubLObject)NIL;
    }
