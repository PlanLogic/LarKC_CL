...
public final class assertion_manager extends SubLTranslatedFile
{
	...
	private static SubLSymbol sublStructDeclSymbol;
    ...
    public static SubLObject lookup_assertion_content(final SubLObject id) {
        ...
        arete.arete_note_assertion_touched(assertion);
        PrologSync.addThis(assertion.toStruct().getName(), id, assertion);
    ...
    public static SubLObject register_assertion_content(final SubLObject id, final SubLObject assertion_content) {
    	SubLObject ret =  kb_object_manager.register_kb_object_content(assertion_manager.$assertion_content_manager$.getGlobalValue(), id, assertion_content);
		PrologSync.addThis(getStructSymbol(),id,assertion_content);
		return ret;
    ...
    public static SubLObject deregister_assertion_content(final SubLObject id) {
    	SubLObject ret = kb_object_manager.deregister_kb_object_content(assertion_manager.$assertion_content_manager$.getGlobalValue(), id);
	    PrologSync.remThis(getStructSymbol(),id);
	    return ret;
    }

	private static SubLSymbol getStructSymbol() {
		if (sublStructDeclSymbol == null) {
			sublStructDeclSymbol = assertions_low.$assertion_content_native.structDecl.getStructName();
		}
		return sublStructDeclSymbol;
	}
    ...
    public static SubLObject mark_assertion_content_as_muted(final SubLObject id) {
        ...
        try {
            kb_storage_logging.$kb_storage_client$.bind(kb_storage_logging.add_kb_storage_logging_add_tag((SubLObject)assertion_manager.$kw5$AM), thread);
            SubLObject ret = kb_object_manager.mark_kb_object_content_as_muted(assertion_manager.$assertion_content_manager$.getGlobalValue(), id);
            SubLObject content = kb_object_manager.lookup_kb_object_content(assertion_manager.$assertion_content_manager$.getGlobalValue(), id);
            PrologSync.updThis(getStructSymbol(),id,content);
            return ret;
        }
        finally {
            kb_storage_logging.$kb_storage_client$.rebind(_prev_bind_0, thread);
