...
public final class constant_handles extends SubLTranslatedFile
{
    ...
    public static final class $constant_native extends SubLStructNative
    {
        ...
        static {
			structDecl = Structures.makeStructDeclNative((Class) $constant_native.class,
					constant_handles.$sym39$CONSTANT, constant_handles.$sym40$CONSTANT_P,
					...
					SubLObjectFactory.makeSymbol("PRINT-CONSTANT"));
        }
    }
